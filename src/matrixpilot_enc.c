...
static void append_payload_base(uint8_t **p, struct matrixpilot_message *msg) {
  switch (msg->msg_id) {
  ...
  case MATRIXPILOT_MESSAGE_FLEXIFUNCTION_SET:
    append_byte(p, msg->flexifunction_set.target_system);
    append_byte(p, msg->flexifunction_set.target_component);
    break;

  case MATRIXPILOT_MESSAGE_FLEXIFUNCTION_READ_REQ:
    append_int16(p, msg->flexifunction_read_req.read_req_type);
    append_int16(p, msg->flexifunction_read_req.data_index);
    append_byte(p, msg->flexifunction_read_req.target_system);
    append_byte(p, msg->flexifunction_read_req.target_component);
    break;

  case MATRIXPILOT_MESSAGE_FLEXIFUNCTION_BUFFER_FUNCTION:
    append_uint16(p, msg->flexifunction_buffer_function.func_index);
    append_uint16(p, msg->flexifunction_buffer_function.func_count);
    append_uint16(p, msg->flexifunction_buffer_function.data_address);
    append_uint16(p, msg->flexifunction_buffer_function.data_size);
    append_byte(p, msg->flexifunction_buffer_function.target_system);
    append_byte(p, msg->flexifunction_buffer_function.target_component);
    for (size_t i = 0; i < 48; i++)
      append_int8(p, msg->flexifunction_buffer_function.data[i]);
    break;

  case MATRIXPILOT_MESSAGE_FLEXIFUNCTION_BUFFER_FUNCTION_ACK:
    append_uint16(p, msg->flexifunction_buffer_function_ack.func_index);
    append_uint16(p, msg->flexifunction_buffer_function_ack.result);
    append_byte(p, msg->flexifunction_buffer_function_ack.target_system);
    append_byte(p, msg->flexifunction_buffer_function_ack.target_component);
    break;

  case MATRIXPILOT_MESSAGE_FLEXIFUNCTION_DIRECTORY:
    append_byte(p, msg->flexifunction_directory.target_system);
    append_byte(p, msg->flexifunction_directory.target_component);
    append_byte(p, msg->flexifunction_directory.directory_type);
    append_byte(p, msg->flexifunction_directory.start_index);
    append_byte(p, msg->flexifunction_directory.count);
    for (size_t i = 0; i < 48; i++)
      append_int8(p, msg->flexifunction_directory.directory_data[i]);
    break;

  case MATRIXPILOT_MESSAGE_FLEXIFUNCTION_DIRECTORY_ACK:
    append_uint16(p, msg->flexifunction_directory_ack.result);
    append_byte(p, msg->flexifunction_directory_ack.target_system);
    append_byte(p, msg->flexifunction_directory_ack.target_component);
    append_byte(p, msg->flexifunction_directory_ack.directory_type);
    append_byte(p, msg->flexifunction_directory_ack.start_index);
    append_byte(p, msg->flexifunction_directory_ack.count);
    break;

  case MATRIXPILOT_MESSAGE_FLEXIFUNCTION_COMMAND:
    append_byte(p, msg->flexifunction_command.target_system);
    append_byte(p, msg->flexifunction_command.target_component);
    append_byte(p, msg->flexifunction_command.command_type);
    break;

  case MATRIXPILOT_MESSAGE_FLEXIFUNCTION_COMMAND_ACK:
    append_uint16(p, msg->flexifunction_command_ack.command_type);
    append_uint16(p, msg->flexifunction_command_ack.result);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F2_A:
    append_uint32(p, msg->serial_udb_extra_f2_a.sue_time);
    append_int32(p, msg->serial_udb_extra_f2_a.sue_latitude);
    append_int32(p, msg->serial_udb_extra_f2_a.sue_longitude);
    append_int32(p, msg->serial_udb_extra_f2_a.sue_altitude);
    append_uint16(p, msg->serial_udb_extra_f2_a.sue_waypoint_index);
    append_int16(p, msg->serial_udb_extra_f2_a.sue_rmat0);
    append_int16(p, msg->serial_udb_extra_f2_a.sue_rmat1);
    append_int16(p, msg->serial_udb_extra_f2_a.sue_rmat2);
    append_int16(p, msg->serial_udb_extra_f2_a.sue_rmat3);
    append_int16(p, msg->serial_udb_extra_f2_a.sue_rmat4);
    append_int16(p, msg->serial_udb_extra_f2_a.sue_rmat5);
    append_int16(p, msg->serial_udb_extra_f2_a.sue_rmat6);
    append_int16(p, msg->serial_udb_extra_f2_a.sue_rmat7);
    append_int16(p, msg->serial_udb_extra_f2_a.sue_rmat8);
    append_uint16(p, msg->serial_udb_extra_f2_a.sue_cog);
    append_int16(p, msg->serial_udb_extra_f2_a.sue_sog);
    append_uint16(p, msg->serial_udb_extra_f2_a.sue_cpu_load);
    append_uint16(p, msg->serial_udb_extra_f2_a.sue_air_speed_3DIMU);
    append_int16(p, msg->serial_udb_extra_f2_a.sue_estimated_wind_0);
    append_int16(p, msg->serial_udb_extra_f2_a.sue_estimated_wind_1);
    append_int16(p, msg->serial_udb_extra_f2_a.sue_estimated_wind_2);
    append_int16(p, msg->serial_udb_extra_f2_a.sue_magFieldEarth0);
    append_int16(p, msg->serial_udb_extra_f2_a.sue_magFieldEarth1);
    append_int16(p, msg->serial_udb_extra_f2_a.sue_magFieldEarth2);
    append_int16(p, msg->serial_udb_extra_f2_a.sue_svs);
    append_int16(p, msg->serial_udb_extra_f2_a.sue_hdop);
    append_byte(p, msg->serial_udb_extra_f2_a.sue_status);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F2_B:
    append_uint32(p, msg->serial_udb_extra_f2_b.sue_time);
    append_uint32(p, msg->serial_udb_extra_f2_b.sue_flags);
    append_int32(p, msg->serial_udb_extra_f2_b.sue_barom_press);
    append_int32(p, msg->serial_udb_extra_f2_b.sue_barom_alt);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_input_1);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_input_2);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_input_3);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_input_4);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_input_5);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_input_6);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_input_7);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_input_8);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_input_9);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_input_10);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_input_11);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_input_12);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_output_1);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_output_2);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_output_3);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_output_4);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_output_5);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_output_6);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_output_7);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_output_8);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_output_9);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_output_10);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_output_11);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_pwm_output_12);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_imu_location_x);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_imu_location_y);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_imu_location_z);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_location_error_earth_x);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_location_error_earth_y);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_location_error_earth_z);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_osc_fails);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_imu_velocity_x);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_imu_velocity_y);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_imu_velocity_z);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_waypoint_goal_x);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_waypoint_goal_y);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_waypoint_goal_z);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_aero_x);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_aero_y);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_aero_z);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_barom_temp);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_bat_volt);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_bat_amp);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_bat_amp_hours);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_desired_height);
    append_int16(p, msg->serial_udb_extra_f2_b.sue_memory_stack_free);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F4:
    append_byte(p, msg->serial_udb_extra_f4.sue_ROLL_STABILIZATION_AILERONS);
    append_byte(p, msg->serial_udb_extra_f4.sue_ROLL_STABILIZATION_RUDDER);
    append_byte(p, msg->serial_udb_extra_f4.sue_PITCH_STABILIZATION);
    append_byte(p, msg->serial_udb_extra_f4.sue_YAW_STABILIZATION_RUDDER);
    append_byte(p, msg->serial_udb_extra_f4.sue_YAW_STABILIZATION_AILERON);
    append_byte(p, msg->serial_udb_extra_f4.sue_AILERON_NAVIGATION);
    append_byte(p, msg->serial_udb_extra_f4.sue_RUDDER_NAVIGATION);
    append_byte(p, msg->serial_udb_extra_f4.sue_ALTITUDEHOLD_STABILIZED);
    append_byte(p, msg->serial_udb_extra_f4.sue_ALTITUDEHOLD_WAYPOINT);
    append_byte(p, msg->serial_udb_extra_f4.sue_RACING_MODE);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F5:
    append_float32(p, msg->serial_udb_extra_f5.sue_YAWKP_AILERON);
    append_float32(p, msg->serial_udb_extra_f5.sue_YAWKD_AILERON);
    append_float32(p, msg->serial_udb_extra_f5.sue_ROLLKP);
    append_float32(p, msg->serial_udb_extra_f5.sue_ROLLKD);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F6:
    append_float32(p, msg->serial_udb_extra_f6.sue_PITCHGAIN);
    append_float32(p, msg->serial_udb_extra_f6.sue_PITCHKD);
    append_float32(p, msg->serial_udb_extra_f6.sue_RUDDER_ELEV_MIX);
    append_float32(p, msg->serial_udb_extra_f6.sue_ROLL_ELEV_MIX);
    append_float32(p, msg->serial_udb_extra_f6.sue_ELEVATOR_BOOST);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F7:
    append_float32(p, msg->serial_udb_extra_f7.sue_YAWKP_RUDDER);
    append_float32(p, msg->serial_udb_extra_f7.sue_YAWKD_RUDDER);
    append_float32(p, msg->serial_udb_extra_f7.sue_ROLLKP_RUDDER);
    append_float32(p, msg->serial_udb_extra_f7.sue_ROLLKD_RUDDER);
    append_float32(p, msg->serial_udb_extra_f7.sue_RUDDER_BOOST);
    append_float32(p, msg->serial_udb_extra_f7.sue_RTL_PITCH_DOWN);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F8:
    append_float32(p, msg->serial_udb_extra_f8.sue_HEIGHT_TARGET_MAX);
    append_float32(p, msg->serial_udb_extra_f8.sue_HEIGHT_TARGET_MIN);
    append_float32(p, msg->serial_udb_extra_f8.sue_ALT_HOLD_THROTTLE_MIN);
    append_float32(p, msg->serial_udb_extra_f8.sue_ALT_HOLD_THROTTLE_MAX);
    append_float32(p, msg->serial_udb_extra_f8.sue_ALT_HOLD_PITCH_MIN);
    append_float32(p, msg->serial_udb_extra_f8.sue_ALT_HOLD_PITCH_MAX);
    append_float32(p, msg->serial_udb_extra_f8.sue_ALT_HOLD_PITCH_HIGH);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F13:
    append_int32(p, msg->serial_udb_extra_f13.sue_lat_origin);
    append_int32(p, msg->serial_udb_extra_f13.sue_lon_origin);
    append_int32(p, msg->serial_udb_extra_f13.sue_alt_origin);
    append_int16(p, msg->serial_udb_extra_f13.sue_week_no);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F14:
    append_uint32(p, msg->serial_udb_extra_f14.sue_TRAP_SOURCE);
    append_int16(p, msg->serial_udb_extra_f14.sue_RCON);
    append_int16(p, msg->serial_udb_extra_f14.sue_TRAP_FLAGS);
    append_int16(p, msg->serial_udb_extra_f14.sue_osc_fail_count);
    append_byte(p, msg->serial_udb_extra_f14.sue_WIND_ESTIMATION);
    append_byte(p, msg->serial_udb_extra_f14.sue_GPS_TYPE);
    append_byte(p, msg->serial_udb_extra_f14.sue_DR);
    append_byte(p, msg->serial_udb_extra_f14.sue_BOARD_TYPE);
    append_byte(p, msg->serial_udb_extra_f14.sue_AIRFRAME);
    append_byte(p, msg->serial_udb_extra_f14.sue_CLOCK_CONFIG);
    append_byte(p, msg->serial_udb_extra_f14.sue_FLIGHT_PLAN_TYPE);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F15:

    for (size_t i = 0; i < 40; i++)
      append_byte(p, msg->serial_udb_extra_f15.sue_ID_VEHICLE_MODEL_NAME[i]);
    for (size_t i = 0; i < 20; i++)
      append_byte(p, msg->serial_udb_extra_f15.sue_ID_VEHICLE_REGISTRATION[i]);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F16:

    for (size_t i = 0; i < 40; i++)
      append_byte(p, msg->serial_udb_extra_f16.sue_ID_LEAD_PILOT[i]);
    for (size_t i = 0; i < 70; i++)
      append_byte(p, msg->serial_udb_extra_f16.sue_ID_DIY_DRONES_URL[i]);
    break;

  case MATRIXPILOT_MESSAGE_ALTITUDES:
    append_uint32(p, msg->altitudes.time_boot_ms);
    append_int32(p, msg->altitudes.alt_gps);
    append_int32(p, msg->altitudes.alt_imu);
    append_int32(p, msg->altitudes.alt_barometric);
    append_int32(p, msg->altitudes.alt_optical_flow);
    append_int32(p, msg->altitudes.alt_range_finder);
    append_int32(p, msg->altitudes.alt_extra);
    break;

  case MATRIXPILOT_MESSAGE_AIRSPEEDS:
    append_uint32(p, msg->airspeeds.time_boot_ms);
    append_int16(p, msg->airspeeds.airspeed_imu);
    append_int16(p, msg->airspeeds.airspeed_pitot);
    append_int16(p, msg->airspeeds.airspeed_hot_wire);
    append_int16(p, msg->airspeeds.airspeed_ultrasonic);
    append_int16(p, msg->airspeeds.aoa);
    append_int16(p, msg->airspeeds.aoy);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F17:
    append_float32(p, msg->serial_udb_extra_f17.sue_feed_forward);
    append_float32(p, msg->serial_udb_extra_f17.sue_turn_rate_nav);
    append_float32(p, msg->serial_udb_extra_f17.sue_turn_rate_fbw);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F18:
    append_float32(p, msg->serial_udb_extra_f18.angle_of_attack_normal);
    append_float32(p, msg->serial_udb_extra_f18.angle_of_attack_inverted);
    append_float32(p, msg->serial_udb_extra_f18.elevator_trim_normal);
    append_float32(p, msg->serial_udb_extra_f18.elevator_trim_inverted);
    append_float32(p, msg->serial_udb_extra_f18.reference_speed);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F19:
    append_byte(p, msg->serial_udb_extra_f19.sue_aileron_output_channel);
    append_byte(p, msg->serial_udb_extra_f19.sue_aileron_reversed);
    append_byte(p, msg->serial_udb_extra_f19.sue_elevator_output_channel);
    append_byte(p, msg->serial_udb_extra_f19.sue_elevator_reversed);
    append_byte(p, msg->serial_udb_extra_f19.sue_throttle_output_channel);
    append_byte(p, msg->serial_udb_extra_f19.sue_throttle_reversed);
    append_byte(p, msg->serial_udb_extra_f19.sue_rudder_output_channel);
    append_byte(p, msg->serial_udb_extra_f19.sue_rudder_reversed);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F20:
    append_int16(p, msg->serial_udb_extra_f20.sue_trim_value_input_1);
    append_int16(p, msg->serial_udb_extra_f20.sue_trim_value_input_2);
    append_int16(p, msg->serial_udb_extra_f20.sue_trim_value_input_3);
    append_int16(p, msg->serial_udb_extra_f20.sue_trim_value_input_4);
    append_int16(p, msg->serial_udb_extra_f20.sue_trim_value_input_5);
    append_int16(p, msg->serial_udb_extra_f20.sue_trim_value_input_6);
    append_int16(p, msg->serial_udb_extra_f20.sue_trim_value_input_7);
    append_int16(p, msg->serial_udb_extra_f20.sue_trim_value_input_8);
    append_int16(p, msg->serial_udb_extra_f20.sue_trim_value_input_9);
    append_int16(p, msg->serial_udb_extra_f20.sue_trim_value_input_10);
    append_int16(p, msg->serial_udb_extra_f20.sue_trim_value_input_11);
    append_int16(p, msg->serial_udb_extra_f20.sue_trim_value_input_12);
    append_byte(p, msg->serial_udb_extra_f20.sue_number_of_inputs);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F21:
    append_int16(p, msg->serial_udb_extra_f21.sue_accel_x_offset);
    append_int16(p, msg->serial_udb_extra_f21.sue_accel_y_offset);
    append_int16(p, msg->serial_udb_extra_f21.sue_accel_z_offset);
    append_int16(p, msg->serial_udb_extra_f21.sue_gyro_x_offset);
    append_int16(p, msg->serial_udb_extra_f21.sue_gyro_y_offset);
    append_int16(p, msg->serial_udb_extra_f21.sue_gyro_z_offset);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F22:
    append_int16(p, msg->serial_udb_extra_f22.sue_accel_x_at_calibration);
    append_int16(p, msg->serial_udb_extra_f22.sue_accel_y_at_calibration);
    append_int16(p, msg->serial_udb_extra_f22.sue_accel_z_at_calibration);
    append_int16(p, msg->serial_udb_extra_f22.sue_gyro_x_at_calibration);
    append_int16(p, msg->serial_udb_extra_f22.sue_gyro_y_at_calibration);
    append_int16(p, msg->serial_udb_extra_f22.sue_gyro_z_at_calibration);
    break;
...
static void append_payload_ext(uint8_t **p, struct matrixpilot_message *msg) {
  switch (msg->msg_id) {
...
size_t matrixpilot_message_serialize_v1(struct matrixpilot_message *msg,
  ...
  *p++ = msg->msg_id;
  ...
  crc = x25(crc, matrixpilot_crcextra(msg->msg_id));
