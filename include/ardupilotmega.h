...
enum MAV_CMD {
  ...
  /* Mission command to wait for an altitude or downwards vertical speed. This
     is meant for high altitude balloon launches, allowing the aircraft to be
     idle until either an altitude is reached or a negative vertical speed is
     reached (indicating early balloon burst). The wiggle time is how often to
     wiggle the control surfaces to prevent them seizing up. */
  ...
  /* Magnetometer calibration based on fixed position         in earth field
     given by inclination, declination and intensity. */
  MAV_CMD_FIXED_MAG_CAL = 42004,
  /* Magnetometer calibration based on fixed expected field values in
     milliGauss. */
  ...
  /* Used when doing accelerometer calibration. When sent to the GCS tells it
     what position to put the vehicle in. When sent to the vehicle says what
...
enum RALLY_FLAGS {
  ...
  FAVORABLE_WIND = 1,
  /* Flag set when plane is to immediately descend to break altitude and land
     without GCS intervention. Flag not set when plane is to loiter at Rally
     point until commanded to land. */
  LAND_IMMEDIATELY = 2
};
...
enum WINCH_ACTIONS {
  /* Relax winch. */
  WINCH_RELAXED = 0,
  /* Winch unwinds or winds specified length of cable optionally using specified
     rate. */
...
enum CAMERA_FEEDBACK_FLAGS {
  ...
  /* Open loop camera, an image trigger has been requested but we can't know for
     sure it has successfully taken a picture. */
...
enum MAV_MODE_GIMBAL {
  ...
  /* Gimbal has finished calibrating and initializing, but is relaxed pending
     reception of first rate command from copter. */
  ...
  /* Gimbal is relaxed because it missed more than 10 expected rate command
     messages in a row. Gimbal will move back to active mode when it receives a
     new rate command. */
...
/* A data stream is not a fixed set of messages, but rather a recommendation
 * to the autopilot software. Individual autopilots may or may not obey      the
...
// This enum is used to switch the anonymous union in ardupilotmega_message.
enum ARDUPILOTMEGA_MESSAGE {
  ARDUPILOTMEGA_MESSAGE_HEARTBEAT = 0,
  ARDUPILOTMEGA_MESSAGE_SYS_STATUS = 1,
  ARDUPILOTMEGA_MESSAGE_SYSTEM_TIME = 2,
  ARDUPILOTMEGA_MESSAGE_PING = 4,
  ARDUPILOTMEGA_MESSAGE_CHANGE_OPERATOR_CONTROL = 5,
  ARDUPILOTMEGA_MESSAGE_CHANGE_OPERATOR_CONTROL_ACK = 6,
  ARDUPILOTMEGA_MESSAGE_AUTH_KEY = 7,
  ARDUPILOTMEGA_MESSAGE_LINK_NODE_STATUS = 8,
  ARDUPILOTMEGA_MESSAGE_SET_MODE = 11,
  ARDUPILOTMEGA_MESSAGE_PARAM_REQUEST_READ = 20,
  ARDUPILOTMEGA_MESSAGE_PARAM_REQUEST_LIST = 21,
  ARDUPILOTMEGA_MESSAGE_PARAM_VALUE = 22,
  ARDUPILOTMEGA_MESSAGE_PARAM_SET = 23,
  ARDUPILOTMEGA_MESSAGE_GPS_RAW_INT = 24,
  ARDUPILOTMEGA_MESSAGE_GPS_STATUS = 25,
  ARDUPILOTMEGA_MESSAGE_SCALED_IMU = 26,
  ARDUPILOTMEGA_MESSAGE_RAW_IMU = 27,
  ARDUPILOTMEGA_MESSAGE_RAW_PRESSURE = 28,
  ARDUPILOTMEGA_MESSAGE_SCALED_PRESSURE = 29,
  ARDUPILOTMEGA_MESSAGE_ATTITUDE = 30,
  ARDUPILOTMEGA_MESSAGE_ATTITUDE_QUATERNION = 31,
  ARDUPILOTMEGA_MESSAGE_LOCAL_POSITION_NED = 32,
  ARDUPILOTMEGA_MESSAGE_GLOBAL_POSITION_INT = 33,
  ARDUPILOTMEGA_MESSAGE_RC_CHANNELS_SCALED = 34,
  ARDUPILOTMEGA_MESSAGE_RC_CHANNELS_RAW = 35,
  ARDUPILOTMEGA_MESSAGE_SERVO_OUTPUT_RAW = 36,
  ARDUPILOTMEGA_MESSAGE_MISSION_REQUEST_PARTIAL_LIST = 37,
  ARDUPILOTMEGA_MESSAGE_MISSION_WRITE_PARTIAL_LIST = 38,
  ARDUPILOTMEGA_MESSAGE_MISSION_ITEM = 39,
  ARDUPILOTMEGA_MESSAGE_MISSION_REQUEST = 40,
  ARDUPILOTMEGA_MESSAGE_MISSION_SET_CURRENT = 41,
  ARDUPILOTMEGA_MESSAGE_MISSION_CURRENT = 42,
  ARDUPILOTMEGA_MESSAGE_MISSION_REQUEST_LIST = 43,
  ARDUPILOTMEGA_MESSAGE_MISSION_COUNT = 44,
  ARDUPILOTMEGA_MESSAGE_MISSION_CLEAR_ALL = 45,
  ARDUPILOTMEGA_MESSAGE_MISSION_ITEM_REACHED = 46,
  ARDUPILOTMEGA_MESSAGE_MISSION_ACK = 47,
  ARDUPILOTMEGA_MESSAGE_SET_GPS_GLOBAL_ORIGIN = 48,
  ARDUPILOTMEGA_MESSAGE_GPS_GLOBAL_ORIGIN = 49,
  ARDUPILOTMEGA_MESSAGE_PARAM_MAP_RC = 50,
  ARDUPILOTMEGA_MESSAGE_MISSION_REQUEST_INT = 51,
  ARDUPILOTMEGA_MESSAGE_MISSION_CHANGED = 52,
  ARDUPILOTMEGA_MESSAGE_SAFETY_SET_ALLOWED_AREA = 54,
  ARDUPILOTMEGA_MESSAGE_SAFETY_ALLOWED_AREA = 55,
  ARDUPILOTMEGA_MESSAGE_ATTITUDE_QUATERNION_COV = 61,
  ARDUPILOTMEGA_MESSAGE_NAV_CONTROLLER_OUTPUT = 62,
  ARDUPILOTMEGA_MESSAGE_GLOBAL_POSITION_INT_COV = 63,
  ARDUPILOTMEGA_MESSAGE_LOCAL_POSITION_NED_COV = 64,
  ARDUPILOTMEGA_MESSAGE_RC_CHANNELS = 65,
  ARDUPILOTMEGA_MESSAGE_REQUEST_DATA_STREAM = 66,
  ARDUPILOTMEGA_MESSAGE_DATA_STREAM = 67,
  ARDUPILOTMEGA_MESSAGE_MANUAL_CONTROL = 69,
  ARDUPILOTMEGA_MESSAGE_RC_CHANNELS_OVERRIDE = 70,
  ARDUPILOTMEGA_MESSAGE_MISSION_ITEM_INT = 73,
  ARDUPILOTMEGA_MESSAGE_VFR_HUD = 74,
  ARDUPILOTMEGA_MESSAGE_COMMAND_INT = 75,
  ARDUPILOTMEGA_MESSAGE_COMMAND_LONG = 76,
  ARDUPILOTMEGA_MESSAGE_COMMAND_ACK = 77,
  ARDUPILOTMEGA_MESSAGE_MANUAL_SETPOINT = 81,
  ARDUPILOTMEGA_MESSAGE_SET_ATTITUDE_TARGET = 82,
  ARDUPILOTMEGA_MESSAGE_ATTITUDE_TARGET = 83,
  ARDUPILOTMEGA_MESSAGE_SET_POSITION_TARGET_LOCAL_NED = 84,
  ARDUPILOTMEGA_MESSAGE_POSITION_TARGET_LOCAL_NED = 85,
  ARDUPILOTMEGA_MESSAGE_SET_POSITION_TARGET_GLOBAL_INT = 86,
  ARDUPILOTMEGA_MESSAGE_POSITION_TARGET_GLOBAL_INT = 87,
  ARDUPILOTMEGA_MESSAGE_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET = 89,
  ARDUPILOTMEGA_MESSAGE_HIL_STATE = 90,
  ARDUPILOTMEGA_MESSAGE_HIL_CONTROLS = 91,
  ARDUPILOTMEGA_MESSAGE_HIL_RC_INPUTS_RAW = 92,
  ARDUPILOTMEGA_MESSAGE_HIL_ACTUATOR_CONTROLS = 93,
  ARDUPILOTMEGA_MESSAGE_OPTICAL_FLOW = 100,
  ARDUPILOTMEGA_MESSAGE_GLOBAL_VISION_POSITION_ESTIMATE = 101,
  ARDUPILOTMEGA_MESSAGE_VISION_POSITION_ESTIMATE = 102,
  ARDUPILOTMEGA_MESSAGE_VISION_SPEED_ESTIMATE = 103,
  ARDUPILOTMEGA_MESSAGE_VICON_POSITION_ESTIMATE = 104,
  ARDUPILOTMEGA_MESSAGE_HIGHRES_IMU = 105,
  ARDUPILOTMEGA_MESSAGE_OPTICAL_FLOW_RAD = 106,
  ARDUPILOTMEGA_MESSAGE_HIL_SENSOR = 107,
  ARDUPILOTMEGA_MESSAGE_SIM_STATE = 108,
  ARDUPILOTMEGA_MESSAGE_RADIO_STATUS = 109,
  ARDUPILOTMEGA_MESSAGE_FILE_TRANSFER_PROTOCOL = 110,
  ARDUPILOTMEGA_MESSAGE_TIMESYNC = 111,
  ARDUPILOTMEGA_MESSAGE_CAMERA_TRIGGER = 112,
  ARDUPILOTMEGA_MESSAGE_HIL_GPS = 113,
  ARDUPILOTMEGA_MESSAGE_HIL_OPTICAL_FLOW = 114,
  ARDUPILOTMEGA_MESSAGE_HIL_STATE_QUATERNION = 115,
  ARDUPILOTMEGA_MESSAGE_SCALED_IMU2 = 116,
  ARDUPILOTMEGA_MESSAGE_LOG_REQUEST_LIST = 117,
  ARDUPILOTMEGA_MESSAGE_LOG_ENTRY = 118,
  ARDUPILOTMEGA_MESSAGE_LOG_REQUEST_DATA = 119,
  ARDUPILOTMEGA_MESSAGE_LOG_DATA = 120,
  ARDUPILOTMEGA_MESSAGE_LOG_ERASE = 121,
  ARDUPILOTMEGA_MESSAGE_LOG_REQUEST_END = 122,
  ARDUPILOTMEGA_MESSAGE_GPS_INJECT_DATA = 123,
  ARDUPILOTMEGA_MESSAGE_GPS2_RAW = 124,
  ARDUPILOTMEGA_MESSAGE_POWER_STATUS = 125,
  ARDUPILOTMEGA_MESSAGE_SERIAL_CONTROL = 126,
  ARDUPILOTMEGA_MESSAGE_GPS_RTK = 127,
  ARDUPILOTMEGA_MESSAGE_GPS2_RTK = 128,
  ARDUPILOTMEGA_MESSAGE_SCALED_IMU3 = 129,
  ARDUPILOTMEGA_MESSAGE_DATA_TRANSMISSION_HANDSHAKE = 130,
  ARDUPILOTMEGA_MESSAGE_ENCAPSULATED_DATA = 131,
  ARDUPILOTMEGA_MESSAGE_DISTANCE_SENSOR = 132,
  ARDUPILOTMEGA_MESSAGE_TERRAIN_REQUEST = 133,
  ARDUPILOTMEGA_MESSAGE_TERRAIN_DATA = 134,
  ARDUPILOTMEGA_MESSAGE_TERRAIN_CHECK = 135,
  ARDUPILOTMEGA_MESSAGE_TERRAIN_REPORT = 136,
  ARDUPILOTMEGA_MESSAGE_SCALED_PRESSURE2 = 137,
  ARDUPILOTMEGA_MESSAGE_ATT_POS_MOCAP = 138,
  ARDUPILOTMEGA_MESSAGE_SET_ACTUATOR_CONTROL_TARGET = 139,
  ARDUPILOTMEGA_MESSAGE_ACTUATOR_CONTROL_TARGET = 140,
  ARDUPILOTMEGA_MESSAGE_ALTITUDE = 141,
  ARDUPILOTMEGA_MESSAGE_RESOURCE_REQUEST = 142,
  ARDUPILOTMEGA_MESSAGE_SCALED_PRESSURE3 = 143,
  ARDUPILOTMEGA_MESSAGE_FOLLOW_TARGET = 144,
  ARDUPILOTMEGA_MESSAGE_CONTROL_SYSTEM_STATE = 146,
  ARDUPILOTMEGA_MESSAGE_BATTERY_STATUS = 147,
  ARDUPILOTMEGA_MESSAGE_AUTOPILOT_VERSION = 148,
  ARDUPILOTMEGA_MESSAGE_LANDING_TARGET = 149,
  ARDUPILOTMEGA_MESSAGE_SENSOR_OFFSETS = 150,
  ARDUPILOTMEGA_MESSAGE_SET_MAG_OFFSETS = 151,
  ARDUPILOTMEGA_MESSAGE_MEMINFO = 152,
  ARDUPILOTMEGA_MESSAGE_AP_ADC = 153,
  ARDUPILOTMEGA_MESSAGE_DIGICAM_CONFIGURE = 154,
  ARDUPILOTMEGA_MESSAGE_DIGICAM_CONTROL = 155,
  ARDUPILOTMEGA_MESSAGE_MOUNT_CONFIGURE = 156,
  ARDUPILOTMEGA_MESSAGE_MOUNT_CONTROL = 157,
  ARDUPILOTMEGA_MESSAGE_MOUNT_STATUS = 158,
  ARDUPILOTMEGA_MESSAGE_FENCE_POINT = 160,
  ARDUPILOTMEGA_MESSAGE_FENCE_FETCH_POINT = 161,
  ARDUPILOTMEGA_MESSAGE_FENCE_STATUS = 162,
  ARDUPILOTMEGA_MESSAGE_AHRS = 163,
  ARDUPILOTMEGA_MESSAGE_SIMSTATE = 164,
  ARDUPILOTMEGA_MESSAGE_HWSTATUS = 165,
  ARDUPILOTMEGA_MESSAGE_RADIO = 166,
  ARDUPILOTMEGA_MESSAGE_LIMITS_STATUS = 167,
  ARDUPILOTMEGA_MESSAGE_WIND = 168,
  ARDUPILOTMEGA_MESSAGE_DATA16 = 169,
  ARDUPILOTMEGA_MESSAGE_DATA32 = 170,
  ARDUPILOTMEGA_MESSAGE_DATA64 = 171,
  ARDUPILOTMEGA_MESSAGE_DATA96 = 172,
  ARDUPILOTMEGA_MESSAGE_RANGEFINDER = 173,
  ARDUPILOTMEGA_MESSAGE_AIRSPEED_AUTOCAL = 174,
  ARDUPILOTMEGA_MESSAGE_RALLY_POINT = 175,
  ARDUPILOTMEGA_MESSAGE_RALLY_FETCH_POINT = 176,
  ARDUPILOTMEGA_MESSAGE_COMPASSMOT_STATUS = 177,
  ARDUPILOTMEGA_MESSAGE_AHRS2 = 178,
  ARDUPILOTMEGA_MESSAGE_CAMERA_STATUS = 179,
  ARDUPILOTMEGA_MESSAGE_CAMERA_FEEDBACK = 180,
  ARDUPILOTMEGA_MESSAGE_BATTERY2 = 181,
  ARDUPILOTMEGA_MESSAGE_AHRS3 = 182,
  ARDUPILOTMEGA_MESSAGE_AUTOPILOT_VERSION_REQUEST = 183,
  ARDUPILOTMEGA_MESSAGE_REMOTE_LOG_DATA_BLOCK = 184,
  ARDUPILOTMEGA_MESSAGE_REMOTE_LOG_BLOCK_STATUS = 185,
  ARDUPILOTMEGA_MESSAGE_LED_CONTROL = 186,
  ARDUPILOTMEGA_MESSAGE_MAG_CAL_PROGRESS = 191,
  ARDUPILOTMEGA_MESSAGE_MAG_CAL_REPORT = 192,
  ARDUPILOTMEGA_MESSAGE_EKF_STATUS_REPORT = 193,
  ARDUPILOTMEGA_MESSAGE_PID_TUNING = 194,
  ARDUPILOTMEGA_MESSAGE_DEEPSTALL = 195,
  ARDUPILOTMEGA_MESSAGE_GIMBAL_REPORT = 200,
  ARDUPILOTMEGA_MESSAGE_GIMBAL_CONTROL = 201,
  ARDUPILOTMEGA_MESSAGE_GIMBAL_TORQUE_CMD_REPORT = 214,
  ARDUPILOTMEGA_MESSAGE_GOPRO_HEARTBEAT = 215,
  ARDUPILOTMEGA_MESSAGE_GOPRO_GET_REQUEST = 216,
  ARDUPILOTMEGA_MESSAGE_GOPRO_GET_RESPONSE = 217,
  ARDUPILOTMEGA_MESSAGE_GOPRO_SET_REQUEST = 218,
  ARDUPILOTMEGA_MESSAGE_GOPRO_SET_RESPONSE = 219,
  ARDUPILOTMEGA_MESSAGE_RPM = 226,
  ARDUPILOTMEGA_MESSAGE_ESTIMATOR_STATUS = 230,
  ARDUPILOTMEGA_MESSAGE_WIND_COV = 231,
  ARDUPILOTMEGA_MESSAGE_GPS_INPUT = 232,
  ARDUPILOTMEGA_MESSAGE_GPS_RTCM_DATA = 233,
  ARDUPILOTMEGA_MESSAGE_HIGH_LATENCY = 234,
  ARDUPILOTMEGA_MESSAGE_HIGH_LATENCY2 = 235,
  ARDUPILOTMEGA_MESSAGE_VIBRATION = 241,
  ARDUPILOTMEGA_MESSAGE_HOME_POSITION = 242,
  ARDUPILOTMEGA_MESSAGE_SET_HOME_POSITION = 243,
  ARDUPILOTMEGA_MESSAGE_MESSAGE_INTERVAL = 244,
  ARDUPILOTMEGA_MESSAGE_EXTENDED_SYS_STATE = 245,
  ARDUPILOTMEGA_MESSAGE_ADSB_VEHICLE = 246,
  ARDUPILOTMEGA_MESSAGE_COLLISION = 247,
  ARDUPILOTMEGA_MESSAGE_V2_EXTENSION = 248,
  ARDUPILOTMEGA_MESSAGE_MEMORY_VECT = 249,
  ARDUPILOTMEGA_MESSAGE_DEBUG_VECT = 250,
  ARDUPILOTMEGA_MESSAGE_NAMED_VALUE_FLOAT = 251,
  ARDUPILOTMEGA_MESSAGE_NAMED_VALUE_INT = 252,
  ARDUPILOTMEGA_MESSAGE_STATUSTEXT = 253,
  ARDUPILOTMEGA_MESSAGE_DEBUG = 254,
  ARDUPILOTMEGA_MESSAGE_SETUP_SIGNING = 256,
  ARDUPILOTMEGA_MESSAGE_BUTTON_CHANGE = 257,
  ARDUPILOTMEGA_MESSAGE_PLAY_TUNE = 258,
  ARDUPILOTMEGA_MESSAGE_CAMERA_INFORMATION = 259,
  ARDUPILOTMEGA_MESSAGE_CAMERA_SETTINGS = 260,
  ARDUPILOTMEGA_MESSAGE_STORAGE_INFORMATION = 261,
  ARDUPILOTMEGA_MESSAGE_CAMERA_CAPTURE_STATUS = 262,
  ARDUPILOTMEGA_MESSAGE_CAMERA_IMAGE_CAPTURED = 263,
  ARDUPILOTMEGA_MESSAGE_FLIGHT_INFORMATION = 264,
  ARDUPILOTMEGA_MESSAGE_MOUNT_ORIENTATION = 265,
  ARDUPILOTMEGA_MESSAGE_LOGGING_DATA = 266,
  ARDUPILOTMEGA_MESSAGE_LOGGING_DATA_ACKED = 267,
  ARDUPILOTMEGA_MESSAGE_LOGGING_ACK = 268,
  ARDUPILOTMEGA_MESSAGE_VIDEO_STREAM_INFORMATION = 269,
  ARDUPILOTMEGA_MESSAGE_VIDEO_STREAM_STATUS = 270,
  ARDUPILOTMEGA_MESSAGE_WIFI_CONFIG_AP = 299,
  ARDUPILOTMEGA_MESSAGE_PROTOCOL_VERSION = 300,
  ARDUPILOTMEGA_MESSAGE_UAVCAN_NODE_STATUS = 310,
  ARDUPILOTMEGA_MESSAGE_UAVCAN_NODE_INFO = 311,
  ARDUPILOTMEGA_MESSAGE_PARAM_EXT_REQUEST_READ = 320,
  ARDUPILOTMEGA_MESSAGE_PARAM_EXT_REQUEST_LIST = 321,
  ARDUPILOTMEGA_MESSAGE_PARAM_EXT_VALUE = 322,
  ARDUPILOTMEGA_MESSAGE_PARAM_EXT_SET = 323,
  ARDUPILOTMEGA_MESSAGE_PARAM_EXT_ACK = 324,
  ARDUPILOTMEGA_MESSAGE_OBSTACLE_DISTANCE = 330,
  ARDUPILOTMEGA_MESSAGE_ODOMETRY = 331,
  ARDUPILOTMEGA_MESSAGE_TRAJECTORY_REPRESENTATION_WAYPOINTS = 332,
  ARDUPILOTMEGA_MESSAGE_TRAJECTORY_REPRESENTATION_BEZIER = 333,
  ARDUPILOTMEGA_MESSAGE_CELLULAR_STATUS = 334,
  ARDUPILOTMEGA_MESSAGE_ISBD_LINK_STATUS = 335,
  ARDUPILOTMEGA_MESSAGE_UTM_GLOBAL_POSITION = 340,
  ARDUPILOTMEGA_MESSAGE_DEBUG_FLOAT_ARRAY = 350,
  ARDUPILOTMEGA_MESSAGE_ORBIT_EXECUTION_STATUS = 360,
  ARDUPILOTMEGA_MESSAGE_STATUSTEXT_LONG = 365,
  ARDUPILOTMEGA_MESSAGE_SMART_BATTERY_INFO = 370,
  ARDUPILOTMEGA_MESSAGE_SMART_BATTERY_STATUS = 371,
  ARDUPILOTMEGA_MESSAGE_ACTUATOR_OUTPUT_STATUS = 375,
  ARDUPILOTMEGA_MESSAGE_TIME_ESTIMATE_TO_TARGET = 380,
  ARDUPILOTMEGA_MESSAGE_WHEEL_DISTANCE = 9000,
  ARDUPILOTMEGA_MESSAGE_UAVIONIX_ADSB_OUT_CFG = 10001,
  ARDUPILOTMEGA_MESSAGE_UAVIONIX_ADSB_OUT_DYNAMIC = 10002,
  ARDUPILOTMEGA_MESSAGE_UAVIONIX_ADSB_TRANSCEIVER_HEALTH_REPORT = 10003,
  ARDUPILOTMEGA_MESSAGE_DEVICE_OP_READ = 11000,
  ARDUPILOTMEGA_MESSAGE_DEVICE_OP_READ_REPLY = 11001,
  ARDUPILOTMEGA_MESSAGE_DEVICE_OP_WRITE = 11002,
  ARDUPILOTMEGA_MESSAGE_DEVICE_OP_WRITE_REPLY = 11003,
  ARDUPILOTMEGA_MESSAGE_ADAP_TUNING = 11010,
  ARDUPILOTMEGA_MESSAGE_VISION_POSITION_DELTA = 11011,
  ARDUPILOTMEGA_MESSAGE_AOA_SSA = 11020,
  ARDUPILOTMEGA_MESSAGE_ESC_TELEMETRY_1_TO_4 = 11030,
  ARDUPILOTMEGA_MESSAGE_ESC_TELEMETRY_5_TO_8 = 11031,
  ARDUPILOTMEGA_MESSAGE_ESC_TELEMETRY_9_TO_12 = 11032,
  ARDUPILOTMEGA_MESSAGE_ICAROUS_HEARTBEAT = 42000,
  ARDUPILOTMEGA_MESSAGE_ICAROUS_KINEMATIC_BANDS = 42001
};
...
struct ardupilotmega_message {
  ...
  enum ARDUPILOTMEGA_MESSAGE msg_id;
  union {
    ...
    struct {
      ...
      int16_t current_battery;  /* Battery current, -1: autopilot does not
                                   measure the current */
      uint16_t
          drop_rate_comm;     /* Communication drop rate, (UART, I2C, SPI, CAN),
    ...
    struct {
      uint64_t time_usec; /* Timestamp (UNIX Epoch time or time since system
                             boot). The receiving end can infer timestamp format
    ...
    struct {
      ...
      char
          passkey[25]; /* Password / Key, depending on version plaintext or
    ...
    struct {
      ...
      uint8_t satellite_used[20]; /* 0: Satellite not used, 1: used for
                                     localization */
      uint8_t
          satellite_elevation[20];   /* Elevation (0: right on top of receiver,
    ...
    struct {
      ...
      uint8_t
          port; /* Servo output port (set of 8 outputs = 1 port). Flight stacks
                   running on Pixhawk should use: 0 = MAIN, 1 = AUX. */
    ...
    struct {
      uint32_t time_usec;  /* Timestamp (UNIX Epoch time or time since system
                              boot). The receiving end can infer timestamp format
                              (since 1.1.1970 or since system boot) by checking
                              for the magnitude the number. */
    ...
    struct {
      ...
      uint8_t target_system; /* System ID */
      uint64_t time_usec; /* EXTENSION Timestamp (UNIX Epoch time or time since
                             system boot). The receiving end can infer timestamp
                             format (since 1.1.1970 or since system boot) by
    ...
    struct {
      ...
      float param_value_max; /* Maximum param value. The protocol does not
                                ...
                                value. (Depends on implementation) */
      int16_t param_index; /* Parameter index. Send -1 to use the param ID field
                              as identifier (else the param id will be ignored),
                              send -2 to disable any existing map for this
                              rc_channel_index. */
      uint8_t target_system;    /* System ID */
      uint8_t target_component; /* Component ID */
      char param_id[16]; /* Onboard parameter id, terminated by NULL if the
    ...
    struct {
      int16_t start_index; /* Start index for partial mission change (-1 for all
                              items). */
      int16_t
    ...
    struct {
      ...
      uint8_t target_system;    /* System ID */
      uint8_t target_component; /* Component ID */
      enum MAV_FRAME frame; /* (uint8_t) Coordinate frame. Can be either global,
                               GPS, right-handed with Z axis up or local, right
                               handed, Z axis down. */
    ...
    struct {
      ...
      float covariance[9]; /* Row-major representation of a 3x3 attitude
                              ...
                              three entries are the first ROW, next three
                              entries are the second row, etc.). If unknown,
    ...
    struct {
      ...
      float covariance[36]; /* Row-major representation of a 6x6 position and
                               velocity 6x6 cross-covariance matrix (states:
                               lat, lon, alt, vx, vy, vz; first six entries are
                               the first ROW, next six entries are the second
                               row, etc.). If unknown, assign NaN value to first
                               element in the array. */
      enum MAV_ESTIMATOR_TYPE
          estimator_type; /* (uint8_t) Class id of the estimator this estimate
                             originated from. */
    ...
    struct {
      ...
      uint8_t chancount; /* Total number of RC channels being received. This can
                            be larger than 18, indicating that more channels are
    ...
    struct {
      ...
      int16_t z; /* Z-axis, normalized to the range [-1000,1000]. A value of
                    ...
                    1000 and minimum being -1000 on a joystick and the thrust of
                    a vehicle. Positive values are positive thrust, negative
     ...
     * receivers/transmitters might violate this specification. */
    struct {
      uint16_t chan1_raw; /* RC channel 1 value. A value of UINT16_MAX means to
                             ignore this field. */
      uint16_t chan2_raw; /* RC channel 2 value. A value of UINT16_MAX means to
                             ignore this field. */
      uint16_t chan3_raw; /* RC channel 3 value. A value of UINT16_MAX means to
                             ignore this field. */
      uint16_t chan4_raw; /* RC channel 4 value. A value of UINT16_MAX means to
                             ignore this field. */
      uint16_t chan5_raw; /* RC channel 5 value. A value of UINT16_MAX means to
                             ignore this field. */
      uint16_t chan6_raw; /* RC channel 6 value. A value of UINT16_MAX means to
                             ignore this field. */
      uint16_t chan7_raw; /* RC channel 7 value. A value of UINT16_MAX means to
                             ignore this field. */
      uint16_t chan8_raw; /* RC channel 8 value. A value of UINT16_MAX means to
                             ignore this field. */
      uint8_t target_system;    /* System ID */
      uint8_t target_component; /* Component ID */
    ...
    struct {
      ...
      float param3; /* PARAM3, see MAV_CMD enum */
      float param4; /* PARAM4, see MAV_CMD enum */
      int32_t x; /* PARAM5 / local: x position in meters * 1e4, global: latitude
                    in degrees * 10^7 */
      ...
      float z;   /* PARAM7 / z position: global: altitude in meters (relative or
                    absolute, depending on frame. */
      uint16_t seq; /* Waypoint ID (sequence number). Starts at zero. Increases
    ...
    struct {
      ...
      uint8_t target_component; /* Component which should execute the command, 0
                                   for all components */
      uint8_t
          confirmation; /* 0: First transmission of this command. 1-255:
    ...
    struct {
      ...
      uint8_t progress; /* EXTENSION WIP: Also used as result_param1, it can be
                           set with a enum containing the errors reasons of why
                           the command was denied or the progress percentage or
                           255 if unknown the progress when result is
                           MAV_RESULT_IN_PROGRESS. */
      uint8_t target_system;    /* EXTENSION WIP: System which requested the
                                   command to be executed */
      uint8_t target_component; /* EXTENSION WIP: Component which requested the
                                   command to be executed */
    } command_ack;
    ...
    struct {
      ...
      uint8_t target_component; /* Component ID */
      uint8_t
          type_mask; /* Mappings: If any of these bits are set, the
                        corresponding input should be ignored: bit 1: body roll
                        rate, bit 2: body pitch rate, bit 3: body yaw rate. bit
                        4-bit 6: reserved, bit 7: throttle, bit 8: attitude */
    } set_attitude_target;
    ...
    struct {
      ...
      enum POSITION_TARGET_TYPEMASK
          type_mask; /* (uint16_t) Bitmap to indicate which dimensions should be
                        ignored by the vehicle. */
      uint8_t target_system;    /* System ID */
      uint8_t target_component; /* Component ID */
      enum MAV_FRAME
          coordinate_frame; /* (uint8_t) Valid options are: MAV_FRAME_LOCAL_NED
                               = 1, MAV_FRAME_LOCAL_OFFSET_NED = 7,
                               MAV_FRAME_BODY_NED = 8, MAV_FRAME_BODY_OFFSET_NED
                               = 9 */
    ...
    struct {
      ...
      float controls[16]; /* Control outputs -1 .. 1. Channel assignment depends
    ...
    struct {
      ...
      float flow_comp_m_y;   /* Flow in y-sensor direction, angular-speed
                                compensated */
      float ground_distance; /* Ground distance. Positive value: distance known.
    ...
    struct {
      ...
      float yaw;     /* Yaw angle */
      float
          covariance[21];    /* EXTENSION Row-major representation of pose 6x6
                                cross-covariance matrix upper right triangle
                                (states: x_global, y_global, z_global, roll, pitch,
                                yaw; first six entries are the first ROW, next five
                                entries are the second ROW, etc.). If unknown,
                                assign NaN value to first element in the array. */
      uint8_t reset_counter; /* EXTENSION Estimate reset counter. This should be
                                incremented when the estimate resets in any of
                                the dimensions (position, velocity, attitude,
                                angular speed). This is designed to be used when
                                e.g an external SLAM system detects a
    ...
    struct {
      ...
      float pitch;   /* Pitch angle */
      float yaw;     /* Yaw angle */
      float covariance[21];  /* EXTENSION Row-major representation of pose 6x6
                                cross-covariance matrix upper right triangle
                                (states: x, y, z, roll, pitch, yaw; first six
                                entries are the first ROW, next five entries are
                                the second ROW, etc.). If unknown, assign NaN
    ...
    struct {
      ...
      float pitch;   /* Pitch angle */
      float yaw;     /* Yaw angle */
      float covariance[21]; /* EXTENSION Row-major representation of 6x6 pose
                               cross-covariance matrix upper right triangle
                               (states: x, y, z, roll, pitch, yaw; first six
                               entries are the first ROW, next five entries are
                               the second ROW, etc.). If unknown, assign NaN
    ...
    struct {
      ...
      uint16_t fields_updated; /* Bitmap for fields that have updated since last
    ...
    struct {
      uint64_t time_usec; /* Timestamp (UNIX Epoch time or time since system
                             ...
                             (since 1.1.1970 or since system boot) by checking
                             for the magnitude the number. */
      uint32_t integration_time_us; /* Integration time. Divide integrated_x and
                                       integrated_y by the integration time to
                                       obtain average flow. The integration time
                                       also indicates the. */
      float integrated_x; /* Flow around X axis (Sensor RH rotation about the X
                             axis induces a positive flow. Sensor linear motion
                             along the positive Y axis induces a negative flow.)
                           */
      float integrated_y; /* Flow around Y axis (Sensor RH rotation about the Y
                             axis induces a positive flow. Sensor linear motion
    ...
    struct {
      ...
      float pitch; /* Attitude pitch expressed as Euler angles, not recommended
                      except for human-readable outputs */
    ...
    struct {
      ...
      uint8_t remrssi; /* Remote (message receiver) signal strength indication
                          in device-dependent units/scale. Values: [0-254], 255:
                          invalid/unknown. */
      uint8_t txbuf;   /* Remaining free transmitter buffer space. */
      uint8_t noise; /* Local background noise level. These are device dependent
                        RSSI values (scale as approx 2x dB on SiK radios).
    ...
    struct {
      ...
      uint8_t
          payload[251]; /* Variable length payload. The length is defined by the
                           remaining message length when subtracting the header
                           and other fields.  The entire content of this block
                           is opaque unless you understand any the encoding
                           message_type.  The particular encoding used can be
                           extension specific and might not always be documented
    ...
    struct {
      ...
      uint16_t eph; /* GPS HDOP horizontal dilution of position. If unknown, set
                       to: 65535 */
    ...
    struct {
      uint64_t time_usec; /* Timestamp (UNIX Epoch time or time since system
                             ...
                             (since 1.1.1970 or since system boot) by checking
                             for the magnitude the number. */
      float attitude_quaternion[4]; /* Vehicle attitude expressed as normalized
                                       quaternion in w, x, y, z order (with 1 0
    ...
    struct {
      ...
      uint8_t
          payload; /* Payload size per packet (normally 253 byte, see DATA field
                      size in message ENCAPSULATED_DATA) (set on ACK only). */
    ...
    struct {
      ...
      float vertical_fov; /* EXTENSION Vertical Field of View (angle) where the
                             distance measurement is valid and the field of view
                             is known. Otherwise this is set to 0. */
      float
          quaternion[4]; /* EXTENSION Quaternion of the sensor orientation in
                            vehicle body frame (w, x, y, z order, zero-rotation
                            is 1, 0, 0, 0). Zero-rotation is along the vehicle
                            body x-axis. This field is required if the
                            orientation is set to MAV_SENSOR_ROTATION_CUSTOM.
    ...
    struct {
      ...
      float covariance[21]; /* EXTENSION Row-major representation of a pose 6x6
                               cross-covariance matrix upper right triangle
                               (states: x, y, z, roll, pitch, yaw; first six
                               entries are the first ROW, next five entries are
                               the second ROW, etc.). If unknown, assign NaN
    ...
    struct {
      uint64_t time_usec; /* Timestamp (UNIX Epoch time or time since system
                             ...
                             for the magnitude the number. */
      float
          controls[8]; /* Actuator controls. Normed to -1..+1 where 0 is neutral
                          position. Throttle for single rotation direction
                          motors is 0..1, negative range for reverse direction.
                          Standard mapping for attitude controls (group 0):
                          (index 0-7): roll, pitch, yaw, throttle, flaps,
                          spoilers, airbrakes, landing gear. Load a pass-through
    ...
    struct {
      ...
      float altitude_amsl;  /* This altitude measure is strictly above mean sea
                               level and might be non-monotonic (it might reset
                               on events like GPS lock or when a new QNH value is
                               set). It should be the altitude to which global
                               altitude waypoints are compared to. Note that it
                               is *not* the GPS altitude, however, most GPS
                               modules already output MSL by default and not the
                               WGS84 altitude. */
      ...
      float altitude_relative; /* This is the altitude above the home position.
                                  ...
                                  position. */
      float altitude_terrain; /* This is the altitude above terrain. It might be
                                 fed by a terrain database or an altimeter.
                                 Values smaller than -1000 should be interpreted
                                 as unknown. */
      float
          bottom_clearance; /* This is not the altitude, but the clear space
                               below the system according to the fused clearance
                               estimate. It generally should max out at the
                               maximum range of e.g. the laser altimeter. It is
                               generally a moving target. A negative value
    ...
    struct {
      uint8_t request_id; /* Request ID. This ID should be re-used when sending
                             back URI contents */
      uint8_t uri_type; /* The type of requested URI. 0 = a file via URL. 1 = a
                           UAVCAN binary */
      uint8_t uri[120]; /* The requested unique resource identifier (URI). It is
                           not necessarily a straight domain name (depends on
                           the URI type enum) */
      uint8_t transfer_type; /* The way the autopilot wants to receive the URI.
                                0 = MAVLink FTP. 1 = binary stream. */
      uint8_t
          storage[120]; /* The storage path the autopilot wants the URI to be
                           stored in. Will only be valid if the transfer_type
    ...
    struct {
      ...
      uint8_t
          est_capabilities; /* bit positions for tracker reporting capabilities
                               (POS = 0, VEL = 1, ACCEL = 2, ATT + RATES = 3) */
    } follow_target;
    ...
    struct {
      ...
      int16_t temperature; /* Temperature of the battery. INT16_MAX for unknown
                              temperature. */
      uint16_t voltages[10]; /* Battery voltage of cells. Cells above the valid
                                cell count for this battery should have the
                                UINT16_MAX value. */
      int16_t current_battery; /* Battery current, -1: autopilot does not
                                  measure the current */
      ...
      int8_t battery_remaining; /* Remaining battery energy. Values: [0-100],
                                   -1: autopilot does not estimate the remaining
                                   battery. */
      int32_t
          time_remaining; /* EXTENSION Remaining battery time, 0: autopilot does
                             not provide remaining battery time estimate */
      enum MAV_BATTERY_CHARGE_STATE
          charge_state; /* (uint8_t) EXTENSION State for extent of discharge,
                           provided by autopilot for warning or external
                           reactions */
    } battery_status;
    ...
    struct {
      ...
      uint8_t middleware_custom_version
          [8]; /* Custom version field, commonly the first 8 bytes of the git
                  ...
                  very large code bases. */
      uint8_t
          os_custom_version[8]; /* Custom version field, commonly the first 8
                                   bytes of the git hash. This is not an unique
                                   identifier, but should allow to identify the
                                   commit using the main version number even for
                                   very large code bases. */
      uint8_t uid2[18]; /* EXTENSION UID if provided by hardware (supersedes the
                           uid field. If this is non-zero, use this field,
                           otherwise use uid) */
    } autopilot_version;
    ...
    struct {
      ...
      uint32_t freemem32; /* EXTENSION Free memory (32 bit). */
    } meminfo;
    ...
    struct {
      ...
      uint16_t shutter_speed;   /* Divisor number //e.g. 1000 means 1/1000 (0
                                   means ignore). */
      uint8_t target_system;    /* System ID. */
      uint8_t target_component; /* Component ID. */
      uint8_t mode;     /* Mode enumeration from 1 to N //P, TV, AV, M, etc. (0
                           means ignore). */
      uint8_t aperture; /* F stop number x 10 //e.g. 28 means 2.8 (0 means
                           ignore). */
      uint8_t iso; /* ISO enumeration from 1 to N //e.g. 80, 100, 200, Etc (0
                      means ignore). */
      uint8_t exposure_type; /* Exposure type enumeration from 1 to N (0 means
                                ignore). */
      uint8_t command_id; /* Command Identity (incremental loop: 0 to 255). //A
                             command sent multiple times will be executed or
                             pooled just once. */
      uint8_t engine_cut_off; /* Main engine cut-off time before camera trigger
                                 (0 means no cut-off). */
    ...
    struct {
      ...
      uint8_t target_system;    /* System ID. */
      uint8_t target_component; /* Component ID. */
      uint8_t session; /* 0: stop, 1: start or keep it up //Session control e.g.
                          show/hide lens. */
      uint8_t
          zoom_pos; /* 1 to N //Zoom's absolute position (0 means ignore). */
      int8_t zoom_step; /* -100 to 100 //Zooming step value to offset zoom from
                           the current position. */
      uint8_t focus_lock;  /* 0: unlock focus or keep unlocked, 1: lock focus or
                              keep locked, 3: re-lock focus. */
    ...
    struct {
      uint8_t target_system;          /* System ID. */
      uint8_t target_component;       /* Component ID. */
      enum MAV_MOUNT_MODE mount_mode; /* (uint8_t) Mount operating mode. */
    ...
    struct {
      int32_t input_a; /* Pitch (centi-degrees) or lat (degE7), depending on
                          mount mode. */
      int32_t input_b; /* Roll (centi-degrees) or lon (degE7) depending on mount
                          mode. */
      int32_t input_c; /* Yaw (centi-degrees) or alt (cm) depending on mount
                          mode. */
      uint8_t target_system;    /* System ID. */
      uint8_t target_component; /* Component ID. */
      uint8_t save_position; /* If "1" it will save current trimmed position on
                                EEPROM (just valid for NEUTRAL and LANDING). */
    } mount_control;
    ...
    struct {
      ...
      uint8_t breach_status; /* Breach status (0 if currently inside fence, 1 if
                                outside). */
      enum FENCE_BREACH breach_type; /* (uint8_t) Last breach type. */
    } fence_status;
    ...
    struct {
      ...
      uint32_t
          last_recovery;   /* Time (since boot) of last successful recovery. */
      uint32_t last_clear; /* Time (since boot) of last all-clear. */
      uint16_t breach_count;            /* Number of fence breaches. */
      enum LIMITS_STATE limits_state;   /* (uint8_t) State of AP_Limits. */
      enum LIMIT_MODULE mods_enabled;   /* (uint8_t) AP_Limit_Module bitfield of
                                           enabled modules. */
      enum LIMIT_MODULE mods_required;  /* (uint8_t) AP_Limit_Module bitfield of
                                           required modules. */
      enum LIMIT_MODULE mods_triggered; /* (uint8_t) AP_Limit_Module bitfield of
                                           triggered modules. */
    } limits_status;
    ...
    struct {
      ...
      uint8_t count; /* Total number of points (for sanity checking). */
      enum RALLY_FLAGS flags; /* (uint8_t) Configuration flags. */
    } rally_point;
    ...
    /* Camera Event. */
    struct {
      uint64_t time_usec;    /* Image timestamp (since UNIX epoch, according to
                                camera clock). */
      float p1;              /* Parameter 1 (meaning depends on event_id, see
                                CAMERA_STATUS_TYPES enum). */
      float p2;              /* Parameter 2 (meaning depends on event_id, see
                                CAMERA_STATUS_TYPES enum). */
      float p3;              /* Parameter 3 (meaning depends on event_id, see
                                CAMERA_STATUS_TYPES enum). */
      float p4;              /* Parameter 4 (meaning depends on event_id, see
                                CAMERA_STATUS_TYPES enum). */
      uint16_t img_idx;      /* Image index. */
      uint8_t target_system; /* System ID. */
      uint8_t cam_idx;       /* Camera ID. */
      enum CAMERA_STATUS_TYPES event_id; /* (uint8_t) Event type. */
    } camera_status;

    /* Camera Capture Feedback. */
    struct {
      uint64_t time_usec; /* Image timestamp (since UNIX epoch), as passed in by
                             CAMERA_STATUS message (or autopilot if no CCB). */
      int32_t lat;        /* Latitude. */
      int32_t lng;        /* Longitude. */
      ...
      uint8_t target_system;            /* System ID. */
      uint8_t cam_idx;                  /* Camera ID. */
      enum CAMERA_FEEDBACK_FLAGS flags; /* (uint8_t) Feedback flags. */
      uint16_t completed_captures; /* EXTENSION Completed image captures. */
    } camera_feedback;
    ...
    struct {
      ...
      uint8_t target_component; /* Component ID. */
      enum MAV_REMOTE_LOG_DATA_BLOCK_STATUSES
          status; /* (uint8_t) Log data block status. */
    ...
    struct {
      uint8_t target_system;    /* System ID. */
      uint8_t target_component; /* Component ID. */
      uint8_t instance;   /* Instance (LED instance to control or 255 for all
                             LEDs). */
    ...
    struct {
      ...
      enum MAG_CAL_STATUS cal_status; /* (uint8_t) Calibration Status. */
      uint8_t attempt;                /* Attempt number. */
      uint8_t completion_pct;         /* Completion percentage. */
      uint8_t completion_mask[10];    /* Bitmask of sphere sections (see
    ...
    struct {
      ...
      uint8_t cal_mask;   /* Bitmask of compasses being calibrated. */
      enum MAG_CAL_STATUS cal_status; /* (uint8_t) Calibration Status. */
      uint8_t autosaved; /* 0=requires a MAV_CMD_DO_ACCEPT_MAG_CAL, 1=saved to
                            parameters. */
      float orientation_confidence; /* EXTENSION Confidence in orientation
                                       (higher is better). */
      enum MAV_SENSOR_ORIENTATION
          old_orientation; /* (uint8_t) EXTENSION orientation before
                              calibration. */
      enum MAV_SENSOR_ORIENTATION
          new_orientation; /* (uint8_t) EXTENSION orientation after calibration.
                            */
    } mag_cal_report;
    ...
    struct {
      ...
      enum EKF_STATUS_FLAGS flags; /* (uint16_t) Flags. */
      float airspeed_variance;     /* EXTENSION Airspeed variance. */
    } ekf_status_report;
    ...
    struct {
      ...
      float I;                   /* I component. */
      float D;                   /* D component. */
      enum PID_TUNING_AXIS axis; /* (uint8_t) Axis. */
    } pid_tuning;
    ...
    struct {
      ...
      float expected_travel_distance; /* Distance the aircraft expects to travel
                                         during the deepstall. */
      float cross_track_error; /* Deepstall cross track error (only valid when
                                  in DEEPSTALL_STAGE_LAND). */
      enum DEEPSTALL_STAGE stage; /* (uint8_t) Deepstall stage. */
    } deepstall;
    ...
    struct {
      enum GOPRO_HEARTBEAT_STATUS status; /* (uint8_t) Status. */
      enum GOPRO_CAPTURE_MODE
          capture_mode;                 /* (uint8_t) Current capture mode. */
      enum GOPRO_HEARTBEAT_FLAGS flags; /* (uint8_t) Additional status bits. */
    } gopro_heartbeat;
    ...
    struct {
      uint8_t target_system;     /* System ID. */
      uint8_t target_component;  /* Component ID. */
      enum GOPRO_COMMAND cmd_id; /* (uint8_t) Command ID. */
    } gopro_get_request;

    /* Response from a GOPRO_COMMAND get request. */
    struct {
      enum GOPRO_COMMAND cmd_id;        /* (uint8_t) Command ID. */
      enum GOPRO_REQUEST_STATUS status; /* (uint8_t) Status. */
    ...
    struct {
      ...
      float var_horiz; /* Variability of the wind in XY. RMS of a 1 Hz lowpassed
                          wind estimate. */
    ...
    struct {
      uint8_t
          flags;   /* LSB: 1 means message is fragmented, next 2 bits are the
                      fragment ID, the remaining 5 bits are used for the sequence
                      ID. Messages are only to be flushed to the GPS when the
                      entire message has been reconstructed on the autopilot. The
                      fragment ID specifies which order the fragments should be
                      assembled into a buffer, while the sequence ID is used to
                      detect a mismatch between different buffers. The buffer is
                      considered fully reconstructed when either all 4 fragments
                      are present, or all the fragments before the first fragment
                      with a non full payload is received. This management is used
                      to ensure that normal GPS operation doesn't corrupt RTCM
                      data, and to recover from a unreliable transport delivery
                      order. */
      uint8_t len; /* data length */
    ...
    struct {
      ...
      enum MAV_LANDED_STATE landed_state; /* (uint8_t) The landed state. Is set
                                             to MAV_LANDED_STATE_UNDEFINED if
      ...
      int8_t temperature_air; /* Air temperature (degrees C) from airspeed
                                 sensor */
      uint8_t failsafe; /* failsafe (each bit represents a failsafe where 0=ok,
    ...
    struct {
      ...
      float z;    /* Local Z position of this position in the local coordinate
                     frame */
      float q[4]; /* World to surface normal and heading transformation of the
      ...
      float
          approach_x; /* Local X position of the end of the approach vector.
                         ...
                         takeoff path. Grass-landing fixed wing aircraft should
                         set it the same way as multicopters. Runway-landing
                         fixed wing aircraft should set it to the opposite
                         direction of the takeoff, assuming the takeoff happened
    ...
    struct {
      int32_t interval_us; /* The interval between two messages. A value of -1
                              indicates this stream is disabled, 0 indicates it
                              is not available, &gt; 0 indicates the interval at
                              which it is sent. */
    ...
    struct {
      enum MAV_VTOL_STATE vtol_state; /* (uint8_t) The VTOL state if applicable.
                                         Is set to MAV_VTOL_STATE_UNDEFINED if
    ...
    struct {
      ...
      float altitude_minimum_delta; /* Closest vertical distance between vehicle
                                       and object */
      ...
      enum MAV_COLLISION_ACTION action; /* (uint8_t) Action that is being taken
                                           to avoid this collision */
      enum MAV_COLLISION_THREAT_LEVEL
          threat_level; /* (uint8_t) How concerned the aircraft is about this
                           collision */
    } collision;
    ...
    struct {
      ...
      uint8_t target_component; /* Component ID (0 for broadcast) */
      uint8_t
          payload[249]; /* Variable length payload. The length is defined by the
                           remaining message length when subtracting the header
                           and other fields.  The entire content of this block
                           is opaque unless you understand any the encoding
                           message_type.  The particular encoding used can be
     ...
     * (e.g. 10 Hz). */
    struct {
      enum MAV_SEVERITY severity; /* (uint8_t) Severity of status. Relies on the
                                     definitions within RFC-5424. */
    ...
    struct {
      ...
      char cam_definition_uri[140]; /* Camera definition URI (if any, otherwise
    ...
    struct {
      ...
      float zoomLevel; /* EXTENSION Current zoom level (0.0 to 100.0, NaN if not
                          known) */
    ...
    struct {
      ...
      float used_capacity;      /* Used capacity. If storage is not ready
                                   (STORAGE_STATUS_READY) value will be ignored. */
      float available_capacity; /* Available storage capacity. If storage is not
    ...
    struct {
      ...
      uint8_t image_status; /* Current status of image capturing (0: idle, 1:
    ...
    struct {
      ...
      int32_t image_index; /* Zero based index of this image (image count since
                              armed -1) */
    ...
    struct {
      ...
      uint64_t takeoff_time_utc; /* Timestamp at takeoff (time since UNIX epoch)
                                    in UTC, 0 for unknown */
    ...
    struct {
      ...
      float yaw_absolute; /* EXTENSION Yaw in absolute frame, North is 0 (set to
                             NaN for invalid). */
    } mount_orientation;
    ...
    struct {
      ...
      char uri[160]; /* Video stream URI (TCP or RTSP URI ground station should
    ...
    struct {
      char ssid[32]; /* Name of Wi-Fi network (SSID). Leave it blank to leave it
                        unchanged. */
    ...
    struct {
      ...
      uint8_t spec_version_hash[8]; /* The first 8 bytes (not characters printed
                                       in hex!) of the git hash. */
    ...
    struct {
      ...
      uint32_t uptime_sec; /* Time since the start-up of the node. */
      uint32_t
          sw_vcs_commit; /* Version control system (VCS) revision identifier
                            (e.g. git short commit hash). Zero if unknown. */
    ...
    struct {
      ...
      uint8_t target_system;    /* System ID */
      uint8_t target_component; /* Component ID */
      char param_id[16]; /* Parameter id, terminated by NULL if the length is
    ...
    struct {
      ...
      float
          increment_f;    /* EXTENSION Angular width in degrees of each array
                             element as a float. If greater than 0 then this value
                             is used instead of the uint8_t increment field. */
      float angle_offset; /* EXTENSION Relative angle offset of the 0-index
    ...
    struct {
      ...
      float yawspeed;     /* Yaw angular speed */
      float
          pose_covariance[21]; /* Row-major representation of a 6x6 pose
                                  cross-covariance matrix upper right triangle
                                  (states: x, y, z, roll, pitch, yaw; first six
                                  entries are the first ROW, next five entries
                                  are the second ROW, etc.). If unknown, assign
    ...
    struct {
      uint64_t timestamp; /* Timestamp (UNIX Epoch time or time since system
                             boot). The receiving end can infer timestamp format
                             (since 1.1.1970 or since system boot) by checking
                             for the magnitude the number. */
      uint64_t last_heartbeat;  /* Timestamp of the last successful sbd session.
                                   The receiving end can infer timestamp format
                                   (since 1.1.1970 or since system boot) by
                                   checking for the magnitude the number. */
      uint16_t failed_sessions; /* Number of failed SBD sessions. */
      uint16_t successful_sessions; /* Number of successful SBD sessions. */
      uint8_t signal_quality; /* Signal quality equal to the number of bars
                                 displayed on the ISU signal strength indicator.
                                 Range is 0 to 5, where 0 indicates no signal
                                 and 5 indicates maximum signal strength. */
    ...
    struct {
      ...
      int32_t y; /* Y coordinate of center point.  Coordinate system depends on
                    frame field: local = x position in meters * 1e4, global =
                    latitude in degrees * 1e7. */
    ...
    struct {
      ...
      uint16_t discharge_minimum_voltage; /* Minimum per-cell voltage when
      ...
      uint16_t charging_minimum_voltage;  /* Minimum per-cell voltage when
                                             ...
                                             UINT16_MAX value. */
      uint16_t
          resting_minimum_voltage; /* Minimum per-cell voltage when resting. If
                                      not supplied set to UINT16_MAX value. */
      uint8_t id;                  /* Battery ID */
    ...
    struct {
      ...
      int32_t time_remaining; /* Estimated remaining battery time. -1: field not
                                 provided. */
      uint16_t id;            /* Battery ID */
      int16_t capacity_remaining; /* Remaining battery energy. Values: [0-100],
                                     -1: field not provided. */
      int16_t current; /* Battery current (through all cells/loads). Positive if
                          discharging, negative if charging. UINT16_MAX: field
                          not provided. */
      ...
      uint16_t cell_offset; /* The cell number of the first index in the
                               ...
                               more than 16 cells. */
      uint16_t
          voltages[16]; /* Individual cell voltages. Batteries with more 16
                           cells can use the cell_offset field to specify the
                           cell offset for the array specified in the current
                           message . Index values above the valid cell count for
    ...
    struct {
      ...
      int32_t land;    /* Estimated time for vehicle to complete the LAND action
                          from its current position. -1 indicates that the vehicle
                          is landed, or that no time estimate available. */
      ...
      int32_t mission_end; /* Estimated time for completing the current mission.
                              ...
                              available. */
      int32_t commanded_action; /* Estimated time for completing the current
    ...
    struct {
      ...
      enum ADSB_EMITTER_TYPE emitterType; /* (uint8_t) Transmitting vehicle
                                             type. See ADSB_EMITTER_TYPE enum */
      enum UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE
          aircraftSize; /* (uint8_t) Aircraft length and width encoding (table
                           2-35 of DO-282B) */
      enum UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LAT
          gpsOffsetLat; /* (uint8_t) GPS antenna lateral offset (table 2-36 of
                           DO-282B) */
      enum UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LON
          gpsOffsetLon; /* (uint8_t) GPS antenna longitudinal offset from nose
                           [if non-zero, take position (in meters) divide by 2
                           and add one] (table 2-37 DO-282B) */
      enum UAVIONIX_ADSB_OUT_RF_SELECT
          rfSelect; /* (uint8_t) ADS-B transponder reciever and transmit enable
                       flags */
    } uavionix_adsb_out_cfg;

    /* Dynamic data used to generate ADS-B out transponder data (send at 5Hz) */
    struct {
      uint32_t utcTime; /* UTC time in seconds since GPS epoch (Jan 6, 1980). If
                           unknown set to UINT32_MAX */
      int32_t
      ...
      int32_t baroAltMSL;    /* Barometric pressure altitude (MSL) relative to a
                                standard atmosphere of 1013.2 mBar and NOT bar
                                corrected altitude (m * 1E-3). (up +ve). If unknown
                                set to INT32_MAX */
      uint32_t accuracyHor;  /* Horizontal accuracy in mm (m * 1E-3). If unknown
                                set to UINT32_MAX */
      uint16_t accuracyVert; /* Vertical accuracy in cm. If unknown set to
                                UINT16_MAX */
      uint16_t accuracyVel;  /* Velocity accuracy in mm/s (m * 1E-3). If unknown
                                set to UINT16_MAX */
      int16_t
          velVert; /* GPS vertical speed in cm/s. If unknown set to INT16_MAX */
      int16_t velNS; /* North-South velocity over ground in cm/s North +ve. If
                        unknown set to INT16_MAX */
      int16_t VelEW; /* East-West velocity over ground in cm/s East +ve. If
                        unknown set to INT16_MAX */
      enum UAVIONIX_ADSB_OUT_DYNAMIC_STATE
          state; /* (uint16_t) ADS-B transponder dynamic input state flags */
      uint16_t squawk; /* Mode A code (typically 1200 [0x04B0] for VFR) */
      enum UAVIONIX_ADSB_OUT_DYNAMIC_GPS_FIX
          gpsFix; /* (uint8_t) 0-1: no fix, 2: 2D fix, 3: 3D fix, 4: DGPS, 5:
                     RTK */
      uint8_t numSats; /* Number of satellites visible. If unknown set to
                          UINT8_MAX */
      enum UAVIONIX_ADSB_EMERGENCY_STATUS
          emergencyStatus; /* (uint8_t) Emergency status */
    } uavionix_adsb_out_dynamic;

    /* Transceiver heartbeat with health report (updated every 10s) */
    struct {
      enum UAVIONIX_ADSB_RF_HEALTH
          rfHealth; /* (uint8_t) ADS-B transponder messages */
    ...
    struct {
      ...
      uint8_t target_system;          /* System ID. */
      uint8_t target_component;       /* Component ID. */
      enum DEVICE_OP_BUSTYPE bustype; /* (uint8_t) The bus type. */
    ...
    struct {
      ...
      float angle_delta[3];     /* Defines a rotation vector in body frame that
                                   rotates the vehicle from the previous to the
                                   current orientation. */
      float position_delta[3];  /* Change in position from previous to current
                                   frame rotated into body frame (0=forward,
                                   1=right, 2=down). */
    ...
    struct {
      ...
      uint16_t
          count[4]; /* count of telemetry packets received (wraps at 65535). */
 ...
 *
 * implemented in ardupilotmega_sign.c
 */
void ardupilotmega_message_sign(struct ardupilotmega_message *msg,
                                uint8_t shared[32]);
int ardupilotmega_message_signed(struct ardupilotmega_message *msg,
                                 uint8_t shared[32]);
 ...
 *
 * implemented in ardupilotmega_enc.c
 */
size_t ardupilotmega_message_serialize_v1(struct ardupilotmega_message *msg,
                                          uint8_t *buf, size_t size);
size_t ardupilotmega_message_serialize_v2(struct ardupilotmega_message *msg,
                                          uint8_t *buf, size_t size);
 ...
 *
 * implemented in ardupilotmega_dec.c
 */
 ...
 * implemented in ardupilotmega_fmt.c
 */
size_t ardupilotmega_message_snprintf(char *buf, size_t size,
                                      const struct ardupilotmega_message *msg);
