...
static void append_payload_base(uint8_t **p, struct asluav_message *msg) {
  switch (msg->msg_id) {
  ...
  case ASLUAV_MESSAGE_COMMAND_INT_STAMPED:
    append_uint64(p, msg->command_int_stamped.vehicle_timestamp);
    append_uint32(p, msg->command_int_stamped.utc_time);
    append_float32(p, msg->command_int_stamped.param1);
    append_float32(p, msg->command_int_stamped.param2);
    append_float32(p, msg->command_int_stamped.param3);
    append_float32(p, msg->command_int_stamped.param4);
    append_int32(p, msg->command_int_stamped.x);
    append_int32(p, msg->command_int_stamped.y);
    append_float32(p, msg->command_int_stamped.z);
    append_uint16(p, msg->command_int_stamped.command);
    append_byte(p, msg->command_int_stamped.target_system);
    append_byte(p, msg->command_int_stamped.target_component);
    append_byte(p, msg->command_int_stamped.frame);
    append_byte(p, msg->command_int_stamped.current);
    append_byte(p, msg->command_int_stamped.autocontinue);
    break;

  case ASLUAV_MESSAGE_COMMAND_LONG_STAMPED:
    append_uint64(p, msg->command_long_stamped.vehicle_timestamp);
    append_uint32(p, msg->command_long_stamped.utc_time);
    append_float32(p, msg->command_long_stamped.param1);
    append_float32(p, msg->command_long_stamped.param2);
    append_float32(p, msg->command_long_stamped.param3);
    append_float32(p, msg->command_long_stamped.param4);
    append_float32(p, msg->command_long_stamped.param5);
    append_float32(p, msg->command_long_stamped.param6);
    append_float32(p, msg->command_long_stamped.param7);
    append_uint16(p, msg->command_long_stamped.command);
    append_byte(p, msg->command_long_stamped.target_system);
    append_byte(p, msg->command_long_stamped.target_component);
    append_byte(p, msg->command_long_stamped.confirmation);
    break;
  ...
  case ASLUAV_MESSAGE_SENS_POWER:
    append_float32(p, msg->sens_power.adc121_vspb_volt);
    append_float32(p, msg->sens_power.adc121_cspb_amp);
    append_float32(p, msg->sens_power.adc121_cs1_amp);
    append_float32(p, msg->sens_power.adc121_cs2_amp);
    break;

  case ASLUAV_MESSAGE_SENS_MPPT:
    append_uint64(p, msg->sens_mppt.mppt_timestamp);
    append_float32(p, msg->sens_mppt.mppt1_volt);
    append_float32(p, msg->sens_mppt.mppt1_amp);
    append_float32(p, msg->sens_mppt.mppt2_volt);
    append_float32(p, msg->sens_mppt.mppt2_amp);
    append_float32(p, msg->sens_mppt.mppt3_volt);
    append_float32(p, msg->sens_mppt.mppt3_amp);
    append_uint16(p, msg->sens_mppt.mppt1_pwm);
    append_uint16(p, msg->sens_mppt.mppt2_pwm);
    append_uint16(p, msg->sens_mppt.mppt3_pwm);
    append_byte(p, msg->sens_mppt.mppt1_status);
    append_byte(p, msg->sens_mppt.mppt2_status);
    append_byte(p, msg->sens_mppt.mppt3_status);
    break;

  case ASLUAV_MESSAGE_ASLCTRL_DATA:
    append_uint64(p, msg->aslctrl_data.timestamp);
    append_float32(p, msg->aslctrl_data.h);
    append_float32(p, msg->aslctrl_data.hRef);
    append_float32(p, msg->aslctrl_data.hRef_t);
    append_float32(p, msg->aslctrl_data.PitchAngle);
    append_float32(p, msg->aslctrl_data.PitchAngleRef);
    append_float32(p, msg->aslctrl_data.q);
    append_float32(p, msg->aslctrl_data.qRef);
    append_float32(p, msg->aslctrl_data.uElev);
    append_float32(p, msg->aslctrl_data.uThrot);
    append_float32(p, msg->aslctrl_data.uThrot2);
    append_float32(p, msg->aslctrl_data.nZ);
    append_float32(p, msg->aslctrl_data.AirspeedRef);
    append_float32(p, msg->aslctrl_data.YawAngle);
    append_float32(p, msg->aslctrl_data.YawAngleRef);
    append_float32(p, msg->aslctrl_data.RollAngle);
    append_float32(p, msg->aslctrl_data.RollAngleRef);
    append_float32(p, msg->aslctrl_data.p);
    append_float32(p, msg->aslctrl_data.pRef);
    append_float32(p, msg->aslctrl_data.r);
    append_float32(p, msg->aslctrl_data.rRef);
    append_float32(p, msg->aslctrl_data.uAil);
    append_float32(p, msg->aslctrl_data.uRud);
    append_byte(p, msg->aslctrl_data.aslctrl_mode);
    append_byte(p, msg->aslctrl_data.SpoilersEngaged);
    break;

  case ASLUAV_MESSAGE_ASLCTRL_DEBUG:
    append_uint32(p, msg->aslctrl_debug.i32_1);
    append_float32(p, msg->aslctrl_debug.f_1);
    append_float32(p, msg->aslctrl_debug.f_2);
    append_float32(p, msg->aslctrl_debug.f_3);
    append_float32(p, msg->aslctrl_debug.f_4);
    append_float32(p, msg->aslctrl_debug.f_5);
    append_float32(p, msg->aslctrl_debug.f_6);
    append_float32(p, msg->aslctrl_debug.f_7);
    append_float32(p, msg->aslctrl_debug.f_8);
    append_byte(p, msg->aslctrl_debug.i8_1);
    append_byte(p, msg->aslctrl_debug.i8_2);
    break;

  case ASLUAV_MESSAGE_ASLUAV_STATUS:
    append_float32(p, msg->asluav_status.Motor_rpm);
    append_byte(p, msg->asluav_status.LED_status);
    append_byte(p, msg->asluav_status.SATCOM_status);
    for (size_t i = 0; i < 8; i++)
      append_byte(p, msg->asluav_status.Servo_status[i]);
    break;

  case ASLUAV_MESSAGE_EKF_EXT:
    append_uint64(p, msg->ekf_ext.timestamp);
    append_float32(p, msg->ekf_ext.Windspeed);
    append_float32(p, msg->ekf_ext.WindDir);
    append_float32(p, msg->ekf_ext.WindZ);
    append_float32(p, msg->ekf_ext.Airspeed);
    append_float32(p, msg->ekf_ext.beta);
    append_float32(p, msg->ekf_ext.alpha);
    break;

  case ASLUAV_MESSAGE_ASL_OBCTRL:
    append_uint64(p, msg->asl_obctrl.timestamp);
    append_float32(p, msg->asl_obctrl.uElev);
    append_float32(p, msg->asl_obctrl.uThrot);
    append_float32(p, msg->asl_obctrl.uThrot2);
    append_float32(p, msg->asl_obctrl.uAilL);
    append_float32(p, msg->asl_obctrl.uAilR);
    append_float32(p, msg->asl_obctrl.uRud);
    append_byte(p, msg->asl_obctrl.obctrl_status);
    break;

  case ASLUAV_MESSAGE_SENS_ATMOS:
    append_uint64(p, msg->sens_atmos.timestamp);
    append_float32(p, msg->sens_atmos.TempAmbient);
    append_float32(p, msg->sens_atmos.Humidity);
    break;

  case ASLUAV_MESSAGE_SENS_BATMON:
    append_uint64(p, msg->sens_batmon.batmon_timestamp);
    append_float32(p, msg->sens_batmon.temperature);
    append_uint32(p, msg->sens_batmon.safetystatus);
    append_uint32(p, msg->sens_batmon.operationstatus);
    append_uint16(p, msg->sens_batmon.voltage);
    append_int16(p, msg->sens_batmon.current);
    append_uint16(p, msg->sens_batmon.batterystatus);
    append_uint16(p, msg->sens_batmon.serialnumber);
    append_uint16(p, msg->sens_batmon.cellvoltage1);
    append_uint16(p, msg->sens_batmon.cellvoltage2);
    append_uint16(p, msg->sens_batmon.cellvoltage3);
    append_uint16(p, msg->sens_batmon.cellvoltage4);
    append_uint16(p, msg->sens_batmon.cellvoltage5);
    append_uint16(p, msg->sens_batmon.cellvoltage6);
    append_byte(p, msg->sens_batmon.SoC);
    break;

  case ASLUAV_MESSAGE_FW_SOARING_DATA:
    append_uint64(p, msg->fw_soaring_data.timestamp);
    append_uint64(p, msg->fw_soaring_data.timestampModeChanged);
    append_float32(p, msg->fw_soaring_data.xW);
    append_float32(p, msg->fw_soaring_data.xR);
    append_float32(p, msg->fw_soaring_data.xLat);
    append_float32(p, msg->fw_soaring_data.xLon);
    append_float32(p, msg->fw_soaring_data.VarW);
    append_float32(p, msg->fw_soaring_data.VarR);
    append_float32(p, msg->fw_soaring_data.VarLat);
    append_float32(p, msg->fw_soaring_data.VarLon);
    append_float32(p, msg->fw_soaring_data.LoiterRadius);
    append_float32(p, msg->fw_soaring_data.LoiterDirection);
    append_float32(p, msg->fw_soaring_data.DistToSoarPoint);
    append_float32(p, msg->fw_soaring_data.vSinkExp);
    append_float32(p, msg->fw_soaring_data.z1_LocalUpdraftSpeed);
    append_float32(p, msg->fw_soaring_data.z2_DeltaRoll);
    append_float32(p, msg->fw_soaring_data.z1_exp);
    append_float32(p, msg->fw_soaring_data.z2_exp);
    append_float32(p, msg->fw_soaring_data.ThermalGSNorth);
    append_float32(p, msg->fw_soaring_data.ThermalGSEast);
    append_float32(p, msg->fw_soaring_data.TSE_dot);
    append_float32(p, msg->fw_soaring_data.DebugVar1);
    append_float32(p, msg->fw_soaring_data.DebugVar2);
    append_byte(p, msg->fw_soaring_data.ControlMode);
    append_byte(p, msg->fw_soaring_data.valid);
    break;

  case ASLUAV_MESSAGE_SENSORPOD_STATUS:
    append_uint64(p, msg->sensorpod_status.timestamp);
    append_uint16(p, msg->sensorpod_status.free_space);
    append_byte(p, msg->sensorpod_status.visensor_rate_1);
    append_byte(p, msg->sensorpod_status.visensor_rate_2);
    append_byte(p, msg->sensorpod_status.visensor_rate_3);
    append_byte(p, msg->sensorpod_status.visensor_rate_4);
    append_byte(p, msg->sensorpod_status.recording_nodes_count);
    append_byte(p, msg->sensorpod_status.cpu_temp);
    break;

  case ASLUAV_MESSAGE_SENS_POWER_BOARD:
    append_uint64(p, msg->sens_power_board.timestamp);
    append_float32(p, msg->sens_power_board.pwr_brd_system_volt);
    append_float32(p, msg->sens_power_board.pwr_brd_servo_volt);
    append_float32(p, msg->sens_power_board.pwr_brd_digital_volt);
    append_float32(p, msg->sens_power_board.pwr_brd_mot_l_amp);
    append_float32(p, msg->sens_power_board.pwr_brd_mot_r_amp);
    append_float32(p, msg->sens_power_board.pwr_brd_analog_amp);
    append_float32(p, msg->sens_power_board.pwr_brd_digital_amp);
    append_float32(p, msg->sens_power_board.pwr_brd_ext_amp);
    append_float32(p, msg->sens_power_board.pwr_brd_aux_amp);
    append_byte(p, msg->sens_power_board.pwr_brd_status);
    append_byte(p, msg->sens_power_board.pwr_brd_led_status);
    break;

  case ASLUAV_MESSAGE_GSM_LINK_STATUS:
    append_uint64(p, msg->gsm_link_status.timestamp);
    append_byte(p, msg->gsm_link_status.gsm_modem_type);
    append_byte(p, msg->gsm_link_status.gsm_link_type);
    append_byte(p, msg->gsm_link_status.rssi);
    append_byte(p, msg->gsm_link_status.rsrp_rscp);
    append_byte(p, msg->gsm_link_status.sinr_ecio);
    append_byte(p, msg->gsm_link_status.rsrq);
    break;
...
static void append_payload_ext(uint8_t **p, struct asluav_message *msg) {
  switch (msg->msg_id) {
...
size_t asluav_message_serialize_v1(struct asluav_message *msg, uint8_t *buf,
  ...
  *p++ = msg->msg_id;
  ...
  crc = x25(crc, asluav_crcextra(msg->msg_id));
