...
// Generated enums and structures for Mavlink dialect autoquad #0 version 3
 ...
 * AUTOQUAD_MAVLINK_DEFS_VERSION_ENUM_END). Append a new entry for each
 * published change. */
enum AUTOQUAD_MAVLINK_DEFS_VERSION { AQ_MAVLINK_DEFS_VERSION_1 = 1 };

/* Available operating modes/statuses for AutoQuad flight controller. Bitmask
 * up to 32 bits. Low side bits for base modes, high side for      additional
 * active features/modifiers/constraints. */
enum AUTOQUAD_NAV_STATUS {
  /* System is initializing */
  AQ_NAV_STATUS_INIT = 0,
  /* System is *armed* and standing by, with no throttle input and no autonomous
     mode */
  AQ_NAV_STATUS_STANDBY = 0x00000001,
  /* Flying (throttle input detected), assumed under manual control unless other
     mode bits are set */
  AQ_NAV_STATUS_MANUAL = 0x00000002,
  /* Altitude hold engaged */
  AQ_NAV_STATUS_ALTHOLD = 0x00000004,
  /* Position hold engaged */
  AQ_NAV_STATUS_POSHOLD = 0x00000008,
  /* Externally-guided (eg. GCS) navigation mode */
  AQ_NAV_STATUS_GUIDED = 0x00000010,
  /* Autonomous mission execution mode */
  AQ_NAV_STATUS_MISSION = 0x00000020,
  /* Ready but *not armed* */
  AQ_NAV_STATUS_READY = 0x00000100,
  /* Calibration mode active */
  AQ_NAV_STATUS_CALIBRATING = 0x00000200,
  /* No valid control input (eg. no radio link) */
  AQ_NAV_STATUS_NO_RC = 0x00001000,
  /* Battery is low (stage 1 warning) */
  AQ_NAV_STATUS_FUEL_LOW = 0x00002000,
  /* Battery is depleted (stage 2 warning) */
  AQ_NAV_STATUS_FUEL_CRITICAL = 0x00004000,
  /* Dynamic Velocity Hold is active (PH with proportional manual direction
     override) */
  AQ_NAV_STATUS_DVH = 0x01000000,
  /* Dynamic Altitude Override is active (AH with proportional manual
     adjustment) */
  AQ_NAV_STATUS_DAO = 0x02000000,
  /* Craft is at ceiling altitude */
  AQ_NAV_STATUS_CEILING_REACHED = 0x04000000,
  /* Ceiling altitude is set */
  AQ_NAV_STATUS_CEILING = 0x08000000,
  /* Heading-Free dynamic mode active */
  AQ_NAV_STATUS_HF_DYNAMIC = 0x10000000,
  /* Heading-Free locked mode active */
  AQ_NAV_STATUS_HF_LOCKED = 0x20000000,
  /* Automatic Return to Home is active */
  AQ_NAV_STATUS_RTH = 0x40000000,
  /* System is in failsafe recovery mode */
  AQ_NAV_STATUS_FAILSAFE = 0x80000000
};
...
// This enum is used to switch the anonymous union in autoquad_message.
enum AUTOQUAD_MESSAGE {
  AUTOQUAD_MESSAGE_HEARTBEAT = 0,
  AUTOQUAD_MESSAGE_SYS_STATUS = 1,
  AUTOQUAD_MESSAGE_SYSTEM_TIME = 2,
  AUTOQUAD_MESSAGE_PING = 4,
  AUTOQUAD_MESSAGE_CHANGE_OPERATOR_CONTROL = 5,
  AUTOQUAD_MESSAGE_CHANGE_OPERATOR_CONTROL_ACK = 6,
  AUTOQUAD_MESSAGE_AUTH_KEY = 7,
  AUTOQUAD_MESSAGE_LINK_NODE_STATUS = 8,
  AUTOQUAD_MESSAGE_SET_MODE = 11,
  AUTOQUAD_MESSAGE_PARAM_REQUEST_READ = 20,
  AUTOQUAD_MESSAGE_PARAM_REQUEST_LIST = 21,
  AUTOQUAD_MESSAGE_PARAM_VALUE = 22,
  AUTOQUAD_MESSAGE_PARAM_SET = 23,
  AUTOQUAD_MESSAGE_GPS_RAW_INT = 24,
  AUTOQUAD_MESSAGE_GPS_STATUS = 25,
  AUTOQUAD_MESSAGE_SCALED_IMU = 26,
  AUTOQUAD_MESSAGE_RAW_IMU = 27,
  AUTOQUAD_MESSAGE_RAW_PRESSURE = 28,
  AUTOQUAD_MESSAGE_SCALED_PRESSURE = 29,
  AUTOQUAD_MESSAGE_ATTITUDE = 30,
  AUTOQUAD_MESSAGE_ATTITUDE_QUATERNION = 31,
  AUTOQUAD_MESSAGE_LOCAL_POSITION_NED = 32,
  AUTOQUAD_MESSAGE_GLOBAL_POSITION_INT = 33,
  AUTOQUAD_MESSAGE_RC_CHANNELS_SCALED = 34,
  AUTOQUAD_MESSAGE_RC_CHANNELS_RAW = 35,
  AUTOQUAD_MESSAGE_SERVO_OUTPUT_RAW = 36,
  AUTOQUAD_MESSAGE_MISSION_REQUEST_PARTIAL_LIST = 37,
  AUTOQUAD_MESSAGE_MISSION_WRITE_PARTIAL_LIST = 38,
  AUTOQUAD_MESSAGE_MISSION_ITEM = 39,
  AUTOQUAD_MESSAGE_MISSION_REQUEST = 40,
  AUTOQUAD_MESSAGE_MISSION_SET_CURRENT = 41,
  AUTOQUAD_MESSAGE_MISSION_CURRENT = 42,
  AUTOQUAD_MESSAGE_MISSION_REQUEST_LIST = 43,
  AUTOQUAD_MESSAGE_MISSION_COUNT = 44,
  AUTOQUAD_MESSAGE_MISSION_CLEAR_ALL = 45,
  AUTOQUAD_MESSAGE_MISSION_ITEM_REACHED = 46,
  AUTOQUAD_MESSAGE_MISSION_ACK = 47,
  AUTOQUAD_MESSAGE_SET_GPS_GLOBAL_ORIGIN = 48,
  AUTOQUAD_MESSAGE_GPS_GLOBAL_ORIGIN = 49,
  AUTOQUAD_MESSAGE_PARAM_MAP_RC = 50,
  AUTOQUAD_MESSAGE_MISSION_REQUEST_INT = 51,
  AUTOQUAD_MESSAGE_MISSION_CHANGED = 52,
  AUTOQUAD_MESSAGE_SAFETY_SET_ALLOWED_AREA = 54,
  AUTOQUAD_MESSAGE_SAFETY_ALLOWED_AREA = 55,
  AUTOQUAD_MESSAGE_ATTITUDE_QUATERNION_COV = 61,
  AUTOQUAD_MESSAGE_NAV_CONTROLLER_OUTPUT = 62,
  AUTOQUAD_MESSAGE_GLOBAL_POSITION_INT_COV = 63,
  AUTOQUAD_MESSAGE_LOCAL_POSITION_NED_COV = 64,
  AUTOQUAD_MESSAGE_RC_CHANNELS = 65,
  AUTOQUAD_MESSAGE_REQUEST_DATA_STREAM = 66,
  AUTOQUAD_MESSAGE_DATA_STREAM = 67,
  AUTOQUAD_MESSAGE_MANUAL_CONTROL = 69,
  AUTOQUAD_MESSAGE_RC_CHANNELS_OVERRIDE = 70,
  AUTOQUAD_MESSAGE_MISSION_ITEM_INT = 73,
  AUTOQUAD_MESSAGE_VFR_HUD = 74,
  AUTOQUAD_MESSAGE_COMMAND_INT = 75,
  AUTOQUAD_MESSAGE_COMMAND_LONG = 76,
  AUTOQUAD_MESSAGE_COMMAND_ACK = 77,
  AUTOQUAD_MESSAGE_MANUAL_SETPOINT = 81,
  AUTOQUAD_MESSAGE_SET_ATTITUDE_TARGET = 82,
  AUTOQUAD_MESSAGE_ATTITUDE_TARGET = 83,
  AUTOQUAD_MESSAGE_SET_POSITION_TARGET_LOCAL_NED = 84,
  AUTOQUAD_MESSAGE_POSITION_TARGET_LOCAL_NED = 85,
  AUTOQUAD_MESSAGE_SET_POSITION_TARGET_GLOBAL_INT = 86,
  AUTOQUAD_MESSAGE_POSITION_TARGET_GLOBAL_INT = 87,
  AUTOQUAD_MESSAGE_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET = 89,
  AUTOQUAD_MESSAGE_HIL_STATE = 90,
  AUTOQUAD_MESSAGE_HIL_CONTROLS = 91,
  AUTOQUAD_MESSAGE_HIL_RC_INPUTS_RAW = 92,
  AUTOQUAD_MESSAGE_HIL_ACTUATOR_CONTROLS = 93,
  AUTOQUAD_MESSAGE_OPTICAL_FLOW = 100,
  AUTOQUAD_MESSAGE_GLOBAL_VISION_POSITION_ESTIMATE = 101,
  AUTOQUAD_MESSAGE_VISION_POSITION_ESTIMATE = 102,
  AUTOQUAD_MESSAGE_VISION_SPEED_ESTIMATE = 103,
  AUTOQUAD_MESSAGE_VICON_POSITION_ESTIMATE = 104,
  AUTOQUAD_MESSAGE_HIGHRES_IMU = 105,
  AUTOQUAD_MESSAGE_OPTICAL_FLOW_RAD = 106,
  AUTOQUAD_MESSAGE_HIL_SENSOR = 107,
  AUTOQUAD_MESSAGE_SIM_STATE = 108,
  AUTOQUAD_MESSAGE_RADIO_STATUS = 109,
  AUTOQUAD_MESSAGE_FILE_TRANSFER_PROTOCOL = 110,
  AUTOQUAD_MESSAGE_TIMESYNC = 111,
  AUTOQUAD_MESSAGE_CAMERA_TRIGGER = 112,
  AUTOQUAD_MESSAGE_HIL_GPS = 113,
  AUTOQUAD_MESSAGE_HIL_OPTICAL_FLOW = 114,
  AUTOQUAD_MESSAGE_HIL_STATE_QUATERNION = 115,
  AUTOQUAD_MESSAGE_SCALED_IMU2 = 116,
  AUTOQUAD_MESSAGE_LOG_REQUEST_LIST = 117,
  AUTOQUAD_MESSAGE_LOG_ENTRY = 118,
  AUTOQUAD_MESSAGE_LOG_REQUEST_DATA = 119,
  AUTOQUAD_MESSAGE_LOG_DATA = 120,
  AUTOQUAD_MESSAGE_LOG_ERASE = 121,
  AUTOQUAD_MESSAGE_LOG_REQUEST_END = 122,
  AUTOQUAD_MESSAGE_GPS_INJECT_DATA = 123,
  AUTOQUAD_MESSAGE_GPS2_RAW = 124,
  AUTOQUAD_MESSAGE_POWER_STATUS = 125,
  AUTOQUAD_MESSAGE_SERIAL_CONTROL = 126,
  AUTOQUAD_MESSAGE_GPS_RTK = 127,
  AUTOQUAD_MESSAGE_GPS2_RTK = 128,
  AUTOQUAD_MESSAGE_SCALED_IMU3 = 129,
  AUTOQUAD_MESSAGE_DATA_TRANSMISSION_HANDSHAKE = 130,
  AUTOQUAD_MESSAGE_ENCAPSULATED_DATA = 131,
  AUTOQUAD_MESSAGE_DISTANCE_SENSOR = 132,
  AUTOQUAD_MESSAGE_TERRAIN_REQUEST = 133,
  AUTOQUAD_MESSAGE_TERRAIN_DATA = 134,
  AUTOQUAD_MESSAGE_TERRAIN_CHECK = 135,
  AUTOQUAD_MESSAGE_TERRAIN_REPORT = 136,
  AUTOQUAD_MESSAGE_SCALED_PRESSURE2 = 137,
  AUTOQUAD_MESSAGE_ATT_POS_MOCAP = 138,
  AUTOQUAD_MESSAGE_SET_ACTUATOR_CONTROL_TARGET = 139,
  AUTOQUAD_MESSAGE_ACTUATOR_CONTROL_TARGET = 140,
  AUTOQUAD_MESSAGE_ALTITUDE = 141,
  AUTOQUAD_MESSAGE_RESOURCE_REQUEST = 142,
  AUTOQUAD_MESSAGE_SCALED_PRESSURE3 = 143,
  AUTOQUAD_MESSAGE_FOLLOW_TARGET = 144,
  AUTOQUAD_MESSAGE_CONTROL_SYSTEM_STATE = 146,
  AUTOQUAD_MESSAGE_BATTERY_STATUS = 147,
  AUTOQUAD_MESSAGE_AUTOPILOT_VERSION = 148,
  AUTOQUAD_MESSAGE_LANDING_TARGET = 149,
  AUTOQUAD_MESSAGE_AQ_TELEMETRY_F = 150,
  AUTOQUAD_MESSAGE_AQ_ESC_TELEMETRY = 152,
  AUTOQUAD_MESSAGE_ESTIMATOR_STATUS = 230,
  AUTOQUAD_MESSAGE_WIND_COV = 231,
  AUTOQUAD_MESSAGE_GPS_INPUT = 232,
  AUTOQUAD_MESSAGE_GPS_RTCM_DATA = 233,
  AUTOQUAD_MESSAGE_HIGH_LATENCY = 234,
  AUTOQUAD_MESSAGE_HIGH_LATENCY2 = 235,
  AUTOQUAD_MESSAGE_VIBRATION = 241,
  AUTOQUAD_MESSAGE_HOME_POSITION = 242,
  AUTOQUAD_MESSAGE_SET_HOME_POSITION = 243,
  AUTOQUAD_MESSAGE_MESSAGE_INTERVAL = 244,
  AUTOQUAD_MESSAGE_EXTENDED_SYS_STATE = 245,
  AUTOQUAD_MESSAGE_ADSB_VEHICLE = 246,
  AUTOQUAD_MESSAGE_COLLISION = 247,
  AUTOQUAD_MESSAGE_V2_EXTENSION = 248,
  AUTOQUAD_MESSAGE_MEMORY_VECT = 249,
  AUTOQUAD_MESSAGE_DEBUG_VECT = 250,
  AUTOQUAD_MESSAGE_NAMED_VALUE_FLOAT = 251,
  AUTOQUAD_MESSAGE_NAMED_VALUE_INT = 252,
  AUTOQUAD_MESSAGE_STATUSTEXT = 253,
  AUTOQUAD_MESSAGE_DEBUG = 254,
  AUTOQUAD_MESSAGE_SETUP_SIGNING = 256,
  AUTOQUAD_MESSAGE_BUTTON_CHANGE = 257,
  AUTOQUAD_MESSAGE_PLAY_TUNE = 258,
  AUTOQUAD_MESSAGE_CAMERA_INFORMATION = 259,
  AUTOQUAD_MESSAGE_CAMERA_SETTINGS = 260,
  AUTOQUAD_MESSAGE_STORAGE_INFORMATION = 261,
  AUTOQUAD_MESSAGE_CAMERA_CAPTURE_STATUS = 262,
  AUTOQUAD_MESSAGE_CAMERA_IMAGE_CAPTURED = 263,
  AUTOQUAD_MESSAGE_FLIGHT_INFORMATION = 264,
  AUTOQUAD_MESSAGE_MOUNT_ORIENTATION = 265,
  AUTOQUAD_MESSAGE_LOGGING_DATA = 266,
  AUTOQUAD_MESSAGE_LOGGING_DATA_ACKED = 267,
  AUTOQUAD_MESSAGE_LOGGING_ACK = 268,
  AUTOQUAD_MESSAGE_VIDEO_STREAM_INFORMATION = 269,
  AUTOQUAD_MESSAGE_VIDEO_STREAM_STATUS = 270,
  AUTOQUAD_MESSAGE_WIFI_CONFIG_AP = 299,
  AUTOQUAD_MESSAGE_PROTOCOL_VERSION = 300,
  AUTOQUAD_MESSAGE_UAVCAN_NODE_STATUS = 310,
  AUTOQUAD_MESSAGE_UAVCAN_NODE_INFO = 311,
  AUTOQUAD_MESSAGE_PARAM_EXT_REQUEST_READ = 320,
  AUTOQUAD_MESSAGE_PARAM_EXT_REQUEST_LIST = 321,
  AUTOQUAD_MESSAGE_PARAM_EXT_VALUE = 322,
  AUTOQUAD_MESSAGE_PARAM_EXT_SET = 323,
  AUTOQUAD_MESSAGE_PARAM_EXT_ACK = 324,
  AUTOQUAD_MESSAGE_OBSTACLE_DISTANCE = 330,
  AUTOQUAD_MESSAGE_ODOMETRY = 331,
  AUTOQUAD_MESSAGE_TRAJECTORY_REPRESENTATION_WAYPOINTS = 332,
  AUTOQUAD_MESSAGE_TRAJECTORY_REPRESENTATION_BEZIER = 333,
  AUTOQUAD_MESSAGE_CELLULAR_STATUS = 334,
  AUTOQUAD_MESSAGE_ISBD_LINK_STATUS = 335,
  AUTOQUAD_MESSAGE_UTM_GLOBAL_POSITION = 340,
  AUTOQUAD_MESSAGE_DEBUG_FLOAT_ARRAY = 350,
  AUTOQUAD_MESSAGE_ORBIT_EXECUTION_STATUS = 360,
  AUTOQUAD_MESSAGE_STATUSTEXT_LONG = 365,
  AUTOQUAD_MESSAGE_SMART_BATTERY_INFO = 370,
  AUTOQUAD_MESSAGE_SMART_BATTERY_STATUS = 371,
  AUTOQUAD_MESSAGE_ACTUATOR_OUTPUT_STATUS = 375,
  AUTOQUAD_MESSAGE_TIME_ESTIMATE_TO_TARGET = 380,
  AUTOQUAD_MESSAGE_WHEEL_DISTANCE = 9000
};
...
struct autoquad_message {
  ...
  union {
    ...
    /* Sends ESC32 telemetry data for up to 4 motors. Multiple messages may be
     * sent in sequence when system has > 4 motors. Data is described as
     * follows:      // unsigned int state :   3;        // unsigned int vin :
     * 12;  // x 100        // unsigned int amps :   14;  // x 100        //
     * unsigned int rpm :   15;        // unsigned int duty :   8;   // x
     * (255/100)        // - Data Version 2 -        //     unsigned int errors
     * :    9;   // Bad detects error count        // - Data Version 3 - //
     * unsigned int temp   :    9;   // (Deg C + 32) * 4        // unsigned int
     * errCode : 3;     */
    struct {
      uint32_t time_boot_ms; /* Timestamp of the component clock since boot time
                                in ms. */
      uint32_t data0[4];     /* Data bits 1-32 for each ESC. */
      uint32_t data1[4];     /* Data bits 33-64 for each ESC. */
      uint16_t status_age[4]; /* Age of each ESC telemetry reading in ms
                                 compared to boot time. A value of 0xFFFF means
                                 timeout/no data. */
      uint8_t seq; /* Sequence number of message (first set of 4 motors is #1,
                      next 4 is #2, etc). */
      uint8_t
          num_motors; /* Total number of active ESCs/motors on the system. */
      uint8_t
          num_in_seq; /* Number of active ESCs in this sequence (1 through this
                         many array members will be populated with data) */
      uint8_t escid[4];        /* ESC/Motor ID */
      uint8_t data_version[4]; /* Version of data structure (determines
                                  contents). */
    } aq_esc_telemetry;
 ...
 *
 * implemented in autoquad_sign.c
 */
void autoquad_message_sign(struct autoquad_message *msg, uint8_t shared[32]);
int autoquad_message_signed(struct autoquad_message *msg, uint8_t shared[32]);
 ...
 *
 * implemented in autoquad_enc.c
 */
size_t autoquad_message_serialize_v1(struct autoquad_message *msg, uint8_t *buf,
                                     size_t size);
size_t autoquad_message_serialize_v2(struct autoquad_message *msg, uint8_t *buf,
                                     size_t size);
 ...
 *
 * implemented in autoquad_dec.c
 */
size_t autoquad_message_seek(const uint8_t *buf, size_t size);
 ...
 * implemented in autoquad_dec.c
 */
size_t autoquad_message_deserialize(const uint8_t *buf, size_t size,
                                    struct autoquad_message *msg);

/* _snprintf appends a debug representation of the message to a buffer
 * implemented in autoquad_fmt.c
 */
size_t autoquad_message_snprintf(char *buf, size_t size,
                                 const struct autoquad_message *msg);
