...
// This enum is used to switch the anonymous union in asluav_message.
enum ASLUAV_MESSAGE {
  ASLUAV_MESSAGE_HEARTBEAT = 0,
  ASLUAV_MESSAGE_SYS_STATUS = 1,
  ASLUAV_MESSAGE_SYSTEM_TIME = 2,
  ASLUAV_MESSAGE_PING = 4,
  ASLUAV_MESSAGE_CHANGE_OPERATOR_CONTROL = 5,
  ASLUAV_MESSAGE_CHANGE_OPERATOR_CONTROL_ACK = 6,
  ASLUAV_MESSAGE_AUTH_KEY = 7,
  ASLUAV_MESSAGE_LINK_NODE_STATUS = 8,
  ASLUAV_MESSAGE_SET_MODE = 11,
  ASLUAV_MESSAGE_PARAM_REQUEST_READ = 20,
  ASLUAV_MESSAGE_PARAM_REQUEST_LIST = 21,
  ASLUAV_MESSAGE_PARAM_VALUE = 22,
  ASLUAV_MESSAGE_PARAM_SET = 23,
  ASLUAV_MESSAGE_GPS_RAW_INT = 24,
  ASLUAV_MESSAGE_GPS_STATUS = 25,
  ASLUAV_MESSAGE_SCALED_IMU = 26,
  ASLUAV_MESSAGE_RAW_IMU = 27,
  ASLUAV_MESSAGE_RAW_PRESSURE = 28,
  ASLUAV_MESSAGE_SCALED_PRESSURE = 29,
  ASLUAV_MESSAGE_ATTITUDE = 30,
  ASLUAV_MESSAGE_ATTITUDE_QUATERNION = 31,
  ASLUAV_MESSAGE_LOCAL_POSITION_NED = 32,
  ASLUAV_MESSAGE_GLOBAL_POSITION_INT = 33,
  ASLUAV_MESSAGE_RC_CHANNELS_SCALED = 34,
  ASLUAV_MESSAGE_RC_CHANNELS_RAW = 35,
  ASLUAV_MESSAGE_SERVO_OUTPUT_RAW = 36,
  ASLUAV_MESSAGE_MISSION_REQUEST_PARTIAL_LIST = 37,
  ASLUAV_MESSAGE_MISSION_WRITE_PARTIAL_LIST = 38,
  ASLUAV_MESSAGE_MISSION_ITEM = 39,
  ASLUAV_MESSAGE_MISSION_REQUEST = 40,
  ASLUAV_MESSAGE_MISSION_SET_CURRENT = 41,
  ASLUAV_MESSAGE_MISSION_CURRENT = 42,
  ASLUAV_MESSAGE_MISSION_REQUEST_LIST = 43,
  ASLUAV_MESSAGE_MISSION_COUNT = 44,
  ASLUAV_MESSAGE_MISSION_CLEAR_ALL = 45,
  ASLUAV_MESSAGE_MISSION_ITEM_REACHED = 46,
  ASLUAV_MESSAGE_MISSION_ACK = 47,
  ASLUAV_MESSAGE_SET_GPS_GLOBAL_ORIGIN = 48,
  ASLUAV_MESSAGE_GPS_GLOBAL_ORIGIN = 49,
  ASLUAV_MESSAGE_PARAM_MAP_RC = 50,
  ASLUAV_MESSAGE_MISSION_REQUEST_INT = 51,
  ASLUAV_MESSAGE_MISSION_CHANGED = 52,
  ASLUAV_MESSAGE_SAFETY_SET_ALLOWED_AREA = 54,
  ASLUAV_MESSAGE_SAFETY_ALLOWED_AREA = 55,
  ASLUAV_MESSAGE_ATTITUDE_QUATERNION_COV = 61,
  ASLUAV_MESSAGE_NAV_CONTROLLER_OUTPUT = 62,
  ASLUAV_MESSAGE_GLOBAL_POSITION_INT_COV = 63,
  ASLUAV_MESSAGE_LOCAL_POSITION_NED_COV = 64,
  ASLUAV_MESSAGE_RC_CHANNELS = 65,
  ASLUAV_MESSAGE_REQUEST_DATA_STREAM = 66,
  ASLUAV_MESSAGE_DATA_STREAM = 67,
  ASLUAV_MESSAGE_MANUAL_CONTROL = 69,
  ASLUAV_MESSAGE_RC_CHANNELS_OVERRIDE = 70,
  ASLUAV_MESSAGE_MISSION_ITEM_INT = 73,
  ASLUAV_MESSAGE_VFR_HUD = 74,
  ASLUAV_MESSAGE_COMMAND_INT = 75,
  ASLUAV_MESSAGE_COMMAND_LONG = 76,
  ASLUAV_MESSAGE_COMMAND_ACK = 77,
  ASLUAV_MESSAGE_COMMAND_INT_STAMPED = 78,
  ASLUAV_MESSAGE_COMMAND_LONG_STAMPED = 79,
  ASLUAV_MESSAGE_MANUAL_SETPOINT = 81,
  ASLUAV_MESSAGE_SET_ATTITUDE_TARGET = 82,
  ASLUAV_MESSAGE_ATTITUDE_TARGET = 83,
  ASLUAV_MESSAGE_SET_POSITION_TARGET_LOCAL_NED = 84,
  ASLUAV_MESSAGE_POSITION_TARGET_LOCAL_NED = 85,
  ASLUAV_MESSAGE_SET_POSITION_TARGET_GLOBAL_INT = 86,
  ASLUAV_MESSAGE_POSITION_TARGET_GLOBAL_INT = 87,
  ASLUAV_MESSAGE_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET = 89,
  ASLUAV_MESSAGE_HIL_STATE = 90,
  ASLUAV_MESSAGE_HIL_CONTROLS = 91,
  ASLUAV_MESSAGE_HIL_RC_INPUTS_RAW = 92,
  ASLUAV_MESSAGE_HIL_ACTUATOR_CONTROLS = 93,
  ASLUAV_MESSAGE_OPTICAL_FLOW = 100,
  ASLUAV_MESSAGE_GLOBAL_VISION_POSITION_ESTIMATE = 101,
  ASLUAV_MESSAGE_VISION_POSITION_ESTIMATE = 102,
  ASLUAV_MESSAGE_VISION_SPEED_ESTIMATE = 103,
  ASLUAV_MESSAGE_VICON_POSITION_ESTIMATE = 104,
  ASLUAV_MESSAGE_HIGHRES_IMU = 105,
  ASLUAV_MESSAGE_OPTICAL_FLOW_RAD = 106,
  ASLUAV_MESSAGE_HIL_SENSOR = 107,
  ASLUAV_MESSAGE_SIM_STATE = 108,
  ASLUAV_MESSAGE_RADIO_STATUS = 109,
  ASLUAV_MESSAGE_FILE_TRANSFER_PROTOCOL = 110,
  ASLUAV_MESSAGE_TIMESYNC = 111,
  ASLUAV_MESSAGE_CAMERA_TRIGGER = 112,
  ASLUAV_MESSAGE_HIL_GPS = 113,
  ASLUAV_MESSAGE_HIL_OPTICAL_FLOW = 114,
  ASLUAV_MESSAGE_HIL_STATE_QUATERNION = 115,
  ASLUAV_MESSAGE_SCALED_IMU2 = 116,
  ASLUAV_MESSAGE_LOG_REQUEST_LIST = 117,
  ASLUAV_MESSAGE_LOG_ENTRY = 118,
  ASLUAV_MESSAGE_LOG_REQUEST_DATA = 119,
  ASLUAV_MESSAGE_LOG_DATA = 120,
  ASLUAV_MESSAGE_LOG_ERASE = 121,
  ASLUAV_MESSAGE_LOG_REQUEST_END = 122,
  ASLUAV_MESSAGE_GPS_INJECT_DATA = 123,
  ASLUAV_MESSAGE_GPS2_RAW = 124,
  ASLUAV_MESSAGE_POWER_STATUS = 125,
  ASLUAV_MESSAGE_SERIAL_CONTROL = 126,
  ASLUAV_MESSAGE_GPS_RTK = 127,
  ASLUAV_MESSAGE_GPS2_RTK = 128,
  ASLUAV_MESSAGE_SCALED_IMU3 = 129,
  ASLUAV_MESSAGE_DATA_TRANSMISSION_HANDSHAKE = 130,
  ASLUAV_MESSAGE_ENCAPSULATED_DATA = 131,
  ASLUAV_MESSAGE_DISTANCE_SENSOR = 132,
  ASLUAV_MESSAGE_TERRAIN_REQUEST = 133,
  ASLUAV_MESSAGE_TERRAIN_DATA = 134,
  ASLUAV_MESSAGE_TERRAIN_CHECK = 135,
  ASLUAV_MESSAGE_TERRAIN_REPORT = 136,
  ASLUAV_MESSAGE_SCALED_PRESSURE2 = 137,
  ASLUAV_MESSAGE_ATT_POS_MOCAP = 138,
  ASLUAV_MESSAGE_SET_ACTUATOR_CONTROL_TARGET = 139,
  ASLUAV_MESSAGE_ACTUATOR_CONTROL_TARGET = 140,
  ASLUAV_MESSAGE_ALTITUDE = 141,
  ASLUAV_MESSAGE_RESOURCE_REQUEST = 142,
  ASLUAV_MESSAGE_SCALED_PRESSURE3 = 143,
  ASLUAV_MESSAGE_FOLLOW_TARGET = 144,
  ASLUAV_MESSAGE_CONTROL_SYSTEM_STATE = 146,
  ASLUAV_MESSAGE_BATTERY_STATUS = 147,
  ASLUAV_MESSAGE_AUTOPILOT_VERSION = 148,
  ASLUAV_MESSAGE_LANDING_TARGET = 149,
  ASLUAV_MESSAGE_SENS_POWER = 201,
  ASLUAV_MESSAGE_SENS_MPPT = 202,
  ASLUAV_MESSAGE_ASLCTRL_DATA = 203,
  ASLUAV_MESSAGE_ASLCTRL_DEBUG = 204,
  ASLUAV_MESSAGE_ASLUAV_STATUS = 205,
  ASLUAV_MESSAGE_EKF_EXT = 206,
  ASLUAV_MESSAGE_ASL_OBCTRL = 207,
  ASLUAV_MESSAGE_SENS_ATMOS = 208,
  ASLUAV_MESSAGE_SENS_BATMON = 209,
  ASLUAV_MESSAGE_FW_SOARING_DATA = 210,
  ASLUAV_MESSAGE_SENSORPOD_STATUS = 211,
  ASLUAV_MESSAGE_SENS_POWER_BOARD = 212,
  ASLUAV_MESSAGE_GSM_LINK_STATUS = 213,
  ASLUAV_MESSAGE_ESTIMATOR_STATUS = 230,
  ASLUAV_MESSAGE_WIND_COV = 231,
  ASLUAV_MESSAGE_GPS_INPUT = 232,
  ASLUAV_MESSAGE_GPS_RTCM_DATA = 233,
  ASLUAV_MESSAGE_HIGH_LATENCY = 234,
  ASLUAV_MESSAGE_HIGH_LATENCY2 = 235,
  ASLUAV_MESSAGE_VIBRATION = 241,
  ASLUAV_MESSAGE_HOME_POSITION = 242,
  ASLUAV_MESSAGE_SET_HOME_POSITION = 243,
  ASLUAV_MESSAGE_MESSAGE_INTERVAL = 244,
  ASLUAV_MESSAGE_EXTENDED_SYS_STATE = 245,
  ASLUAV_MESSAGE_ADSB_VEHICLE = 246,
  ASLUAV_MESSAGE_COLLISION = 247,
  ASLUAV_MESSAGE_V2_EXTENSION = 248,
  ASLUAV_MESSAGE_MEMORY_VECT = 249,
  ASLUAV_MESSAGE_DEBUG_VECT = 250,
  ASLUAV_MESSAGE_NAMED_VALUE_FLOAT = 251,
  ASLUAV_MESSAGE_NAMED_VALUE_INT = 252,
  ASLUAV_MESSAGE_STATUSTEXT = 253,
  ASLUAV_MESSAGE_DEBUG = 254,
  ASLUAV_MESSAGE_SETUP_SIGNING = 256,
  ASLUAV_MESSAGE_BUTTON_CHANGE = 257,
  ASLUAV_MESSAGE_PLAY_TUNE = 258,
  ASLUAV_MESSAGE_CAMERA_INFORMATION = 259,
  ASLUAV_MESSAGE_CAMERA_SETTINGS = 260,
  ASLUAV_MESSAGE_STORAGE_INFORMATION = 261,
  ASLUAV_MESSAGE_CAMERA_CAPTURE_STATUS = 262,
  ASLUAV_MESSAGE_CAMERA_IMAGE_CAPTURED = 263,
  ASLUAV_MESSAGE_FLIGHT_INFORMATION = 264,
  ASLUAV_MESSAGE_MOUNT_ORIENTATION = 265,
  ASLUAV_MESSAGE_LOGGING_DATA = 266,
  ASLUAV_MESSAGE_LOGGING_DATA_ACKED = 267,
  ASLUAV_MESSAGE_LOGGING_ACK = 268,
  ASLUAV_MESSAGE_VIDEO_STREAM_INFORMATION = 269,
  ASLUAV_MESSAGE_VIDEO_STREAM_STATUS = 270,
  ASLUAV_MESSAGE_WIFI_CONFIG_AP = 299,
  ASLUAV_MESSAGE_PROTOCOL_VERSION = 300,
  ASLUAV_MESSAGE_UAVCAN_NODE_STATUS = 310,
  ASLUAV_MESSAGE_UAVCAN_NODE_INFO = 311,
  ASLUAV_MESSAGE_PARAM_EXT_REQUEST_READ = 320,
  ASLUAV_MESSAGE_PARAM_EXT_REQUEST_LIST = 321,
  ASLUAV_MESSAGE_PARAM_EXT_VALUE = 322,
  ASLUAV_MESSAGE_PARAM_EXT_SET = 323,
  ASLUAV_MESSAGE_PARAM_EXT_ACK = 324,
  ASLUAV_MESSAGE_OBSTACLE_DISTANCE = 330,
  ASLUAV_MESSAGE_ODOMETRY = 331,
  ASLUAV_MESSAGE_TRAJECTORY_REPRESENTATION_WAYPOINTS = 332,
  ASLUAV_MESSAGE_TRAJECTORY_REPRESENTATION_BEZIER = 333,
  ASLUAV_MESSAGE_CELLULAR_STATUS = 334,
  ASLUAV_MESSAGE_ISBD_LINK_STATUS = 335,
  ASLUAV_MESSAGE_UTM_GLOBAL_POSITION = 340,
  ASLUAV_MESSAGE_DEBUG_FLOAT_ARRAY = 350,
  ASLUAV_MESSAGE_ORBIT_EXECUTION_STATUS = 360,
  ASLUAV_MESSAGE_STATUSTEXT_LONG = 365,
  ASLUAV_MESSAGE_SMART_BATTERY_INFO = 370,
  ASLUAV_MESSAGE_SMART_BATTERY_STATUS = 371,
  ASLUAV_MESSAGE_ACTUATOR_OUTPUT_STATUS = 375,
  ASLUAV_MESSAGE_TIME_ESTIMATE_TO_TARGET = 380,
  ASLUAV_MESSAGE_WHEEL_DISTANCE = 9000
};
...
struct asluav_message {
  ...
  union {
    ...
    struct {
      ...
      int32_t y; /* PARAM6 / local: y position in meters * 1e4, global:
                    longitude in degrees * 10^7 */
      float z;   /* PARAM7 / z position: global: altitude in meters (MSL, WGS84,
                    AGL or relative to home - depending on frame). */
      enum MAV_CMD command;  /* (uint16_t) The scheduled action for the mission
                                item, as defined by MAV_CMD enum */
      uint8_t target_system; /* System ID */
      uint8_t target_component; /* Component ID */
      enum MAV_FRAME frame; /* (uint8_t) The coordinate system of the COMMAND,
                               as defined by MAV_FRAME enum */
      uint8_t current;      /* false:0, true:1 */
      uint8_t autocontinue; /* autocontinue to next wp */
    } command_int_stamped;
    ...
    struct {
      ...
      float uAil;           /*   */
      float uRud;           /*   */
      uint8_t aslctrl_mode; /*  ASLCTRL control-mode (manual, stabilized, auto,
                               etc...) */
    ...
    struct {
      ...
      uint8_t SATCOM_status;   /*  Status of the IRIDIUM satellite communication
                                  system */
    ...
    struct {
      ...
      float Windspeed;    /*  Magnitude of wind velocity (in lateral inertial
                             plane) */
    ...
    struct {
      ...
      uint32_t operationstatus; /* Battery monitor operation status report bits
                                   in Hex */
    ...
    struct {
      uint64_t timestamp;            /* Timestamp */
      uint64_t timestampModeChanged; /* Timestamp since last mode change */
      ...
      float vSinkExp; /* Expected sink rate at current airspeed, roll and
                         throttle */
      float z1_LocalUpdraftSpeed; /* Measurement / updraft speed at
                                     current/local airplane position */
      ...
      float ThermalGSNorth; /* Thermal drift (from estimator prediction step
                               only) */
      float ThermalGSEast;  /* Thermal drift (from estimator prediction step
                               only) */
    ...
    struct {
      ...
      uint16_t free_space; /* Free space available in recordings directory in
                              [Gb] * 1e2 */
    ...
    struct {
      uint64_t timestamp;                 /* Timestamp (of OBC) */
      enum GSM_MODEM_TYPE gsm_modem_type; /* (uint8_t) GSM modem used */
      enum GSM_LINK_TYPE gsm_link_type;   /* (uint8_t) GSM link type */
      uint8_t rssi;      /* RSSI as reported by modem (unconverted) */
      uint8_t rsrp_rscp; /* RSRP (LTE) or RSCP (WCDMA) as reported by modem
                            (unconverted) */
      uint8_t sinr_ecio; /* SINR (LTE) or ECIO (WCDMA) as reported by modem
                            (unconverted) */
 ...
 *
 * implemented in asluav_sign.c
 */
void asluav_message_sign(struct asluav_message *msg, uint8_t shared[32]);
int asluav_message_signed(struct asluav_message *msg, uint8_t shared[32]);
 ...
 *
 * implemented in asluav_enc.c
 */
size_t asluav_message_serialize_v1(struct asluav_message *msg, uint8_t *buf,
                                   size_t size);
size_t asluav_message_serialize_v2(struct asluav_message *msg, uint8_t *buf,
                                   size_t size);
 ...
 *
 * implemented in asluav_dec.c
 */
size_t asluav_message_seek(const uint8_t *buf, size_t size);
 ...
 * implemented in asluav_dec.c
 */
size_t asluav_message_deserialize(const uint8_t *buf, size_t size,
                                  struct asluav_message *msg);

/* _snprintf appends a debug representation of the message to a buffer
 * implemented in asluav_fmt.c
 */
size_t asluav_message_snprintf(char *buf, size_t size,
                               const struct asluav_message *msg);
