...
enum SLUGS_MODE {
  ...
  SLUGS_MODE_LOST = 7,
  /* Vehicle is in selective passthrough mode, where selected surfaces are being
     manually controlled. */
  SLUGS_MODE_SELECTIVE_PASSTHROUGH = 8,
  /* Vehicle is in ISR mode, performing reconaissance at a point specified by
     ISR_LOCATION message. */
  SLUGS_MODE_ISR = 9,
...
// This enum is used to switch the anonymous union in slugs_message.
enum SLUGS_MESSAGE {
  SLUGS_MESSAGE_HEARTBEAT = 0,
  SLUGS_MESSAGE_SYS_STATUS = 1,
  SLUGS_MESSAGE_SYSTEM_TIME = 2,
  SLUGS_MESSAGE_PING = 4,
  SLUGS_MESSAGE_CHANGE_OPERATOR_CONTROL = 5,
  SLUGS_MESSAGE_CHANGE_OPERATOR_CONTROL_ACK = 6,
  SLUGS_MESSAGE_AUTH_KEY = 7,
  SLUGS_MESSAGE_LINK_NODE_STATUS = 8,
  SLUGS_MESSAGE_SET_MODE = 11,
  SLUGS_MESSAGE_PARAM_REQUEST_READ = 20,
  SLUGS_MESSAGE_PARAM_REQUEST_LIST = 21,
  SLUGS_MESSAGE_PARAM_VALUE = 22,
  SLUGS_MESSAGE_PARAM_SET = 23,
  SLUGS_MESSAGE_GPS_RAW_INT = 24,
  SLUGS_MESSAGE_GPS_STATUS = 25,
  SLUGS_MESSAGE_SCALED_IMU = 26,
  SLUGS_MESSAGE_RAW_IMU = 27,
  SLUGS_MESSAGE_RAW_PRESSURE = 28,
  SLUGS_MESSAGE_SCALED_PRESSURE = 29,
  SLUGS_MESSAGE_ATTITUDE = 30,
  SLUGS_MESSAGE_ATTITUDE_QUATERNION = 31,
  SLUGS_MESSAGE_LOCAL_POSITION_NED = 32,
  SLUGS_MESSAGE_GLOBAL_POSITION_INT = 33,
  SLUGS_MESSAGE_RC_CHANNELS_SCALED = 34,
  SLUGS_MESSAGE_RC_CHANNELS_RAW = 35,
  SLUGS_MESSAGE_SERVO_OUTPUT_RAW = 36,
  SLUGS_MESSAGE_MISSION_REQUEST_PARTIAL_LIST = 37,
  SLUGS_MESSAGE_MISSION_WRITE_PARTIAL_LIST = 38,
  SLUGS_MESSAGE_MISSION_ITEM = 39,
  SLUGS_MESSAGE_MISSION_REQUEST = 40,
  SLUGS_MESSAGE_MISSION_SET_CURRENT = 41,
  SLUGS_MESSAGE_MISSION_CURRENT = 42,
  SLUGS_MESSAGE_MISSION_REQUEST_LIST = 43,
  SLUGS_MESSAGE_MISSION_COUNT = 44,
  SLUGS_MESSAGE_MISSION_CLEAR_ALL = 45,
  SLUGS_MESSAGE_MISSION_ITEM_REACHED = 46,
  SLUGS_MESSAGE_MISSION_ACK = 47,
  SLUGS_MESSAGE_SET_GPS_GLOBAL_ORIGIN = 48,
  SLUGS_MESSAGE_GPS_GLOBAL_ORIGIN = 49,
  SLUGS_MESSAGE_PARAM_MAP_RC = 50,
  SLUGS_MESSAGE_MISSION_REQUEST_INT = 51,
  SLUGS_MESSAGE_MISSION_CHANGED = 52,
  SLUGS_MESSAGE_SAFETY_SET_ALLOWED_AREA = 54,
  SLUGS_MESSAGE_SAFETY_ALLOWED_AREA = 55,
  SLUGS_MESSAGE_ATTITUDE_QUATERNION_COV = 61,
  SLUGS_MESSAGE_NAV_CONTROLLER_OUTPUT = 62,
  SLUGS_MESSAGE_GLOBAL_POSITION_INT_COV = 63,
  SLUGS_MESSAGE_LOCAL_POSITION_NED_COV = 64,
  SLUGS_MESSAGE_RC_CHANNELS = 65,
  SLUGS_MESSAGE_REQUEST_DATA_STREAM = 66,
  SLUGS_MESSAGE_DATA_STREAM = 67,
  SLUGS_MESSAGE_MANUAL_CONTROL = 69,
  SLUGS_MESSAGE_RC_CHANNELS_OVERRIDE = 70,
  SLUGS_MESSAGE_MISSION_ITEM_INT = 73,
  SLUGS_MESSAGE_VFR_HUD = 74,
  SLUGS_MESSAGE_COMMAND_INT = 75,
  SLUGS_MESSAGE_COMMAND_LONG = 76,
  SLUGS_MESSAGE_COMMAND_ACK = 77,
  SLUGS_MESSAGE_MANUAL_SETPOINT = 81,
  SLUGS_MESSAGE_SET_ATTITUDE_TARGET = 82,
  SLUGS_MESSAGE_ATTITUDE_TARGET = 83,
  SLUGS_MESSAGE_SET_POSITION_TARGET_LOCAL_NED = 84,
  SLUGS_MESSAGE_POSITION_TARGET_LOCAL_NED = 85,
  SLUGS_MESSAGE_SET_POSITION_TARGET_GLOBAL_INT = 86,
  SLUGS_MESSAGE_POSITION_TARGET_GLOBAL_INT = 87,
  SLUGS_MESSAGE_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET = 89,
  SLUGS_MESSAGE_HIL_STATE = 90,
  SLUGS_MESSAGE_HIL_CONTROLS = 91,
  SLUGS_MESSAGE_HIL_RC_INPUTS_RAW = 92,
  SLUGS_MESSAGE_HIL_ACTUATOR_CONTROLS = 93,
  SLUGS_MESSAGE_OPTICAL_FLOW = 100,
  SLUGS_MESSAGE_GLOBAL_VISION_POSITION_ESTIMATE = 101,
  SLUGS_MESSAGE_VISION_POSITION_ESTIMATE = 102,
  SLUGS_MESSAGE_VISION_SPEED_ESTIMATE = 103,
  SLUGS_MESSAGE_VICON_POSITION_ESTIMATE = 104,
  SLUGS_MESSAGE_HIGHRES_IMU = 105,
  SLUGS_MESSAGE_OPTICAL_FLOW_RAD = 106,
  SLUGS_MESSAGE_HIL_SENSOR = 107,
  SLUGS_MESSAGE_SIM_STATE = 108,
  SLUGS_MESSAGE_RADIO_STATUS = 109,
  SLUGS_MESSAGE_FILE_TRANSFER_PROTOCOL = 110,
  SLUGS_MESSAGE_TIMESYNC = 111,
  SLUGS_MESSAGE_CAMERA_TRIGGER = 112,
  SLUGS_MESSAGE_HIL_GPS = 113,
  SLUGS_MESSAGE_HIL_OPTICAL_FLOW = 114,
  SLUGS_MESSAGE_HIL_STATE_QUATERNION = 115,
  SLUGS_MESSAGE_SCALED_IMU2 = 116,
  SLUGS_MESSAGE_LOG_REQUEST_LIST = 117,
  SLUGS_MESSAGE_LOG_ENTRY = 118,
  SLUGS_MESSAGE_LOG_REQUEST_DATA = 119,
  SLUGS_MESSAGE_LOG_DATA = 120,
  SLUGS_MESSAGE_LOG_ERASE = 121,
  SLUGS_MESSAGE_LOG_REQUEST_END = 122,
  SLUGS_MESSAGE_GPS_INJECT_DATA = 123,
  SLUGS_MESSAGE_GPS2_RAW = 124,
  SLUGS_MESSAGE_POWER_STATUS = 125,
  SLUGS_MESSAGE_SERIAL_CONTROL = 126,
  SLUGS_MESSAGE_GPS_RTK = 127,
  SLUGS_MESSAGE_GPS2_RTK = 128,
  SLUGS_MESSAGE_SCALED_IMU3 = 129,
  SLUGS_MESSAGE_DATA_TRANSMISSION_HANDSHAKE = 130,
  SLUGS_MESSAGE_ENCAPSULATED_DATA = 131,
  SLUGS_MESSAGE_DISTANCE_SENSOR = 132,
  SLUGS_MESSAGE_TERRAIN_REQUEST = 133,
  SLUGS_MESSAGE_TERRAIN_DATA = 134,
  SLUGS_MESSAGE_TERRAIN_CHECK = 135,
  SLUGS_MESSAGE_TERRAIN_REPORT = 136,
  SLUGS_MESSAGE_SCALED_PRESSURE2 = 137,
  SLUGS_MESSAGE_ATT_POS_MOCAP = 138,
  SLUGS_MESSAGE_SET_ACTUATOR_CONTROL_TARGET = 139,
  SLUGS_MESSAGE_ACTUATOR_CONTROL_TARGET = 140,
  SLUGS_MESSAGE_ALTITUDE = 141,
  SLUGS_MESSAGE_RESOURCE_REQUEST = 142,
  SLUGS_MESSAGE_SCALED_PRESSURE3 = 143,
  SLUGS_MESSAGE_FOLLOW_TARGET = 144,
  SLUGS_MESSAGE_CONTROL_SYSTEM_STATE = 146,
  SLUGS_MESSAGE_BATTERY_STATUS = 147,
  SLUGS_MESSAGE_AUTOPILOT_VERSION = 148,
  SLUGS_MESSAGE_LANDING_TARGET = 149,
  SLUGS_MESSAGE_CPU_LOAD = 170,
  SLUGS_MESSAGE_SENSOR_BIAS = 172,
  SLUGS_MESSAGE_DIAGNOSTIC = 173,
  SLUGS_MESSAGE_SLUGS_NAVIGATION = 176,
  SLUGS_MESSAGE_DATA_LOG = 177,
  SLUGS_MESSAGE_GPS_DATE_TIME = 179,
  SLUGS_MESSAGE_MID_LVL_CMDS = 180,
  SLUGS_MESSAGE_CTRL_SRFC_PT = 181,
  SLUGS_MESSAGE_SLUGS_CAMERA_ORDER = 184,
  SLUGS_MESSAGE_CONTROL_SURFACE = 185,
  SLUGS_MESSAGE_SLUGS_MOBILE_LOCATION = 186,
  SLUGS_MESSAGE_SLUGS_CONFIGURATION_CAMERA = 188,
  SLUGS_MESSAGE_ISR_LOCATION = 189,
  SLUGS_MESSAGE_VOLT_SENSOR = 191,
  SLUGS_MESSAGE_PTZ_STATUS = 192,
  SLUGS_MESSAGE_UAV_STATUS = 193,
  SLUGS_MESSAGE_STATUS_GPS = 194,
  SLUGS_MESSAGE_NOVATEL_DIAG = 195,
  SLUGS_MESSAGE_SENSOR_DIAG = 196,
  SLUGS_MESSAGE_BOOT = 197,
  SLUGS_MESSAGE_ESTIMATOR_STATUS = 230,
  SLUGS_MESSAGE_WIND_COV = 231,
  SLUGS_MESSAGE_GPS_INPUT = 232,
  SLUGS_MESSAGE_GPS_RTCM_DATA = 233,
  SLUGS_MESSAGE_HIGH_LATENCY = 234,
  SLUGS_MESSAGE_HIGH_LATENCY2 = 235,
  SLUGS_MESSAGE_VIBRATION = 241,
  SLUGS_MESSAGE_HOME_POSITION = 242,
  SLUGS_MESSAGE_SET_HOME_POSITION = 243,
  SLUGS_MESSAGE_MESSAGE_INTERVAL = 244,
  SLUGS_MESSAGE_EXTENDED_SYS_STATE = 245,
  SLUGS_MESSAGE_ADSB_VEHICLE = 246,
  SLUGS_MESSAGE_COLLISION = 247,
  SLUGS_MESSAGE_V2_EXTENSION = 248,
  SLUGS_MESSAGE_MEMORY_VECT = 249,
  SLUGS_MESSAGE_DEBUG_VECT = 250,
  SLUGS_MESSAGE_NAMED_VALUE_FLOAT = 251,
  SLUGS_MESSAGE_NAMED_VALUE_INT = 252,
  SLUGS_MESSAGE_STATUSTEXT = 253,
  SLUGS_MESSAGE_DEBUG = 254,
  SLUGS_MESSAGE_SETUP_SIGNING = 256,
  SLUGS_MESSAGE_BUTTON_CHANGE = 257,
  SLUGS_MESSAGE_PLAY_TUNE = 258,
  SLUGS_MESSAGE_CAMERA_INFORMATION = 259,
  SLUGS_MESSAGE_CAMERA_SETTINGS = 260,
  SLUGS_MESSAGE_STORAGE_INFORMATION = 261,
  SLUGS_MESSAGE_CAMERA_CAPTURE_STATUS = 262,
  SLUGS_MESSAGE_CAMERA_IMAGE_CAPTURED = 263,
  SLUGS_MESSAGE_FLIGHT_INFORMATION = 264,
  SLUGS_MESSAGE_MOUNT_ORIENTATION = 265,
  SLUGS_MESSAGE_LOGGING_DATA = 266,
  SLUGS_MESSAGE_LOGGING_DATA_ACKED = 267,
  SLUGS_MESSAGE_LOGGING_ACK = 268,
  SLUGS_MESSAGE_VIDEO_STREAM_INFORMATION = 269,
  SLUGS_MESSAGE_VIDEO_STREAM_STATUS = 270,
  SLUGS_MESSAGE_WIFI_CONFIG_AP = 299,
  SLUGS_MESSAGE_PROTOCOL_VERSION = 300,
  SLUGS_MESSAGE_UAVCAN_NODE_STATUS = 310,
  SLUGS_MESSAGE_UAVCAN_NODE_INFO = 311,
  SLUGS_MESSAGE_PARAM_EXT_REQUEST_READ = 320,
  SLUGS_MESSAGE_PARAM_EXT_REQUEST_LIST = 321,
  SLUGS_MESSAGE_PARAM_EXT_VALUE = 322,
  SLUGS_MESSAGE_PARAM_EXT_SET = 323,
  SLUGS_MESSAGE_PARAM_EXT_ACK = 324,
  SLUGS_MESSAGE_OBSTACLE_DISTANCE = 330,
  SLUGS_MESSAGE_ODOMETRY = 331,
  SLUGS_MESSAGE_TRAJECTORY_REPRESENTATION_WAYPOINTS = 332,
  SLUGS_MESSAGE_TRAJECTORY_REPRESENTATION_BEZIER = 333,
  SLUGS_MESSAGE_CELLULAR_STATUS = 334,
  SLUGS_MESSAGE_ISBD_LINK_STATUS = 335,
  SLUGS_MESSAGE_UTM_GLOBAL_POSITION = 340,
  SLUGS_MESSAGE_DEBUG_FLOAT_ARRAY = 350,
  SLUGS_MESSAGE_ORBIT_EXECUTION_STATUS = 360,
  SLUGS_MESSAGE_STATUSTEXT_LONG = 365,
  SLUGS_MESSAGE_SMART_BATTERY_INFO = 370,
  SLUGS_MESSAGE_SMART_BATTERY_STATUS = 371,
  SLUGS_MESSAGE_ACTUATOR_OUTPUT_STATUS = 375,
  SLUGS_MESSAGE_TIME_ESTIMATE_TO_TARGET = 380,
  SLUGS_MESSAGE_WHEEL_DISTANCE = 9000
};
...
struct slugs_message {
  ...
  union {
    ...
    struct {
      ...
      uint16_t h_c;    /* Commanded altitude (MSL) */
    ...
    struct {
      ...
      uint8_t sigUsedMask; /* GPS and GLONASS usage mask (bit 0 GPS_used? bit_4
                              GLONASS_used?) */
    ...
    struct {
      enum CONTROL_SURFACE_FLAG
          bitfieldPt; /* (uint16_t) Bitfield containing the passthrough
                         configuration, see CONTROL_SURFACE_FLAG ENUM. */
      uint8_t target; /* The system setting the commands */
    } ctrl_srfc_pt;
    ...
    struct {
      ...
      int8_t moveHome; /* Orders the camera mount to move home. The other fields
                          are ignored when this field is set. 1: move home, 0
                          ignored */
    } slugs_camera_order;
    ...
    struct {
      ...
      uint8_t target;    /* The system setting the commands */
      uint8_t idSurface; /* ID control surface send 0: throttle 1: aileron 2:
                            elevator 3: rudder */
    } control_surface;
    ...
    struct {
      uint8_t target;  /* The system setting the commands */
      uint8_t idOrder; /* ID 0: brightness 1: aperture 2: iris 3: ICR 4:
                          backlight */
    ...
    struct {
      ...
      uint16_t reading2; /* Depends on the value of r2Type (0) Current
                            consumption in uS of PWM, 20 uS = 90Amp (1) Distance
                            in cm (2) Distance in cm (3) Absolute value */
      uint8_t r2Type; /* It is the value of reading 2: 0 - Current, 1 - Foreward
                         Sonar, 2 - Back Sonar, 3 - RPM */
    } volt_sensor;
    ...
    struct {
      ...
      uint8_t gpsQuality; /* The quality indicator, 0=fix not available or
                             invalid, 1=GPS fix, 2=C/A differential GPS, 6=Dead
                             reckoning mode, 7=Manual input mode (fixed
                             position), 8=Simulator mode, 9= WAAS a */
      uint8_t
          msgsType; /*  Indicates if GN, GL or GP messages are being received */
      uint8_t posStatus; /*  A = data valid, V = data invalid */
      int8_t magDir;   /*  Magnetic variation direction E/W. Easterly variation
                          (E) subtracts from True course and Westerly variation
                          (W) adds to True course */
      uint8_t modeInd; /*  Positioning system mode indicator. A -
                          Autonomous;D-Differential; E-Estimated (dead
                          reckoning) mode;M-Manual input; N-Data not valid */
    } status_gps;

    /* Transmits the diagnostics data from the Novatel OEMStar GPS */
    struct {
      uint32_t receiverStatus; /* Status Bitfield. See table 69 page 350 Novatel
                                  OEMstar Manual */
      float posSolAge;         /* Age of the position solution */
      uint16_t csFails;        /* Times the CRC has failed since boot */
      uint8_t timeStatus;      /* The Time Status. See Table 8 page 27 Novatel
                                  OEMStar Manual */
     ...
     * software version allows to keep track of onboard soft/firmware revisions.
     * This message allows the sensor and control MCUs to communicate version
     * numbers on startup. */
    struct {
 ...
 *
 * implemented in slugs_sign.c
 */
void slugs_message_sign(struct slugs_message *msg, uint8_t shared[32]);
int slugs_message_signed(struct slugs_message *msg, uint8_t shared[32]);
 ...
 *
 * implemented in slugs_enc.c
 */
size_t slugs_message_serialize_v1(struct slugs_message *msg, uint8_t *buf,
                                  size_t size);
size_t slugs_message_serialize_v2(struct slugs_message *msg, uint8_t *buf,
                                  size_t size);
 ...
 *
 * implemented in slugs_dec.c
 */
size_t slugs_message_seek(const uint8_t *buf, size_t size);
 ...
 * implemented in slugs_dec.c
 */
size_t slugs_message_deserialize(const uint8_t *buf, size_t size,
                                 struct slugs_message *msg);

/* _snprintf appends a debug representation of the message to a buffer
 * implemented in slugs_fmt.c
 */
size_t slugs_message_snprintf(char *buf, size_t size,
                              const struct slugs_message *msg);
