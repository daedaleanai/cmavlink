...
static void append_payload_base(uint8_t **p,
  ...
  case PYTHON_ARRAY_TEST_MESSAGE_ARRAY_TEST_0:
    ...
    for (size_t i = 0; i < 4; i++)
      append_uint32(p, msg->array_test_0.ar_u32[i]);
    for (size_t i = 0; i < 4; i++)
      append_uint16(p, msg->array_test_0.ar_u16[i]);
    append_byte(p, msg->array_test_0.v1);
    for (size_t i = 0; i < 4; i++)
      append_int8(p, msg->array_test_0.ar_i8[i]);
    for (size_t i = 0; i < 4; i++)
      append_byte(p, msg->array_test_0.ar_u8[i]);
    break;

  case PYTHON_ARRAY_TEST_MESSAGE_ARRAY_TEST_1:

    for (size_t i = 0; i < 4; i++)
      append_uint32(p, msg->array_test_1.ar_u32[i]);
    break;

  case PYTHON_ARRAY_TEST_MESSAGE_ARRAY_TEST_3:

    for (size_t i = 0; i < 4; i++)
      append_uint32(p, msg->array_test_3.ar_u32[i]);
    append_byte(p, msg->array_test_3.v);
    break;

  case PYTHON_ARRAY_TEST_MESSAGE_ARRAY_TEST_4:

    for (size_t i = 0; i < 4; i++)
      append_uint32(p, msg->array_test_4.ar_u32[i]);
    append_byte(p, msg->array_test_4.v);
    break;

  case PYTHON_ARRAY_TEST_MESSAGE_ARRAY_TEST_5:

    for (size_t i = 0; i < 5; i++)
      append_byte(p, msg->array_test_5.c1[i]);
    for (size_t i = 0; i < 5; i++)
      append_byte(p, msg->array_test_5.c2[i]);
    break;

  case PYTHON_ARRAY_TEST_MESSAGE_ARRAY_TEST_6:

    for (size_t i = 0; i < 2; i++)
      append_float64(p, msg->array_test_6.ar_d[i]);
    append_uint32(p, msg->array_test_6.v3);
    for (size_t i = 0; i < 2; i++)
      append_uint32(p, msg->array_test_6.ar_u32[i]);
    for (size_t i = 0; i < 2; i++)
      append_int32(p, msg->array_test_6.ar_i32[i]);
    for (size_t i = 0; i < 2; i++)
      append_float32(p, msg->array_test_6.ar_f[i]);
    append_uint16(p, msg->array_test_6.v2);
    for (size_t i = 0; i < 2; i++)
      append_uint16(p, msg->array_test_6.ar_u16[i]);
    for (size_t i = 0; i < 2; i++)
      append_int16(p, msg->array_test_6.ar_i16[i]);
    append_byte(p, msg->array_test_6.v1);
    for (size_t i = 0; i < 2; i++)
      append_byte(p, msg->array_test_6.ar_u8[i]);
    for (size_t i = 0; i < 2; i++)
      append_int8(p, msg->array_test_6.ar_i8[i]);
    for (size_t i = 0; i < 32; i++)
      append_byte(p, msg->array_test_6.ar_c[i]);
    break;

  case PYTHON_ARRAY_TEST_MESSAGE_ARRAY_TEST_7:

    for (size_t i = 0; i < 2; i++)
      append_float64(p, msg->array_test_7.ar_d[i]);
    for (size_t i = 0; i < 2; i++)
      append_float32(p, msg->array_test_7.ar_f[i]);
    for (size_t i = 0; i < 2; i++)
      append_uint32(p, msg->array_test_7.ar_u32[i]);
    for (size_t i = 0; i < 2; i++)
      append_int32(p, msg->array_test_7.ar_i32[i]);
    for (size_t i = 0; i < 2; i++)
      append_uint16(p, msg->array_test_7.ar_u16[i]);
    for (size_t i = 0; i < 2; i++)
      append_int16(p, msg->array_test_7.ar_i16[i]);
    for (size_t i = 0; i < 2; i++)
      append_byte(p, msg->array_test_7.ar_u8[i]);
    for (size_t i = 0; i < 2; i++)
      append_int8(p, msg->array_test_7.ar_i8[i]);
    for (size_t i = 0; i < 32; i++)
      append_byte(p, msg->array_test_7.ar_c[i]);
    break;

  case PYTHON_ARRAY_TEST_MESSAGE_ARRAY_TEST_8:

    for (size_t i = 0; i < 2; i++)
      append_float64(p, msg->array_test_8.ar_d[i]);
    append_uint32(p, msg->array_test_8.v3);
    for (size_t i = 0; i < 2; i++)
      append_uint16(p, msg->array_test_8.ar_u16[i]);
    break;
...
static void append_payload_ext(uint8_t **p,
                               struct python_array_test_message *msg) {
  switch (msg->msg_id) {
