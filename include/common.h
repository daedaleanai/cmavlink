...
// This enum is used to switch the anonymous union in common_message.
enum COMMON_MESSAGE {
  COMMON_MESSAGE_HEARTBEAT = 0,
  COMMON_MESSAGE_SYS_STATUS = 1,
  COMMON_MESSAGE_SYSTEM_TIME = 2,
  COMMON_MESSAGE_PING = 4,
  COMMON_MESSAGE_CHANGE_OPERATOR_CONTROL = 5,
  COMMON_MESSAGE_CHANGE_OPERATOR_CONTROL_ACK = 6,
  COMMON_MESSAGE_AUTH_KEY = 7,
  COMMON_MESSAGE_LINK_NODE_STATUS = 8,
  COMMON_MESSAGE_SET_MODE = 11,
  COMMON_MESSAGE_PARAM_REQUEST_READ = 20,
  COMMON_MESSAGE_PARAM_REQUEST_LIST = 21,
  COMMON_MESSAGE_PARAM_VALUE = 22,
  COMMON_MESSAGE_PARAM_SET = 23,
  COMMON_MESSAGE_GPS_RAW_INT = 24,
  COMMON_MESSAGE_GPS_STATUS = 25,
  COMMON_MESSAGE_SCALED_IMU = 26,
  COMMON_MESSAGE_RAW_IMU = 27,
  COMMON_MESSAGE_RAW_PRESSURE = 28,
  COMMON_MESSAGE_SCALED_PRESSURE = 29,
  COMMON_MESSAGE_ATTITUDE = 30,
  COMMON_MESSAGE_ATTITUDE_QUATERNION = 31,
  COMMON_MESSAGE_LOCAL_POSITION_NED = 32,
  COMMON_MESSAGE_GLOBAL_POSITION_INT = 33,
  COMMON_MESSAGE_RC_CHANNELS_SCALED = 34,
  COMMON_MESSAGE_RC_CHANNELS_RAW = 35,
  COMMON_MESSAGE_SERVO_OUTPUT_RAW = 36,
  COMMON_MESSAGE_MISSION_REQUEST_PARTIAL_LIST = 37,
  COMMON_MESSAGE_MISSION_WRITE_PARTIAL_LIST = 38,
  COMMON_MESSAGE_MISSION_ITEM = 39,
  COMMON_MESSAGE_MISSION_REQUEST = 40,
  COMMON_MESSAGE_MISSION_SET_CURRENT = 41,
  COMMON_MESSAGE_MISSION_CURRENT = 42,
  COMMON_MESSAGE_MISSION_REQUEST_LIST = 43,
  COMMON_MESSAGE_MISSION_COUNT = 44,
  COMMON_MESSAGE_MISSION_CLEAR_ALL = 45,
  COMMON_MESSAGE_MISSION_ITEM_REACHED = 46,
  COMMON_MESSAGE_MISSION_ACK = 47,
  COMMON_MESSAGE_SET_GPS_GLOBAL_ORIGIN = 48,
  COMMON_MESSAGE_GPS_GLOBAL_ORIGIN = 49,
  COMMON_MESSAGE_PARAM_MAP_RC = 50,
  COMMON_MESSAGE_MISSION_REQUEST_INT = 51,
  COMMON_MESSAGE_MISSION_CHANGED = 52,
  COMMON_MESSAGE_SAFETY_SET_ALLOWED_AREA = 54,
  COMMON_MESSAGE_SAFETY_ALLOWED_AREA = 55,
  COMMON_MESSAGE_ATTITUDE_QUATERNION_COV = 61,
  COMMON_MESSAGE_NAV_CONTROLLER_OUTPUT = 62,
  COMMON_MESSAGE_GLOBAL_POSITION_INT_COV = 63,
  COMMON_MESSAGE_LOCAL_POSITION_NED_COV = 64,
  COMMON_MESSAGE_RC_CHANNELS = 65,
  COMMON_MESSAGE_REQUEST_DATA_STREAM = 66,
  COMMON_MESSAGE_DATA_STREAM = 67,
  COMMON_MESSAGE_MANUAL_CONTROL = 69,
  COMMON_MESSAGE_RC_CHANNELS_OVERRIDE = 70,
  COMMON_MESSAGE_MISSION_ITEM_INT = 73,
  COMMON_MESSAGE_VFR_HUD = 74,
  COMMON_MESSAGE_COMMAND_INT = 75,
  COMMON_MESSAGE_COMMAND_LONG = 76,
  COMMON_MESSAGE_COMMAND_ACK = 77,
  COMMON_MESSAGE_MANUAL_SETPOINT = 81,
  COMMON_MESSAGE_SET_ATTITUDE_TARGET = 82,
  COMMON_MESSAGE_ATTITUDE_TARGET = 83,
  COMMON_MESSAGE_SET_POSITION_TARGET_LOCAL_NED = 84,
  COMMON_MESSAGE_POSITION_TARGET_LOCAL_NED = 85,
  COMMON_MESSAGE_SET_POSITION_TARGET_GLOBAL_INT = 86,
  COMMON_MESSAGE_POSITION_TARGET_GLOBAL_INT = 87,
  COMMON_MESSAGE_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET = 89,
  COMMON_MESSAGE_HIL_STATE = 90,
  COMMON_MESSAGE_HIL_CONTROLS = 91,
  COMMON_MESSAGE_HIL_RC_INPUTS_RAW = 92,
  COMMON_MESSAGE_HIL_ACTUATOR_CONTROLS = 93,
  COMMON_MESSAGE_OPTICAL_FLOW = 100,
  COMMON_MESSAGE_GLOBAL_VISION_POSITION_ESTIMATE = 101,
  COMMON_MESSAGE_VISION_POSITION_ESTIMATE = 102,
  COMMON_MESSAGE_VISION_SPEED_ESTIMATE = 103,
  COMMON_MESSAGE_VICON_POSITION_ESTIMATE = 104,
  COMMON_MESSAGE_HIGHRES_IMU = 105,
  COMMON_MESSAGE_OPTICAL_FLOW_RAD = 106,
  COMMON_MESSAGE_HIL_SENSOR = 107,
  COMMON_MESSAGE_SIM_STATE = 108,
  COMMON_MESSAGE_RADIO_STATUS = 109,
  COMMON_MESSAGE_FILE_TRANSFER_PROTOCOL = 110,
  COMMON_MESSAGE_TIMESYNC = 111,
  COMMON_MESSAGE_CAMERA_TRIGGER = 112,
  COMMON_MESSAGE_HIL_GPS = 113,
  COMMON_MESSAGE_HIL_OPTICAL_FLOW = 114,
  COMMON_MESSAGE_HIL_STATE_QUATERNION = 115,
  COMMON_MESSAGE_SCALED_IMU2 = 116,
  COMMON_MESSAGE_LOG_REQUEST_LIST = 117,
  COMMON_MESSAGE_LOG_ENTRY = 118,
  COMMON_MESSAGE_LOG_REQUEST_DATA = 119,
  COMMON_MESSAGE_LOG_DATA = 120,
  COMMON_MESSAGE_LOG_ERASE = 121,
  COMMON_MESSAGE_LOG_REQUEST_END = 122,
  COMMON_MESSAGE_GPS_INJECT_DATA = 123,
  COMMON_MESSAGE_GPS2_RAW = 124,
  COMMON_MESSAGE_POWER_STATUS = 125,
  COMMON_MESSAGE_SERIAL_CONTROL = 126,
  COMMON_MESSAGE_GPS_RTK = 127,
  COMMON_MESSAGE_GPS2_RTK = 128,
  COMMON_MESSAGE_SCALED_IMU3 = 129,
  COMMON_MESSAGE_DATA_TRANSMISSION_HANDSHAKE = 130,
  COMMON_MESSAGE_ENCAPSULATED_DATA = 131,
  COMMON_MESSAGE_DISTANCE_SENSOR = 132,
  COMMON_MESSAGE_TERRAIN_REQUEST = 133,
  COMMON_MESSAGE_TERRAIN_DATA = 134,
  COMMON_MESSAGE_TERRAIN_CHECK = 135,
  COMMON_MESSAGE_TERRAIN_REPORT = 136,
  COMMON_MESSAGE_SCALED_PRESSURE2 = 137,
  COMMON_MESSAGE_ATT_POS_MOCAP = 138,
  COMMON_MESSAGE_SET_ACTUATOR_CONTROL_TARGET = 139,
  COMMON_MESSAGE_ACTUATOR_CONTROL_TARGET = 140,
  COMMON_MESSAGE_ALTITUDE = 141,
  COMMON_MESSAGE_RESOURCE_REQUEST = 142,
  COMMON_MESSAGE_SCALED_PRESSURE3 = 143,
  COMMON_MESSAGE_FOLLOW_TARGET = 144,
  COMMON_MESSAGE_CONTROL_SYSTEM_STATE = 146,
  COMMON_MESSAGE_BATTERY_STATUS = 147,
  COMMON_MESSAGE_AUTOPILOT_VERSION = 148,
  COMMON_MESSAGE_LANDING_TARGET = 149,
  COMMON_MESSAGE_ESTIMATOR_STATUS = 230,
  COMMON_MESSAGE_WIND_COV = 231,
  COMMON_MESSAGE_GPS_INPUT = 232,
  COMMON_MESSAGE_GPS_RTCM_DATA = 233,
  COMMON_MESSAGE_HIGH_LATENCY = 234,
  COMMON_MESSAGE_HIGH_LATENCY2 = 235,
  COMMON_MESSAGE_VIBRATION = 241,
  COMMON_MESSAGE_HOME_POSITION = 242,
  COMMON_MESSAGE_SET_HOME_POSITION = 243,
  COMMON_MESSAGE_MESSAGE_INTERVAL = 244,
  COMMON_MESSAGE_EXTENDED_SYS_STATE = 245,
  COMMON_MESSAGE_ADSB_VEHICLE = 246,
  COMMON_MESSAGE_COLLISION = 247,
  COMMON_MESSAGE_V2_EXTENSION = 248,
  COMMON_MESSAGE_MEMORY_VECT = 249,
  COMMON_MESSAGE_DEBUG_VECT = 250,
  COMMON_MESSAGE_NAMED_VALUE_FLOAT = 251,
  COMMON_MESSAGE_NAMED_VALUE_INT = 252,
  COMMON_MESSAGE_STATUSTEXT = 253,
  COMMON_MESSAGE_DEBUG = 254,
  COMMON_MESSAGE_SETUP_SIGNING = 256,
  COMMON_MESSAGE_BUTTON_CHANGE = 257,
  COMMON_MESSAGE_PLAY_TUNE = 258,
  COMMON_MESSAGE_CAMERA_INFORMATION = 259,
  COMMON_MESSAGE_CAMERA_SETTINGS = 260,
  COMMON_MESSAGE_STORAGE_INFORMATION = 261,
  COMMON_MESSAGE_CAMERA_CAPTURE_STATUS = 262,
  COMMON_MESSAGE_CAMERA_IMAGE_CAPTURED = 263,
  COMMON_MESSAGE_FLIGHT_INFORMATION = 264,
  COMMON_MESSAGE_MOUNT_ORIENTATION = 265,
  COMMON_MESSAGE_LOGGING_DATA = 266,
  COMMON_MESSAGE_LOGGING_DATA_ACKED = 267,
  COMMON_MESSAGE_LOGGING_ACK = 268,
  COMMON_MESSAGE_VIDEO_STREAM_INFORMATION = 269,
  COMMON_MESSAGE_VIDEO_STREAM_STATUS = 270,
  COMMON_MESSAGE_WIFI_CONFIG_AP = 299,
  COMMON_MESSAGE_PROTOCOL_VERSION = 300,
  COMMON_MESSAGE_UAVCAN_NODE_STATUS = 310,
  COMMON_MESSAGE_UAVCAN_NODE_INFO = 311,
  COMMON_MESSAGE_PARAM_EXT_REQUEST_READ = 320,
  COMMON_MESSAGE_PARAM_EXT_REQUEST_LIST = 321,
  COMMON_MESSAGE_PARAM_EXT_VALUE = 322,
  COMMON_MESSAGE_PARAM_EXT_SET = 323,
  COMMON_MESSAGE_PARAM_EXT_ACK = 324,
  COMMON_MESSAGE_OBSTACLE_DISTANCE = 330,
  COMMON_MESSAGE_ODOMETRY = 331,
  COMMON_MESSAGE_TRAJECTORY_REPRESENTATION_WAYPOINTS = 332,
  COMMON_MESSAGE_TRAJECTORY_REPRESENTATION_BEZIER = 333,
  COMMON_MESSAGE_CELLULAR_STATUS = 334,
  COMMON_MESSAGE_ISBD_LINK_STATUS = 335,
  COMMON_MESSAGE_UTM_GLOBAL_POSITION = 340,
  COMMON_MESSAGE_DEBUG_FLOAT_ARRAY = 350,
  COMMON_MESSAGE_ORBIT_EXECUTION_STATUS = 360,
  COMMON_MESSAGE_STATUSTEXT_LONG = 365,
  COMMON_MESSAGE_SMART_BATTERY_INFO = 370,
  COMMON_MESSAGE_SMART_BATTERY_STATUS = 371,
  COMMON_MESSAGE_ACTUATOR_OUTPUT_STATUS = 375,
  COMMON_MESSAGE_TIME_ESTIMATE_TO_TARGET = 380,
  COMMON_MESSAGE_WHEEL_DISTANCE = 9000
};
 ...
 *
 * implemented in common_sign.c
 */
void common_message_sign(struct common_message *msg, uint8_t shared[32]);
int common_message_signed(struct common_message *msg, uint8_t shared[32]);
 ...
 *
 * implemented in common_enc.c
 */
size_t common_message_serialize_v1(struct common_message *msg, uint8_t *buf,
                                   size_t size);
size_t common_message_serialize_v2(struct common_message *msg, uint8_t *buf,
                                   size_t size);
 ...
 *
 * implemented in common_dec.c
 */
size_t common_message_seek(const uint8_t *buf, size_t size);
