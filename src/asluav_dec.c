...
static void read_payload_base(const uint8_t **p, struct asluav_message *msg) {
  switch (msg->msg_id) {
  ...
  case ASLUAV_MESSAGE_COMMAND_INT_STAMPED:
    msg->command_int_stamped.vehicle_timestamp = read_uint64(p);
    msg->command_int_stamped.utc_time = read_uint32(p);
    msg->command_int_stamped.param1 = read_float32(p);
    msg->command_int_stamped.param2 = read_float32(p);
    msg->command_int_stamped.param3 = read_float32(p);
    msg->command_int_stamped.param4 = read_float32(p);
    msg->command_int_stamped.x = read_int32(p);
    msg->command_int_stamped.y = read_int32(p);
    msg->command_int_stamped.z = read_float32(p);
    msg->command_int_stamped.command = read_uint16(p);
    msg->command_int_stamped.target_system = read_byte(p);
    msg->command_int_stamped.target_component = read_byte(p);
    msg->command_int_stamped.frame = read_byte(p);
    msg->command_int_stamped.current = read_byte(p);
    msg->command_int_stamped.autocontinue = read_byte(p);
    break;

  case ASLUAV_MESSAGE_COMMAND_LONG_STAMPED:
    msg->command_long_stamped.vehicle_timestamp = read_uint64(p);
    msg->command_long_stamped.utc_time = read_uint32(p);
    msg->command_long_stamped.param1 = read_float32(p);
    msg->command_long_stamped.param2 = read_float32(p);
    msg->command_long_stamped.param3 = read_float32(p);
    msg->command_long_stamped.param4 = read_float32(p);
    msg->command_long_stamped.param5 = read_float32(p);
    msg->command_long_stamped.param6 = read_float32(p);
    msg->command_long_stamped.param7 = read_float32(p);
    msg->command_long_stamped.command = read_uint16(p);
    msg->command_long_stamped.target_system = read_byte(p);
    msg->command_long_stamped.target_component = read_byte(p);
    msg->command_long_stamped.confirmation = read_byte(p);
    break;
  ...
  case ASLUAV_MESSAGE_SENS_POWER:
    msg->sens_power.adc121_vspb_volt = read_float32(p);
    msg->sens_power.adc121_cspb_amp = read_float32(p);
    msg->sens_power.adc121_cs1_amp = read_float32(p);
    msg->sens_power.adc121_cs2_amp = read_float32(p);
    break;

  case ASLUAV_MESSAGE_SENS_MPPT:
    msg->sens_mppt.mppt_timestamp = read_uint64(p);
    msg->sens_mppt.mppt1_volt = read_float32(p);
    msg->sens_mppt.mppt1_amp = read_float32(p);
    msg->sens_mppt.mppt2_volt = read_float32(p);
    msg->sens_mppt.mppt2_amp = read_float32(p);
    msg->sens_mppt.mppt3_volt = read_float32(p);
    msg->sens_mppt.mppt3_amp = read_float32(p);
    msg->sens_mppt.mppt1_pwm = read_uint16(p);
    msg->sens_mppt.mppt2_pwm = read_uint16(p);
    msg->sens_mppt.mppt3_pwm = read_uint16(p);
    msg->sens_mppt.mppt1_status = read_byte(p);
    msg->sens_mppt.mppt2_status = read_byte(p);
    msg->sens_mppt.mppt3_status = read_byte(p);
    break;

  case ASLUAV_MESSAGE_ASLCTRL_DATA:
    msg->aslctrl_data.timestamp = read_uint64(p);
    msg->aslctrl_data.h = read_float32(p);
    msg->aslctrl_data.hRef = read_float32(p);
    msg->aslctrl_data.hRef_t = read_float32(p);
    msg->aslctrl_data.PitchAngle = read_float32(p);
    msg->aslctrl_data.PitchAngleRef = read_float32(p);
    msg->aslctrl_data.q = read_float32(p);
    msg->aslctrl_data.qRef = read_float32(p);
    msg->aslctrl_data.uElev = read_float32(p);
    msg->aslctrl_data.uThrot = read_float32(p);
    msg->aslctrl_data.uThrot2 = read_float32(p);
    msg->aslctrl_data.nZ = read_float32(p);
    msg->aslctrl_data.AirspeedRef = read_float32(p);
    msg->aslctrl_data.YawAngle = read_float32(p);
    msg->aslctrl_data.YawAngleRef = read_float32(p);
    msg->aslctrl_data.RollAngle = read_float32(p);
    msg->aslctrl_data.RollAngleRef = read_float32(p);
    msg->aslctrl_data.p = read_float32(p);
    msg->aslctrl_data.pRef = read_float32(p);
    msg->aslctrl_data.r = read_float32(p);
    msg->aslctrl_data.rRef = read_float32(p);
    msg->aslctrl_data.uAil = read_float32(p);
    msg->aslctrl_data.uRud = read_float32(p);
    msg->aslctrl_data.aslctrl_mode = read_byte(p);
    msg->aslctrl_data.SpoilersEngaged = read_byte(p);
    break;

  case ASLUAV_MESSAGE_ASLCTRL_DEBUG:
    msg->aslctrl_debug.i32_1 = read_uint32(p);
    msg->aslctrl_debug.f_1 = read_float32(p);
    msg->aslctrl_debug.f_2 = read_float32(p);
    msg->aslctrl_debug.f_3 = read_float32(p);
    msg->aslctrl_debug.f_4 = read_float32(p);
    msg->aslctrl_debug.f_5 = read_float32(p);
    msg->aslctrl_debug.f_6 = read_float32(p);
    msg->aslctrl_debug.f_7 = read_float32(p);
    msg->aslctrl_debug.f_8 = read_float32(p);
    msg->aslctrl_debug.i8_1 = read_byte(p);
    msg->aslctrl_debug.i8_2 = read_byte(p);
    break;

  case ASLUAV_MESSAGE_ASLUAV_STATUS:
    msg->asluav_status.Motor_rpm = read_float32(p);
    msg->asluav_status.LED_status = read_byte(p);
    msg->asluav_status.SATCOM_status = read_byte(p);
    for (size_t i = 0; i < 8; i++)
      msg->asluav_status.Servo_status[i] = read_byte(p);
    break;

  case ASLUAV_MESSAGE_EKF_EXT:
    msg->ekf_ext.timestamp = read_uint64(p);
    msg->ekf_ext.Windspeed = read_float32(p);
    msg->ekf_ext.WindDir = read_float32(p);
    msg->ekf_ext.WindZ = read_float32(p);
    msg->ekf_ext.Airspeed = read_float32(p);
    msg->ekf_ext.beta = read_float32(p);
    msg->ekf_ext.alpha = read_float32(p);
    break;

  case ASLUAV_MESSAGE_ASL_OBCTRL:
    msg->asl_obctrl.timestamp = read_uint64(p);
    msg->asl_obctrl.uElev = read_float32(p);
    msg->asl_obctrl.uThrot = read_float32(p);
    msg->asl_obctrl.uThrot2 = read_float32(p);
    msg->asl_obctrl.uAilL = read_float32(p);
    msg->asl_obctrl.uAilR = read_float32(p);
    msg->asl_obctrl.uRud = read_float32(p);
    msg->asl_obctrl.obctrl_status = read_byte(p);
    break;

  case ASLUAV_MESSAGE_SENS_ATMOS:
    msg->sens_atmos.timestamp = read_uint64(p);
    msg->sens_atmos.TempAmbient = read_float32(p);
    msg->sens_atmos.Humidity = read_float32(p);
    break;

  case ASLUAV_MESSAGE_SENS_BATMON:
    msg->sens_batmon.batmon_timestamp = read_uint64(p);
    msg->sens_batmon.temperature = read_float32(p);
    msg->sens_batmon.safetystatus = read_uint32(p);
    msg->sens_batmon.operationstatus = read_uint32(p);
    msg->sens_batmon.voltage = read_uint16(p);
    msg->sens_batmon.current = read_int16(p);
    msg->sens_batmon.batterystatus = read_uint16(p);
    msg->sens_batmon.serialnumber = read_uint16(p);
    msg->sens_batmon.cellvoltage1 = read_uint16(p);
    msg->sens_batmon.cellvoltage2 = read_uint16(p);
    msg->sens_batmon.cellvoltage3 = read_uint16(p);
    msg->sens_batmon.cellvoltage4 = read_uint16(p);
    msg->sens_batmon.cellvoltage5 = read_uint16(p);
    msg->sens_batmon.cellvoltage6 = read_uint16(p);
    msg->sens_batmon.SoC = read_byte(p);
    break;

  case ASLUAV_MESSAGE_FW_SOARING_DATA:
    msg->fw_soaring_data.timestamp = read_uint64(p);
    msg->fw_soaring_data.timestampModeChanged = read_uint64(p);
    msg->fw_soaring_data.xW = read_float32(p);
    msg->fw_soaring_data.xR = read_float32(p);
    msg->fw_soaring_data.xLat = read_float32(p);
    msg->fw_soaring_data.xLon = read_float32(p);
    msg->fw_soaring_data.VarW = read_float32(p);
    msg->fw_soaring_data.VarR = read_float32(p);
    msg->fw_soaring_data.VarLat = read_float32(p);
    msg->fw_soaring_data.VarLon = read_float32(p);
    msg->fw_soaring_data.LoiterRadius = read_float32(p);
    msg->fw_soaring_data.LoiterDirection = read_float32(p);
    msg->fw_soaring_data.DistToSoarPoint = read_float32(p);
    msg->fw_soaring_data.vSinkExp = read_float32(p);
    msg->fw_soaring_data.z1_LocalUpdraftSpeed = read_float32(p);
    msg->fw_soaring_data.z2_DeltaRoll = read_float32(p);
    msg->fw_soaring_data.z1_exp = read_float32(p);
    msg->fw_soaring_data.z2_exp = read_float32(p);
    msg->fw_soaring_data.ThermalGSNorth = read_float32(p);
    msg->fw_soaring_data.ThermalGSEast = read_float32(p);
    msg->fw_soaring_data.TSE_dot = read_float32(p);
    msg->fw_soaring_data.DebugVar1 = read_float32(p);
    msg->fw_soaring_data.DebugVar2 = read_float32(p);
    msg->fw_soaring_data.ControlMode = read_byte(p);
    msg->fw_soaring_data.valid = read_byte(p);
    break;

  case ASLUAV_MESSAGE_SENSORPOD_STATUS:
    msg->sensorpod_status.timestamp = read_uint64(p);
    msg->sensorpod_status.free_space = read_uint16(p);
    msg->sensorpod_status.visensor_rate_1 = read_byte(p);
    msg->sensorpod_status.visensor_rate_2 = read_byte(p);
    msg->sensorpod_status.visensor_rate_3 = read_byte(p);
    msg->sensorpod_status.visensor_rate_4 = read_byte(p);
    msg->sensorpod_status.recording_nodes_count = read_byte(p);
    msg->sensorpod_status.cpu_temp = read_byte(p);
    break;

  case ASLUAV_MESSAGE_SENS_POWER_BOARD:
    msg->sens_power_board.timestamp = read_uint64(p);
    msg->sens_power_board.pwr_brd_system_volt = read_float32(p);
    msg->sens_power_board.pwr_brd_servo_volt = read_float32(p);
    msg->sens_power_board.pwr_brd_digital_volt = read_float32(p);
    msg->sens_power_board.pwr_brd_mot_l_amp = read_float32(p);
    msg->sens_power_board.pwr_brd_mot_r_amp = read_float32(p);
    msg->sens_power_board.pwr_brd_analog_amp = read_float32(p);
    msg->sens_power_board.pwr_brd_digital_amp = read_float32(p);
    msg->sens_power_board.pwr_brd_ext_amp = read_float32(p);
    msg->sens_power_board.pwr_brd_aux_amp = read_float32(p);
    msg->sens_power_board.pwr_brd_status = read_byte(p);
    msg->sens_power_board.pwr_brd_led_status = read_byte(p);
    break;

  case ASLUAV_MESSAGE_GSM_LINK_STATUS:
    msg->gsm_link_status.timestamp = read_uint64(p);
    msg->gsm_link_status.gsm_modem_type = read_byte(p);
    msg->gsm_link_status.gsm_link_type = read_byte(p);
    msg->gsm_link_status.rssi = read_byte(p);
    msg->gsm_link_status.rsrp_rscp = read_byte(p);
    msg->gsm_link_status.sinr_ecio = read_byte(p);
    msg->gsm_link_status.rsrq = read_byte(p);
    break;
...
static void read_payload_ext(const uint8_t **p, struct asluav_message *msg) {
  switch (msg->msg_id) {
