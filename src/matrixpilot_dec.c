...
static void read_payload_base(const uint8_t **p,
  ...
  case MATRIXPILOT_MESSAGE_FLEXIFUNCTION_SET:
    msg->flexifunction_set.target_system = read_byte(p);
    msg->flexifunction_set.target_component = read_byte(p);
    break;

  case MATRIXPILOT_MESSAGE_FLEXIFUNCTION_READ_REQ:
    msg->flexifunction_read_req.read_req_type = read_int16(p);
    msg->flexifunction_read_req.data_index = read_int16(p);
    msg->flexifunction_read_req.target_system = read_byte(p);
    msg->flexifunction_read_req.target_component = read_byte(p);
    break;

  case MATRIXPILOT_MESSAGE_FLEXIFUNCTION_BUFFER_FUNCTION:
    msg->flexifunction_buffer_function.func_index = read_uint16(p);
    msg->flexifunction_buffer_function.func_count = read_uint16(p);
    msg->flexifunction_buffer_function.data_address = read_uint16(p);
    msg->flexifunction_buffer_function.data_size = read_uint16(p);
    msg->flexifunction_buffer_function.target_system = read_byte(p);
    msg->flexifunction_buffer_function.target_component = read_byte(p);
    for (size_t i = 0; i < 48; i++)
      msg->flexifunction_buffer_function.data[i] = read_int8(p);
    break;

  case MATRIXPILOT_MESSAGE_FLEXIFUNCTION_BUFFER_FUNCTION_ACK:
    msg->flexifunction_buffer_function_ack.func_index = read_uint16(p);
    msg->flexifunction_buffer_function_ack.result = read_uint16(p);
    msg->flexifunction_buffer_function_ack.target_system = read_byte(p);
    msg->flexifunction_buffer_function_ack.target_component = read_byte(p);
    break;

  case MATRIXPILOT_MESSAGE_FLEXIFUNCTION_DIRECTORY:
    msg->flexifunction_directory.target_system = read_byte(p);
    msg->flexifunction_directory.target_component = read_byte(p);
    msg->flexifunction_directory.directory_type = read_byte(p);
    msg->flexifunction_directory.start_index = read_byte(p);
    msg->flexifunction_directory.count = read_byte(p);
    for (size_t i = 0; i < 48; i++)
      msg->flexifunction_directory.directory_data[i] = read_int8(p);
    break;

  case MATRIXPILOT_MESSAGE_FLEXIFUNCTION_DIRECTORY_ACK:
    msg->flexifunction_directory_ack.result = read_uint16(p);
    msg->flexifunction_directory_ack.target_system = read_byte(p);
    msg->flexifunction_directory_ack.target_component = read_byte(p);
    msg->flexifunction_directory_ack.directory_type = read_byte(p);
    msg->flexifunction_directory_ack.start_index = read_byte(p);
    msg->flexifunction_directory_ack.count = read_byte(p);
    break;

  case MATRIXPILOT_MESSAGE_FLEXIFUNCTION_COMMAND:
    msg->flexifunction_command.target_system = read_byte(p);
    msg->flexifunction_command.target_component = read_byte(p);
    msg->flexifunction_command.command_type = read_byte(p);
    break;

  case MATRIXPILOT_MESSAGE_FLEXIFUNCTION_COMMAND_ACK:
    msg->flexifunction_command_ack.command_type = read_uint16(p);
    msg->flexifunction_command_ack.result = read_uint16(p);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F2_A:
    msg->serial_udb_extra_f2_a.sue_time = read_uint32(p);
    msg->serial_udb_extra_f2_a.sue_latitude = read_int32(p);
    msg->serial_udb_extra_f2_a.sue_longitude = read_int32(p);
    msg->serial_udb_extra_f2_a.sue_altitude = read_int32(p);
    msg->serial_udb_extra_f2_a.sue_waypoint_index = read_uint16(p);
    msg->serial_udb_extra_f2_a.sue_rmat0 = read_int16(p);
    msg->serial_udb_extra_f2_a.sue_rmat1 = read_int16(p);
    msg->serial_udb_extra_f2_a.sue_rmat2 = read_int16(p);
    msg->serial_udb_extra_f2_a.sue_rmat3 = read_int16(p);
    msg->serial_udb_extra_f2_a.sue_rmat4 = read_int16(p);
    msg->serial_udb_extra_f2_a.sue_rmat5 = read_int16(p);
    msg->serial_udb_extra_f2_a.sue_rmat6 = read_int16(p);
    msg->serial_udb_extra_f2_a.sue_rmat7 = read_int16(p);
    msg->serial_udb_extra_f2_a.sue_rmat8 = read_int16(p);
    msg->serial_udb_extra_f2_a.sue_cog = read_uint16(p);
    msg->serial_udb_extra_f2_a.sue_sog = read_int16(p);
    msg->serial_udb_extra_f2_a.sue_cpu_load = read_uint16(p);
    msg->serial_udb_extra_f2_a.sue_air_speed_3DIMU = read_uint16(p);
    msg->serial_udb_extra_f2_a.sue_estimated_wind_0 = read_int16(p);
    msg->serial_udb_extra_f2_a.sue_estimated_wind_1 = read_int16(p);
    msg->serial_udb_extra_f2_a.sue_estimated_wind_2 = read_int16(p);
    msg->serial_udb_extra_f2_a.sue_magFieldEarth0 = read_int16(p);
    msg->serial_udb_extra_f2_a.sue_magFieldEarth1 = read_int16(p);
    msg->serial_udb_extra_f2_a.sue_magFieldEarth2 = read_int16(p);
    msg->serial_udb_extra_f2_a.sue_svs = read_int16(p);
    msg->serial_udb_extra_f2_a.sue_hdop = read_int16(p);
    msg->serial_udb_extra_f2_a.sue_status = read_byte(p);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F2_B:
    msg->serial_udb_extra_f2_b.sue_time = read_uint32(p);
    msg->serial_udb_extra_f2_b.sue_flags = read_uint32(p);
    msg->serial_udb_extra_f2_b.sue_barom_press = read_int32(p);
    msg->serial_udb_extra_f2_b.sue_barom_alt = read_int32(p);
    msg->serial_udb_extra_f2_b.sue_pwm_input_1 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_input_2 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_input_3 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_input_4 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_input_5 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_input_6 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_input_7 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_input_8 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_input_9 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_input_10 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_input_11 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_input_12 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_output_1 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_output_2 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_output_3 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_output_4 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_output_5 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_output_6 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_output_7 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_output_8 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_output_9 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_output_10 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_output_11 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_pwm_output_12 = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_imu_location_x = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_imu_location_y = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_imu_location_z = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_location_error_earth_x = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_location_error_earth_y = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_location_error_earth_z = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_osc_fails = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_imu_velocity_x = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_imu_velocity_y = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_imu_velocity_z = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_waypoint_goal_x = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_waypoint_goal_y = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_waypoint_goal_z = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_aero_x = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_aero_y = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_aero_z = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_barom_temp = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_bat_volt = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_bat_amp = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_bat_amp_hours = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_desired_height = read_int16(p);
    msg->serial_udb_extra_f2_b.sue_memory_stack_free = read_int16(p);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F4:
    msg->serial_udb_extra_f4.sue_ROLL_STABILIZATION_AILERONS = read_byte(p);
    msg->serial_udb_extra_f4.sue_ROLL_STABILIZATION_RUDDER = read_byte(p);
    msg->serial_udb_extra_f4.sue_PITCH_STABILIZATION = read_byte(p);
    msg->serial_udb_extra_f4.sue_YAW_STABILIZATION_RUDDER = read_byte(p);
    msg->serial_udb_extra_f4.sue_YAW_STABILIZATION_AILERON = read_byte(p);
    msg->serial_udb_extra_f4.sue_AILERON_NAVIGATION = read_byte(p);
    msg->serial_udb_extra_f4.sue_RUDDER_NAVIGATION = read_byte(p);
    msg->serial_udb_extra_f4.sue_ALTITUDEHOLD_STABILIZED = read_byte(p);
    msg->serial_udb_extra_f4.sue_ALTITUDEHOLD_WAYPOINT = read_byte(p);
    msg->serial_udb_extra_f4.sue_RACING_MODE = read_byte(p);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F5:
    msg->serial_udb_extra_f5.sue_YAWKP_AILERON = read_float32(p);
    msg->serial_udb_extra_f5.sue_YAWKD_AILERON = read_float32(p);
    msg->serial_udb_extra_f5.sue_ROLLKP = read_float32(p);
    msg->serial_udb_extra_f5.sue_ROLLKD = read_float32(p);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F6:
    msg->serial_udb_extra_f6.sue_PITCHGAIN = read_float32(p);
    msg->serial_udb_extra_f6.sue_PITCHKD = read_float32(p);
    msg->serial_udb_extra_f6.sue_RUDDER_ELEV_MIX = read_float32(p);
    msg->serial_udb_extra_f6.sue_ROLL_ELEV_MIX = read_float32(p);
    msg->serial_udb_extra_f6.sue_ELEVATOR_BOOST = read_float32(p);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F7:
    msg->serial_udb_extra_f7.sue_YAWKP_RUDDER = read_float32(p);
    msg->serial_udb_extra_f7.sue_YAWKD_RUDDER = read_float32(p);
    msg->serial_udb_extra_f7.sue_ROLLKP_RUDDER = read_float32(p);
    msg->serial_udb_extra_f7.sue_ROLLKD_RUDDER = read_float32(p);
    msg->serial_udb_extra_f7.sue_RUDDER_BOOST = read_float32(p);
    msg->serial_udb_extra_f7.sue_RTL_PITCH_DOWN = read_float32(p);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F8:
    msg->serial_udb_extra_f8.sue_HEIGHT_TARGET_MAX = read_float32(p);
    msg->serial_udb_extra_f8.sue_HEIGHT_TARGET_MIN = read_float32(p);
    msg->serial_udb_extra_f8.sue_ALT_HOLD_THROTTLE_MIN = read_float32(p);
    msg->serial_udb_extra_f8.sue_ALT_HOLD_THROTTLE_MAX = read_float32(p);
    msg->serial_udb_extra_f8.sue_ALT_HOLD_PITCH_MIN = read_float32(p);
    msg->serial_udb_extra_f8.sue_ALT_HOLD_PITCH_MAX = read_float32(p);
    msg->serial_udb_extra_f8.sue_ALT_HOLD_PITCH_HIGH = read_float32(p);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F13:
    msg->serial_udb_extra_f13.sue_lat_origin = read_int32(p);
    msg->serial_udb_extra_f13.sue_lon_origin = read_int32(p);
    msg->serial_udb_extra_f13.sue_alt_origin = read_int32(p);
    msg->serial_udb_extra_f13.sue_week_no = read_int16(p);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F14:
    msg->serial_udb_extra_f14.sue_TRAP_SOURCE = read_uint32(p);
    msg->serial_udb_extra_f14.sue_RCON = read_int16(p);
    msg->serial_udb_extra_f14.sue_TRAP_FLAGS = read_int16(p);
    msg->serial_udb_extra_f14.sue_osc_fail_count = read_int16(p);
    msg->serial_udb_extra_f14.sue_WIND_ESTIMATION = read_byte(p);
    msg->serial_udb_extra_f14.sue_GPS_TYPE = read_byte(p);
    msg->serial_udb_extra_f14.sue_DR = read_byte(p);
    msg->serial_udb_extra_f14.sue_BOARD_TYPE = read_byte(p);
    msg->serial_udb_extra_f14.sue_AIRFRAME = read_byte(p);
    msg->serial_udb_extra_f14.sue_CLOCK_CONFIG = read_byte(p);
    msg->serial_udb_extra_f14.sue_FLIGHT_PLAN_TYPE = read_byte(p);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F15:

    for (size_t i = 0; i < 40; i++)
      msg->serial_udb_extra_f15.sue_ID_VEHICLE_MODEL_NAME[i] = read_byte(p);
    for (size_t i = 0; i < 20; i++)
      msg->serial_udb_extra_f15.sue_ID_VEHICLE_REGISTRATION[i] = read_byte(p);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F16:

    for (size_t i = 0; i < 40; i++)
      msg->serial_udb_extra_f16.sue_ID_LEAD_PILOT[i] = read_byte(p);
    for (size_t i = 0; i < 70; i++)
      msg->serial_udb_extra_f16.sue_ID_DIY_DRONES_URL[i] = read_byte(p);
    break;

  case MATRIXPILOT_MESSAGE_ALTITUDES:
    msg->altitudes.time_boot_ms = read_uint32(p);
    msg->altitudes.alt_gps = read_int32(p);
    msg->altitudes.alt_imu = read_int32(p);
    msg->altitudes.alt_barometric = read_int32(p);
    msg->altitudes.alt_optical_flow = read_int32(p);
    msg->altitudes.alt_range_finder = read_int32(p);
    msg->altitudes.alt_extra = read_int32(p);
    break;

  case MATRIXPILOT_MESSAGE_AIRSPEEDS:
    msg->airspeeds.time_boot_ms = read_uint32(p);
    msg->airspeeds.airspeed_imu = read_int16(p);
    msg->airspeeds.airspeed_pitot = read_int16(p);
    msg->airspeeds.airspeed_hot_wire = read_int16(p);
    msg->airspeeds.airspeed_ultrasonic = read_int16(p);
    msg->airspeeds.aoa = read_int16(p);
    msg->airspeeds.aoy = read_int16(p);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F17:
    msg->serial_udb_extra_f17.sue_feed_forward = read_float32(p);
    msg->serial_udb_extra_f17.sue_turn_rate_nav = read_float32(p);
    msg->serial_udb_extra_f17.sue_turn_rate_fbw = read_float32(p);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F18:
    msg->serial_udb_extra_f18.angle_of_attack_normal = read_float32(p);
    msg->serial_udb_extra_f18.angle_of_attack_inverted = read_float32(p);
    msg->serial_udb_extra_f18.elevator_trim_normal = read_float32(p);
    msg->serial_udb_extra_f18.elevator_trim_inverted = read_float32(p);
    msg->serial_udb_extra_f18.reference_speed = read_float32(p);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F19:
    msg->serial_udb_extra_f19.sue_aileron_output_channel = read_byte(p);
    msg->serial_udb_extra_f19.sue_aileron_reversed = read_byte(p);
    msg->serial_udb_extra_f19.sue_elevator_output_channel = read_byte(p);
    msg->serial_udb_extra_f19.sue_elevator_reversed = read_byte(p);
    msg->serial_udb_extra_f19.sue_throttle_output_channel = read_byte(p);
    msg->serial_udb_extra_f19.sue_throttle_reversed = read_byte(p);
    msg->serial_udb_extra_f19.sue_rudder_output_channel = read_byte(p);
    msg->serial_udb_extra_f19.sue_rudder_reversed = read_byte(p);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F20:
    msg->serial_udb_extra_f20.sue_trim_value_input_1 = read_int16(p);
    msg->serial_udb_extra_f20.sue_trim_value_input_2 = read_int16(p);
    msg->serial_udb_extra_f20.sue_trim_value_input_3 = read_int16(p);
    msg->serial_udb_extra_f20.sue_trim_value_input_4 = read_int16(p);
    msg->serial_udb_extra_f20.sue_trim_value_input_5 = read_int16(p);
    msg->serial_udb_extra_f20.sue_trim_value_input_6 = read_int16(p);
    msg->serial_udb_extra_f20.sue_trim_value_input_7 = read_int16(p);
    msg->serial_udb_extra_f20.sue_trim_value_input_8 = read_int16(p);
    msg->serial_udb_extra_f20.sue_trim_value_input_9 = read_int16(p);
    msg->serial_udb_extra_f20.sue_trim_value_input_10 = read_int16(p);
    msg->serial_udb_extra_f20.sue_trim_value_input_11 = read_int16(p);
    msg->serial_udb_extra_f20.sue_trim_value_input_12 = read_int16(p);
    msg->serial_udb_extra_f20.sue_number_of_inputs = read_byte(p);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F21:
    msg->serial_udb_extra_f21.sue_accel_x_offset = read_int16(p);
    msg->serial_udb_extra_f21.sue_accel_y_offset = read_int16(p);
    msg->serial_udb_extra_f21.sue_accel_z_offset = read_int16(p);
    msg->serial_udb_extra_f21.sue_gyro_x_offset = read_int16(p);
    msg->serial_udb_extra_f21.sue_gyro_y_offset = read_int16(p);
    msg->serial_udb_extra_f21.sue_gyro_z_offset = read_int16(p);
    break;

  case MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F22:
    msg->serial_udb_extra_f22.sue_accel_x_at_calibration = read_int16(p);
    msg->serial_udb_extra_f22.sue_accel_y_at_calibration = read_int16(p);
    msg->serial_udb_extra_f22.sue_accel_z_at_calibration = read_int16(p);
    msg->serial_udb_extra_f22.sue_gyro_x_at_calibration = read_int16(p);
    msg->serial_udb_extra_f22.sue_gyro_y_at_calibration = read_int16(p);
    msg->serial_udb_extra_f22.sue_gyro_z_at_calibration = read_int16(p);
    break;
