...
static void append_payload_base(uint8_t **p, struct common_message *msg) {
  switch (msg->msg_id) {
...
static void append_payload_ext(uint8_t **p, struct common_message *msg) {
  switch (msg->msg_id) {
...
size_t common_message_serialize_v1(struct common_message *msg, uint8_t *buf,
  ...
  *p++ = msg->msg_id;
  ...
  crc = x25(crc, common_crcextra(msg->msg_id));
