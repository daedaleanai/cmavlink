...
static void read_payload_base(const uint8_t **p, struct autoquad_message *msg) {
  switch (msg->msg_id) {
  ...
  case AUTOQUAD_MESSAGE_AQ_TELEMETRY_F:
    msg->aq_telemetry_f.value1 = read_float32(p);
    msg->aq_telemetry_f.value2 = read_float32(p);
    msg->aq_telemetry_f.value3 = read_float32(p);
    msg->aq_telemetry_f.value4 = read_float32(p);
    msg->aq_telemetry_f.value5 = read_float32(p);
    msg->aq_telemetry_f.value6 = read_float32(p);
    msg->aq_telemetry_f.value7 = read_float32(p);
    msg->aq_telemetry_f.value8 = read_float32(p);
    msg->aq_telemetry_f.value9 = read_float32(p);
    msg->aq_telemetry_f.value10 = read_float32(p);
    msg->aq_telemetry_f.value11 = read_float32(p);
    msg->aq_telemetry_f.value12 = read_float32(p);
    msg->aq_telemetry_f.value13 = read_float32(p);
    msg->aq_telemetry_f.value14 = read_float32(p);
    msg->aq_telemetry_f.value15 = read_float32(p);
    msg->aq_telemetry_f.value16 = read_float32(p);
    msg->aq_telemetry_f.value17 = read_float32(p);
    msg->aq_telemetry_f.value18 = read_float32(p);
    msg->aq_telemetry_f.value19 = read_float32(p);
    msg->aq_telemetry_f.value20 = read_float32(p);
    msg->aq_telemetry_f.Index = read_uint16(p);
    break;

  case AUTOQUAD_MESSAGE_AQ_ESC_TELEMETRY:
    msg->aq_esc_telemetry.time_boot_ms = read_uint32(p);
    for (size_t i = 0; i < 4; i++)
      msg->aq_esc_telemetry.data0[i] = read_uint32(p);
    for (size_t i = 0; i < 4; i++)
      msg->aq_esc_telemetry.data1[i] = read_uint32(p);
    for (size_t i = 0; i < 4; i++)
      msg->aq_esc_telemetry.status_age[i] = read_uint16(p);
    msg->aq_esc_telemetry.seq = read_byte(p);
    msg->aq_esc_telemetry.num_motors = read_byte(p);
    msg->aq_esc_telemetry.num_in_seq = read_byte(p);
    for (size_t i = 0; i < 4; i++)
      msg->aq_esc_telemetry.escid[i] = read_byte(p);
    for (size_t i = 0; i < 4; i++)
      msg->aq_esc_telemetry.data_version[i] = read_byte(p);
    break;
...
static void read_payload_ext(const uint8_t **p, struct autoquad_message *msg) {
  switch (msg->msg_id) {
