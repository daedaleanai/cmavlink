...
// This enum is used to switch the anonymous union in uavionix_message.
enum UAVIONIX_MESSAGE {
  UAVIONIX_MESSAGE_HEARTBEAT = 0,
  UAVIONIX_MESSAGE_SYS_STATUS = 1,
  UAVIONIX_MESSAGE_SYSTEM_TIME = 2,
  UAVIONIX_MESSAGE_PING = 4,
  UAVIONIX_MESSAGE_CHANGE_OPERATOR_CONTROL = 5,
  UAVIONIX_MESSAGE_CHANGE_OPERATOR_CONTROL_ACK = 6,
  UAVIONIX_MESSAGE_AUTH_KEY = 7,
  UAVIONIX_MESSAGE_LINK_NODE_STATUS = 8,
  UAVIONIX_MESSAGE_SET_MODE = 11,
  UAVIONIX_MESSAGE_PARAM_REQUEST_READ = 20,
  UAVIONIX_MESSAGE_PARAM_REQUEST_LIST = 21,
  UAVIONIX_MESSAGE_PARAM_VALUE = 22,
  UAVIONIX_MESSAGE_PARAM_SET = 23,
  UAVIONIX_MESSAGE_GPS_RAW_INT = 24,
  UAVIONIX_MESSAGE_GPS_STATUS = 25,
  UAVIONIX_MESSAGE_SCALED_IMU = 26,
  UAVIONIX_MESSAGE_RAW_IMU = 27,
  UAVIONIX_MESSAGE_RAW_PRESSURE = 28,
  UAVIONIX_MESSAGE_SCALED_PRESSURE = 29,
  UAVIONIX_MESSAGE_ATTITUDE = 30,
  UAVIONIX_MESSAGE_ATTITUDE_QUATERNION = 31,
  UAVIONIX_MESSAGE_LOCAL_POSITION_NED = 32,
  UAVIONIX_MESSAGE_GLOBAL_POSITION_INT = 33,
  UAVIONIX_MESSAGE_RC_CHANNELS_SCALED = 34,
  UAVIONIX_MESSAGE_RC_CHANNELS_RAW = 35,
  UAVIONIX_MESSAGE_SERVO_OUTPUT_RAW = 36,
  UAVIONIX_MESSAGE_MISSION_REQUEST_PARTIAL_LIST = 37,
  UAVIONIX_MESSAGE_MISSION_WRITE_PARTIAL_LIST = 38,
  UAVIONIX_MESSAGE_MISSION_ITEM = 39,
  UAVIONIX_MESSAGE_MISSION_REQUEST = 40,
  UAVIONIX_MESSAGE_MISSION_SET_CURRENT = 41,
  UAVIONIX_MESSAGE_MISSION_CURRENT = 42,
  UAVIONIX_MESSAGE_MISSION_REQUEST_LIST = 43,
  UAVIONIX_MESSAGE_MISSION_COUNT = 44,
  UAVIONIX_MESSAGE_MISSION_CLEAR_ALL = 45,
  UAVIONIX_MESSAGE_MISSION_ITEM_REACHED = 46,
  UAVIONIX_MESSAGE_MISSION_ACK = 47,
  UAVIONIX_MESSAGE_SET_GPS_GLOBAL_ORIGIN = 48,
  UAVIONIX_MESSAGE_GPS_GLOBAL_ORIGIN = 49,
  UAVIONIX_MESSAGE_PARAM_MAP_RC = 50,
  UAVIONIX_MESSAGE_MISSION_REQUEST_INT = 51,
  UAVIONIX_MESSAGE_MISSION_CHANGED = 52,
  UAVIONIX_MESSAGE_SAFETY_SET_ALLOWED_AREA = 54,
  UAVIONIX_MESSAGE_SAFETY_ALLOWED_AREA = 55,
  UAVIONIX_MESSAGE_ATTITUDE_QUATERNION_COV = 61,
  UAVIONIX_MESSAGE_NAV_CONTROLLER_OUTPUT = 62,
  UAVIONIX_MESSAGE_GLOBAL_POSITION_INT_COV = 63,
  UAVIONIX_MESSAGE_LOCAL_POSITION_NED_COV = 64,
  UAVIONIX_MESSAGE_RC_CHANNELS = 65,
  UAVIONIX_MESSAGE_REQUEST_DATA_STREAM = 66,
  UAVIONIX_MESSAGE_DATA_STREAM = 67,
  UAVIONIX_MESSAGE_MANUAL_CONTROL = 69,
  UAVIONIX_MESSAGE_RC_CHANNELS_OVERRIDE = 70,
  UAVIONIX_MESSAGE_MISSION_ITEM_INT = 73,
  UAVIONIX_MESSAGE_VFR_HUD = 74,
  UAVIONIX_MESSAGE_COMMAND_INT = 75,
  UAVIONIX_MESSAGE_COMMAND_LONG = 76,
  UAVIONIX_MESSAGE_COMMAND_ACK = 77,
  UAVIONIX_MESSAGE_MANUAL_SETPOINT = 81,
  UAVIONIX_MESSAGE_SET_ATTITUDE_TARGET = 82,
  UAVIONIX_MESSAGE_ATTITUDE_TARGET = 83,
  UAVIONIX_MESSAGE_SET_POSITION_TARGET_LOCAL_NED = 84,
  UAVIONIX_MESSAGE_POSITION_TARGET_LOCAL_NED = 85,
  UAVIONIX_MESSAGE_SET_POSITION_TARGET_GLOBAL_INT = 86,
  UAVIONIX_MESSAGE_POSITION_TARGET_GLOBAL_INT = 87,
  UAVIONIX_MESSAGE_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET = 89,
  UAVIONIX_MESSAGE_HIL_STATE = 90,
  UAVIONIX_MESSAGE_HIL_CONTROLS = 91,
  UAVIONIX_MESSAGE_HIL_RC_INPUTS_RAW = 92,
  UAVIONIX_MESSAGE_HIL_ACTUATOR_CONTROLS = 93,
  UAVIONIX_MESSAGE_OPTICAL_FLOW = 100,
  UAVIONIX_MESSAGE_GLOBAL_VISION_POSITION_ESTIMATE = 101,
  UAVIONIX_MESSAGE_VISION_POSITION_ESTIMATE = 102,
  UAVIONIX_MESSAGE_VISION_SPEED_ESTIMATE = 103,
  UAVIONIX_MESSAGE_VICON_POSITION_ESTIMATE = 104,
  UAVIONIX_MESSAGE_HIGHRES_IMU = 105,
  UAVIONIX_MESSAGE_OPTICAL_FLOW_RAD = 106,
  UAVIONIX_MESSAGE_HIL_SENSOR = 107,
  UAVIONIX_MESSAGE_SIM_STATE = 108,
  UAVIONIX_MESSAGE_RADIO_STATUS = 109,
  UAVIONIX_MESSAGE_FILE_TRANSFER_PROTOCOL = 110,
  UAVIONIX_MESSAGE_TIMESYNC = 111,
  UAVIONIX_MESSAGE_CAMERA_TRIGGER = 112,
  UAVIONIX_MESSAGE_HIL_GPS = 113,
  UAVIONIX_MESSAGE_HIL_OPTICAL_FLOW = 114,
  UAVIONIX_MESSAGE_HIL_STATE_QUATERNION = 115,
  UAVIONIX_MESSAGE_SCALED_IMU2 = 116,
  UAVIONIX_MESSAGE_LOG_REQUEST_LIST = 117,
  UAVIONIX_MESSAGE_LOG_ENTRY = 118,
  UAVIONIX_MESSAGE_LOG_REQUEST_DATA = 119,
  UAVIONIX_MESSAGE_LOG_DATA = 120,
  UAVIONIX_MESSAGE_LOG_ERASE = 121,
  UAVIONIX_MESSAGE_LOG_REQUEST_END = 122,
  UAVIONIX_MESSAGE_GPS_INJECT_DATA = 123,
  UAVIONIX_MESSAGE_GPS2_RAW = 124,
  UAVIONIX_MESSAGE_POWER_STATUS = 125,
  UAVIONIX_MESSAGE_SERIAL_CONTROL = 126,
  UAVIONIX_MESSAGE_GPS_RTK = 127,
  UAVIONIX_MESSAGE_GPS2_RTK = 128,
  UAVIONIX_MESSAGE_SCALED_IMU3 = 129,
  UAVIONIX_MESSAGE_DATA_TRANSMISSION_HANDSHAKE = 130,
  UAVIONIX_MESSAGE_ENCAPSULATED_DATA = 131,
  UAVIONIX_MESSAGE_DISTANCE_SENSOR = 132,
  UAVIONIX_MESSAGE_TERRAIN_REQUEST = 133,
  UAVIONIX_MESSAGE_TERRAIN_DATA = 134,
  UAVIONIX_MESSAGE_TERRAIN_CHECK = 135,
  UAVIONIX_MESSAGE_TERRAIN_REPORT = 136,
  UAVIONIX_MESSAGE_SCALED_PRESSURE2 = 137,
  UAVIONIX_MESSAGE_ATT_POS_MOCAP = 138,
  UAVIONIX_MESSAGE_SET_ACTUATOR_CONTROL_TARGET = 139,
  UAVIONIX_MESSAGE_ACTUATOR_CONTROL_TARGET = 140,
  UAVIONIX_MESSAGE_ALTITUDE = 141,
  UAVIONIX_MESSAGE_RESOURCE_REQUEST = 142,
  UAVIONIX_MESSAGE_SCALED_PRESSURE3 = 143,
  UAVIONIX_MESSAGE_FOLLOW_TARGET = 144,
  UAVIONIX_MESSAGE_CONTROL_SYSTEM_STATE = 146,
  UAVIONIX_MESSAGE_BATTERY_STATUS = 147,
  UAVIONIX_MESSAGE_AUTOPILOT_VERSION = 148,
  UAVIONIX_MESSAGE_LANDING_TARGET = 149,
  UAVIONIX_MESSAGE_ESTIMATOR_STATUS = 230,
  UAVIONIX_MESSAGE_WIND_COV = 231,
  UAVIONIX_MESSAGE_GPS_INPUT = 232,
  UAVIONIX_MESSAGE_GPS_RTCM_DATA = 233,
  UAVIONIX_MESSAGE_HIGH_LATENCY = 234,
  UAVIONIX_MESSAGE_HIGH_LATENCY2 = 235,
  UAVIONIX_MESSAGE_VIBRATION = 241,
  UAVIONIX_MESSAGE_HOME_POSITION = 242,
  UAVIONIX_MESSAGE_SET_HOME_POSITION = 243,
  UAVIONIX_MESSAGE_MESSAGE_INTERVAL = 244,
  UAVIONIX_MESSAGE_EXTENDED_SYS_STATE = 245,
  UAVIONIX_MESSAGE_ADSB_VEHICLE = 246,
  UAVIONIX_MESSAGE_COLLISION = 247,
  UAVIONIX_MESSAGE_V2_EXTENSION = 248,
  UAVIONIX_MESSAGE_MEMORY_VECT = 249,
  UAVIONIX_MESSAGE_DEBUG_VECT = 250,
  UAVIONIX_MESSAGE_NAMED_VALUE_FLOAT = 251,
  UAVIONIX_MESSAGE_NAMED_VALUE_INT = 252,
  UAVIONIX_MESSAGE_STATUSTEXT = 253,
  UAVIONIX_MESSAGE_DEBUG = 254,
  UAVIONIX_MESSAGE_SETUP_SIGNING = 256,
  UAVIONIX_MESSAGE_BUTTON_CHANGE = 257,
  UAVIONIX_MESSAGE_PLAY_TUNE = 258,
  UAVIONIX_MESSAGE_CAMERA_INFORMATION = 259,
  UAVIONIX_MESSAGE_CAMERA_SETTINGS = 260,
  UAVIONIX_MESSAGE_STORAGE_INFORMATION = 261,
  UAVIONIX_MESSAGE_CAMERA_CAPTURE_STATUS = 262,
  UAVIONIX_MESSAGE_CAMERA_IMAGE_CAPTURED = 263,
  UAVIONIX_MESSAGE_FLIGHT_INFORMATION = 264,
  UAVIONIX_MESSAGE_MOUNT_ORIENTATION = 265,
  UAVIONIX_MESSAGE_LOGGING_DATA = 266,
  UAVIONIX_MESSAGE_LOGGING_DATA_ACKED = 267,
  UAVIONIX_MESSAGE_LOGGING_ACK = 268,
  UAVIONIX_MESSAGE_VIDEO_STREAM_INFORMATION = 269,
  UAVIONIX_MESSAGE_VIDEO_STREAM_STATUS = 270,
  UAVIONIX_MESSAGE_WIFI_CONFIG_AP = 299,
  UAVIONIX_MESSAGE_PROTOCOL_VERSION = 300,
  UAVIONIX_MESSAGE_UAVCAN_NODE_STATUS = 310,
  UAVIONIX_MESSAGE_UAVCAN_NODE_INFO = 311,
  UAVIONIX_MESSAGE_PARAM_EXT_REQUEST_READ = 320,
  UAVIONIX_MESSAGE_PARAM_EXT_REQUEST_LIST = 321,
  UAVIONIX_MESSAGE_PARAM_EXT_VALUE = 322,
  UAVIONIX_MESSAGE_PARAM_EXT_SET = 323,
  UAVIONIX_MESSAGE_PARAM_EXT_ACK = 324,
  UAVIONIX_MESSAGE_OBSTACLE_DISTANCE = 330,
  UAVIONIX_MESSAGE_ODOMETRY = 331,
  UAVIONIX_MESSAGE_TRAJECTORY_REPRESENTATION_WAYPOINTS = 332,
  UAVIONIX_MESSAGE_TRAJECTORY_REPRESENTATION_BEZIER = 333,
  UAVIONIX_MESSAGE_CELLULAR_STATUS = 334,
  UAVIONIX_MESSAGE_ISBD_LINK_STATUS = 335,
  UAVIONIX_MESSAGE_UTM_GLOBAL_POSITION = 340,
  UAVIONIX_MESSAGE_DEBUG_FLOAT_ARRAY = 350,
  UAVIONIX_MESSAGE_ORBIT_EXECUTION_STATUS = 360,
  UAVIONIX_MESSAGE_STATUSTEXT_LONG = 365,
  UAVIONIX_MESSAGE_SMART_BATTERY_INFO = 370,
  UAVIONIX_MESSAGE_SMART_BATTERY_STATUS = 371,
  UAVIONIX_MESSAGE_ACTUATOR_OUTPUT_STATUS = 375,
  UAVIONIX_MESSAGE_TIME_ESTIMATE_TO_TARGET = 380,
  UAVIONIX_MESSAGE_WHEEL_DISTANCE = 9000,
  UAVIONIX_MESSAGE_UAVIONIX_ADSB_OUT_CFG = 10001,
  UAVIONIX_MESSAGE_UAVIONIX_ADSB_OUT_DYNAMIC = 10002,
  UAVIONIX_MESSAGE_UAVIONIX_ADSB_TRANSCEIVER_HEALTH_REPORT = 10003
};
 ...
 *
 * implemented in uavionix_sign.c
 */
void uavionix_message_sign(struct uavionix_message *msg, uint8_t shared[32]);
int uavionix_message_signed(struct uavionix_message *msg, uint8_t shared[32]);
 ...
 *
 * implemented in uavionix_enc.c
 */
size_t uavionix_message_serialize_v1(struct uavionix_message *msg, uint8_t *buf,
                                     size_t size);
size_t uavionix_message_serialize_v2(struct uavionix_message *msg, uint8_t *buf,
                                     size_t size);
 ...
 *
 * implemented in uavionix_dec.c
 */
size_t uavionix_message_seek(const uint8_t *buf, size_t size);
 ...
 * implemented in uavionix_dec.c
 */
size_t uavionix_message_deserialize(const uint8_t *buf, size_t size,
                                    struct uavionix_message *msg);

/* _snprintf appends a debug representation of the message to a buffer
 * implemented in uavionix_fmt.c
 */
size_t uavionix_message_snprintf(char *buf, size_t size,
                                 const struct uavionix_message *msg);
