...
// This enum is used to switch the anonymous union in standard_message.
enum STANDARD_MESSAGE {
  STANDARD_MESSAGE_HEARTBEAT = 0,
  STANDARD_MESSAGE_SYS_STATUS = 1,
  STANDARD_MESSAGE_SYSTEM_TIME = 2,
  STANDARD_MESSAGE_PING = 4,
  STANDARD_MESSAGE_CHANGE_OPERATOR_CONTROL = 5,
  STANDARD_MESSAGE_CHANGE_OPERATOR_CONTROL_ACK = 6,
  STANDARD_MESSAGE_AUTH_KEY = 7,
  STANDARD_MESSAGE_LINK_NODE_STATUS = 8,
  STANDARD_MESSAGE_SET_MODE = 11,
  STANDARD_MESSAGE_PARAM_REQUEST_READ = 20,
  STANDARD_MESSAGE_PARAM_REQUEST_LIST = 21,
  STANDARD_MESSAGE_PARAM_VALUE = 22,
  STANDARD_MESSAGE_PARAM_SET = 23,
  STANDARD_MESSAGE_GPS_RAW_INT = 24,
  STANDARD_MESSAGE_GPS_STATUS = 25,
  STANDARD_MESSAGE_SCALED_IMU = 26,
  STANDARD_MESSAGE_RAW_IMU = 27,
  STANDARD_MESSAGE_RAW_PRESSURE = 28,
  STANDARD_MESSAGE_SCALED_PRESSURE = 29,
  STANDARD_MESSAGE_ATTITUDE = 30,
  STANDARD_MESSAGE_ATTITUDE_QUATERNION = 31,
  STANDARD_MESSAGE_LOCAL_POSITION_NED = 32,
  STANDARD_MESSAGE_GLOBAL_POSITION_INT = 33,
  STANDARD_MESSAGE_RC_CHANNELS_SCALED = 34,
  STANDARD_MESSAGE_RC_CHANNELS_RAW = 35,
  STANDARD_MESSAGE_SERVO_OUTPUT_RAW = 36,
  STANDARD_MESSAGE_MISSION_REQUEST_PARTIAL_LIST = 37,
  STANDARD_MESSAGE_MISSION_WRITE_PARTIAL_LIST = 38,
  STANDARD_MESSAGE_MISSION_ITEM = 39,
  STANDARD_MESSAGE_MISSION_REQUEST = 40,
  STANDARD_MESSAGE_MISSION_SET_CURRENT = 41,
  STANDARD_MESSAGE_MISSION_CURRENT = 42,
  STANDARD_MESSAGE_MISSION_REQUEST_LIST = 43,
  STANDARD_MESSAGE_MISSION_COUNT = 44,
  STANDARD_MESSAGE_MISSION_CLEAR_ALL = 45,
  STANDARD_MESSAGE_MISSION_ITEM_REACHED = 46,
  STANDARD_MESSAGE_MISSION_ACK = 47,
  STANDARD_MESSAGE_SET_GPS_GLOBAL_ORIGIN = 48,
  STANDARD_MESSAGE_GPS_GLOBAL_ORIGIN = 49,
  STANDARD_MESSAGE_PARAM_MAP_RC = 50,
  STANDARD_MESSAGE_MISSION_REQUEST_INT = 51,
  STANDARD_MESSAGE_MISSION_CHANGED = 52,
  STANDARD_MESSAGE_SAFETY_SET_ALLOWED_AREA = 54,
  STANDARD_MESSAGE_SAFETY_ALLOWED_AREA = 55,
  STANDARD_MESSAGE_ATTITUDE_QUATERNION_COV = 61,
  STANDARD_MESSAGE_NAV_CONTROLLER_OUTPUT = 62,
  STANDARD_MESSAGE_GLOBAL_POSITION_INT_COV = 63,
  STANDARD_MESSAGE_LOCAL_POSITION_NED_COV = 64,
  STANDARD_MESSAGE_RC_CHANNELS = 65,
  STANDARD_MESSAGE_REQUEST_DATA_STREAM = 66,
  STANDARD_MESSAGE_DATA_STREAM = 67,
  STANDARD_MESSAGE_MANUAL_CONTROL = 69,
  STANDARD_MESSAGE_RC_CHANNELS_OVERRIDE = 70,
  STANDARD_MESSAGE_MISSION_ITEM_INT = 73,
  STANDARD_MESSAGE_VFR_HUD = 74,
  STANDARD_MESSAGE_COMMAND_INT = 75,
  STANDARD_MESSAGE_COMMAND_LONG = 76,
  STANDARD_MESSAGE_COMMAND_ACK = 77,
  STANDARD_MESSAGE_MANUAL_SETPOINT = 81,
  STANDARD_MESSAGE_SET_ATTITUDE_TARGET = 82,
  STANDARD_MESSAGE_ATTITUDE_TARGET = 83,
  STANDARD_MESSAGE_SET_POSITION_TARGET_LOCAL_NED = 84,
  STANDARD_MESSAGE_POSITION_TARGET_LOCAL_NED = 85,
  STANDARD_MESSAGE_SET_POSITION_TARGET_GLOBAL_INT = 86,
  STANDARD_MESSAGE_POSITION_TARGET_GLOBAL_INT = 87,
  STANDARD_MESSAGE_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET = 89,
  STANDARD_MESSAGE_HIL_STATE = 90,
  STANDARD_MESSAGE_HIL_CONTROLS = 91,
  STANDARD_MESSAGE_HIL_RC_INPUTS_RAW = 92,
  STANDARD_MESSAGE_HIL_ACTUATOR_CONTROLS = 93,
  STANDARD_MESSAGE_OPTICAL_FLOW = 100,
  STANDARD_MESSAGE_GLOBAL_VISION_POSITION_ESTIMATE = 101,
  STANDARD_MESSAGE_VISION_POSITION_ESTIMATE = 102,
  STANDARD_MESSAGE_VISION_SPEED_ESTIMATE = 103,
  STANDARD_MESSAGE_VICON_POSITION_ESTIMATE = 104,
  STANDARD_MESSAGE_HIGHRES_IMU = 105,
  STANDARD_MESSAGE_OPTICAL_FLOW_RAD = 106,
  STANDARD_MESSAGE_HIL_SENSOR = 107,
  STANDARD_MESSAGE_SIM_STATE = 108,
  STANDARD_MESSAGE_RADIO_STATUS = 109,
  STANDARD_MESSAGE_FILE_TRANSFER_PROTOCOL = 110,
  STANDARD_MESSAGE_TIMESYNC = 111,
  STANDARD_MESSAGE_CAMERA_TRIGGER = 112,
  STANDARD_MESSAGE_HIL_GPS = 113,
  STANDARD_MESSAGE_HIL_OPTICAL_FLOW = 114,
  STANDARD_MESSAGE_HIL_STATE_QUATERNION = 115,
  STANDARD_MESSAGE_SCALED_IMU2 = 116,
  STANDARD_MESSAGE_LOG_REQUEST_LIST = 117,
  STANDARD_MESSAGE_LOG_ENTRY = 118,
  STANDARD_MESSAGE_LOG_REQUEST_DATA = 119,
  STANDARD_MESSAGE_LOG_DATA = 120,
  STANDARD_MESSAGE_LOG_ERASE = 121,
  STANDARD_MESSAGE_LOG_REQUEST_END = 122,
  STANDARD_MESSAGE_GPS_INJECT_DATA = 123,
  STANDARD_MESSAGE_GPS2_RAW = 124,
  STANDARD_MESSAGE_POWER_STATUS = 125,
  STANDARD_MESSAGE_SERIAL_CONTROL = 126,
  STANDARD_MESSAGE_GPS_RTK = 127,
  STANDARD_MESSAGE_GPS2_RTK = 128,
  STANDARD_MESSAGE_SCALED_IMU3 = 129,
  STANDARD_MESSAGE_DATA_TRANSMISSION_HANDSHAKE = 130,
  STANDARD_MESSAGE_ENCAPSULATED_DATA = 131,
  STANDARD_MESSAGE_DISTANCE_SENSOR = 132,
  STANDARD_MESSAGE_TERRAIN_REQUEST = 133,
  STANDARD_MESSAGE_TERRAIN_DATA = 134,
  STANDARD_MESSAGE_TERRAIN_CHECK = 135,
  STANDARD_MESSAGE_TERRAIN_REPORT = 136,
  STANDARD_MESSAGE_SCALED_PRESSURE2 = 137,
  STANDARD_MESSAGE_ATT_POS_MOCAP = 138,
  STANDARD_MESSAGE_SET_ACTUATOR_CONTROL_TARGET = 139,
  STANDARD_MESSAGE_ACTUATOR_CONTROL_TARGET = 140,
  STANDARD_MESSAGE_ALTITUDE = 141,
  STANDARD_MESSAGE_RESOURCE_REQUEST = 142,
  STANDARD_MESSAGE_SCALED_PRESSURE3 = 143,
  STANDARD_MESSAGE_FOLLOW_TARGET = 144,
  STANDARD_MESSAGE_CONTROL_SYSTEM_STATE = 146,
  STANDARD_MESSAGE_BATTERY_STATUS = 147,
  STANDARD_MESSAGE_AUTOPILOT_VERSION = 148,
  STANDARD_MESSAGE_LANDING_TARGET = 149,
  STANDARD_MESSAGE_ESTIMATOR_STATUS = 230,
  STANDARD_MESSAGE_WIND_COV = 231,
  STANDARD_MESSAGE_GPS_INPUT = 232,
  STANDARD_MESSAGE_GPS_RTCM_DATA = 233,
  STANDARD_MESSAGE_HIGH_LATENCY = 234,
  STANDARD_MESSAGE_HIGH_LATENCY2 = 235,
  STANDARD_MESSAGE_VIBRATION = 241,
  STANDARD_MESSAGE_HOME_POSITION = 242,
  STANDARD_MESSAGE_SET_HOME_POSITION = 243,
  STANDARD_MESSAGE_MESSAGE_INTERVAL = 244,
  STANDARD_MESSAGE_EXTENDED_SYS_STATE = 245,
  STANDARD_MESSAGE_ADSB_VEHICLE = 246,
  STANDARD_MESSAGE_COLLISION = 247,
  STANDARD_MESSAGE_V2_EXTENSION = 248,
  STANDARD_MESSAGE_MEMORY_VECT = 249,
  STANDARD_MESSAGE_DEBUG_VECT = 250,
  STANDARD_MESSAGE_NAMED_VALUE_FLOAT = 251,
  STANDARD_MESSAGE_NAMED_VALUE_INT = 252,
  STANDARD_MESSAGE_STATUSTEXT = 253,
  STANDARD_MESSAGE_DEBUG = 254,
  STANDARD_MESSAGE_SETUP_SIGNING = 256,
  STANDARD_MESSAGE_BUTTON_CHANGE = 257,
  STANDARD_MESSAGE_PLAY_TUNE = 258,
  STANDARD_MESSAGE_CAMERA_INFORMATION = 259,
  STANDARD_MESSAGE_CAMERA_SETTINGS = 260,
  STANDARD_MESSAGE_STORAGE_INFORMATION = 261,
  STANDARD_MESSAGE_CAMERA_CAPTURE_STATUS = 262,
  STANDARD_MESSAGE_CAMERA_IMAGE_CAPTURED = 263,
  STANDARD_MESSAGE_FLIGHT_INFORMATION = 264,
  STANDARD_MESSAGE_MOUNT_ORIENTATION = 265,
  STANDARD_MESSAGE_LOGGING_DATA = 266,
  STANDARD_MESSAGE_LOGGING_DATA_ACKED = 267,
  STANDARD_MESSAGE_LOGGING_ACK = 268,
  STANDARD_MESSAGE_VIDEO_STREAM_INFORMATION = 269,
  STANDARD_MESSAGE_VIDEO_STREAM_STATUS = 270,
  STANDARD_MESSAGE_WIFI_CONFIG_AP = 299,
  STANDARD_MESSAGE_PROTOCOL_VERSION = 300,
  STANDARD_MESSAGE_UAVCAN_NODE_STATUS = 310,
  STANDARD_MESSAGE_UAVCAN_NODE_INFO = 311,
  STANDARD_MESSAGE_PARAM_EXT_REQUEST_READ = 320,
  STANDARD_MESSAGE_PARAM_EXT_REQUEST_LIST = 321,
  STANDARD_MESSAGE_PARAM_EXT_VALUE = 322,
  STANDARD_MESSAGE_PARAM_EXT_SET = 323,
  STANDARD_MESSAGE_PARAM_EXT_ACK = 324,
  STANDARD_MESSAGE_OBSTACLE_DISTANCE = 330,
  STANDARD_MESSAGE_ODOMETRY = 331,
  STANDARD_MESSAGE_TRAJECTORY_REPRESENTATION_WAYPOINTS = 332,
  STANDARD_MESSAGE_TRAJECTORY_REPRESENTATION_BEZIER = 333,
  STANDARD_MESSAGE_CELLULAR_STATUS = 334,
  STANDARD_MESSAGE_ISBD_LINK_STATUS = 335,
  STANDARD_MESSAGE_UTM_GLOBAL_POSITION = 340,
  STANDARD_MESSAGE_DEBUG_FLOAT_ARRAY = 350,
  STANDARD_MESSAGE_ORBIT_EXECUTION_STATUS = 360,
  STANDARD_MESSAGE_STATUSTEXT_LONG = 365,
  STANDARD_MESSAGE_SMART_BATTERY_INFO = 370,
  STANDARD_MESSAGE_SMART_BATTERY_STATUS = 371,
  STANDARD_MESSAGE_ACTUATOR_OUTPUT_STATUS = 375,
  STANDARD_MESSAGE_TIME_ESTIMATE_TO_TARGET = 380,
  STANDARD_MESSAGE_WHEEL_DISTANCE = 9000
};
 ...
 *
 * implemented in standard_sign.c
 */
void standard_message_sign(struct standard_message *msg, uint8_t shared[32]);
int standard_message_signed(struct standard_message *msg, uint8_t shared[32]);
 ...
 *
 * implemented in standard_enc.c
 */
size_t standard_message_serialize_v1(struct standard_message *msg, uint8_t *buf,
                                     size_t size);
size_t standard_message_serialize_v2(struct standard_message *msg, uint8_t *buf,
                                     size_t size);
 ...
 *
 * implemented in standard_dec.c
 */
size_t standard_message_seek(const uint8_t *buf, size_t size);
 ...
 * implemented in standard_dec.c
 */
size_t standard_message_deserialize(const uint8_t *buf, size_t size,
                                    struct standard_message *msg);

/* _snprintf appends a debug representation of the message to a buffer
 * implemented in standard_fmt.c
 */
size_t standard_message_snprintf(char *buf, size_t size,
                                 const struct standard_message *msg);
