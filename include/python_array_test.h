...
// This enum is used to switch the anonymous union in python_array_test_message.
enum PYTHON_ARRAY_TEST_MESSAGE {
  PYTHON_ARRAY_TEST_MESSAGE_HEARTBEAT = 0,
  PYTHON_ARRAY_TEST_MESSAGE_SYS_STATUS = 1,
  PYTHON_ARRAY_TEST_MESSAGE_SYSTEM_TIME = 2,
  PYTHON_ARRAY_TEST_MESSAGE_PING = 4,
  PYTHON_ARRAY_TEST_MESSAGE_CHANGE_OPERATOR_CONTROL = 5,
  PYTHON_ARRAY_TEST_MESSAGE_CHANGE_OPERATOR_CONTROL_ACK = 6,
  PYTHON_ARRAY_TEST_MESSAGE_AUTH_KEY = 7,
  PYTHON_ARRAY_TEST_MESSAGE_LINK_NODE_STATUS = 8,
  PYTHON_ARRAY_TEST_MESSAGE_SET_MODE = 11,
  PYTHON_ARRAY_TEST_MESSAGE_PARAM_REQUEST_READ = 20,
  PYTHON_ARRAY_TEST_MESSAGE_PARAM_REQUEST_LIST = 21,
  PYTHON_ARRAY_TEST_MESSAGE_PARAM_VALUE = 22,
  PYTHON_ARRAY_TEST_MESSAGE_PARAM_SET = 23,
  PYTHON_ARRAY_TEST_MESSAGE_GPS_RAW_INT = 24,
  PYTHON_ARRAY_TEST_MESSAGE_GPS_STATUS = 25,
  PYTHON_ARRAY_TEST_MESSAGE_SCALED_IMU = 26,
  PYTHON_ARRAY_TEST_MESSAGE_RAW_IMU = 27,
  PYTHON_ARRAY_TEST_MESSAGE_RAW_PRESSURE = 28,
  PYTHON_ARRAY_TEST_MESSAGE_SCALED_PRESSURE = 29,
  PYTHON_ARRAY_TEST_MESSAGE_ATTITUDE = 30,
  PYTHON_ARRAY_TEST_MESSAGE_ATTITUDE_QUATERNION = 31,
  PYTHON_ARRAY_TEST_MESSAGE_LOCAL_POSITION_NED = 32,
  PYTHON_ARRAY_TEST_MESSAGE_GLOBAL_POSITION_INT = 33,
  PYTHON_ARRAY_TEST_MESSAGE_RC_CHANNELS_SCALED = 34,
  PYTHON_ARRAY_TEST_MESSAGE_RC_CHANNELS_RAW = 35,
  PYTHON_ARRAY_TEST_MESSAGE_SERVO_OUTPUT_RAW = 36,
  PYTHON_ARRAY_TEST_MESSAGE_MISSION_REQUEST_PARTIAL_LIST = 37,
  PYTHON_ARRAY_TEST_MESSAGE_MISSION_WRITE_PARTIAL_LIST = 38,
  PYTHON_ARRAY_TEST_MESSAGE_MISSION_ITEM = 39,
  PYTHON_ARRAY_TEST_MESSAGE_MISSION_REQUEST = 40,
  PYTHON_ARRAY_TEST_MESSAGE_MISSION_SET_CURRENT = 41,
  PYTHON_ARRAY_TEST_MESSAGE_MISSION_CURRENT = 42,
  PYTHON_ARRAY_TEST_MESSAGE_MISSION_REQUEST_LIST = 43,
  PYTHON_ARRAY_TEST_MESSAGE_MISSION_COUNT = 44,
  PYTHON_ARRAY_TEST_MESSAGE_MISSION_CLEAR_ALL = 45,
  PYTHON_ARRAY_TEST_MESSAGE_MISSION_ITEM_REACHED = 46,
  PYTHON_ARRAY_TEST_MESSAGE_MISSION_ACK = 47,
  PYTHON_ARRAY_TEST_MESSAGE_SET_GPS_GLOBAL_ORIGIN = 48,
  PYTHON_ARRAY_TEST_MESSAGE_GPS_GLOBAL_ORIGIN = 49,
  PYTHON_ARRAY_TEST_MESSAGE_PARAM_MAP_RC = 50,
  PYTHON_ARRAY_TEST_MESSAGE_MISSION_REQUEST_INT = 51,
  PYTHON_ARRAY_TEST_MESSAGE_MISSION_CHANGED = 52,
  PYTHON_ARRAY_TEST_MESSAGE_SAFETY_SET_ALLOWED_AREA = 54,
  PYTHON_ARRAY_TEST_MESSAGE_SAFETY_ALLOWED_AREA = 55,
  PYTHON_ARRAY_TEST_MESSAGE_ATTITUDE_QUATERNION_COV = 61,
  PYTHON_ARRAY_TEST_MESSAGE_NAV_CONTROLLER_OUTPUT = 62,
  PYTHON_ARRAY_TEST_MESSAGE_GLOBAL_POSITION_INT_COV = 63,
  PYTHON_ARRAY_TEST_MESSAGE_LOCAL_POSITION_NED_COV = 64,
  PYTHON_ARRAY_TEST_MESSAGE_RC_CHANNELS = 65,
  PYTHON_ARRAY_TEST_MESSAGE_REQUEST_DATA_STREAM = 66,
  PYTHON_ARRAY_TEST_MESSAGE_DATA_STREAM = 67,
  PYTHON_ARRAY_TEST_MESSAGE_MANUAL_CONTROL = 69,
  PYTHON_ARRAY_TEST_MESSAGE_RC_CHANNELS_OVERRIDE = 70,
  PYTHON_ARRAY_TEST_MESSAGE_MISSION_ITEM_INT = 73,
  PYTHON_ARRAY_TEST_MESSAGE_VFR_HUD = 74,
  PYTHON_ARRAY_TEST_MESSAGE_COMMAND_INT = 75,
  PYTHON_ARRAY_TEST_MESSAGE_COMMAND_LONG = 76,
  PYTHON_ARRAY_TEST_MESSAGE_COMMAND_ACK = 77,
  PYTHON_ARRAY_TEST_MESSAGE_MANUAL_SETPOINT = 81,
  PYTHON_ARRAY_TEST_MESSAGE_SET_ATTITUDE_TARGET = 82,
  PYTHON_ARRAY_TEST_MESSAGE_ATTITUDE_TARGET = 83,
  PYTHON_ARRAY_TEST_MESSAGE_SET_POSITION_TARGET_LOCAL_NED = 84,
  PYTHON_ARRAY_TEST_MESSAGE_POSITION_TARGET_LOCAL_NED = 85,
  PYTHON_ARRAY_TEST_MESSAGE_SET_POSITION_TARGET_GLOBAL_INT = 86,
  PYTHON_ARRAY_TEST_MESSAGE_POSITION_TARGET_GLOBAL_INT = 87,
  PYTHON_ARRAY_TEST_MESSAGE_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET = 89,
  PYTHON_ARRAY_TEST_MESSAGE_HIL_STATE = 90,
  PYTHON_ARRAY_TEST_MESSAGE_HIL_CONTROLS = 91,
  PYTHON_ARRAY_TEST_MESSAGE_HIL_RC_INPUTS_RAW = 92,
  PYTHON_ARRAY_TEST_MESSAGE_HIL_ACTUATOR_CONTROLS = 93,
  PYTHON_ARRAY_TEST_MESSAGE_OPTICAL_FLOW = 100,
  PYTHON_ARRAY_TEST_MESSAGE_GLOBAL_VISION_POSITION_ESTIMATE = 101,
  PYTHON_ARRAY_TEST_MESSAGE_VISION_POSITION_ESTIMATE = 102,
  PYTHON_ARRAY_TEST_MESSAGE_VISION_SPEED_ESTIMATE = 103,
  PYTHON_ARRAY_TEST_MESSAGE_VICON_POSITION_ESTIMATE = 104,
  PYTHON_ARRAY_TEST_MESSAGE_HIGHRES_IMU = 105,
  PYTHON_ARRAY_TEST_MESSAGE_OPTICAL_FLOW_RAD = 106,
  PYTHON_ARRAY_TEST_MESSAGE_HIL_SENSOR = 107,
  PYTHON_ARRAY_TEST_MESSAGE_SIM_STATE = 108,
  PYTHON_ARRAY_TEST_MESSAGE_RADIO_STATUS = 109,
  PYTHON_ARRAY_TEST_MESSAGE_FILE_TRANSFER_PROTOCOL = 110,
  PYTHON_ARRAY_TEST_MESSAGE_TIMESYNC = 111,
  PYTHON_ARRAY_TEST_MESSAGE_CAMERA_TRIGGER = 112,
  PYTHON_ARRAY_TEST_MESSAGE_HIL_GPS = 113,
  PYTHON_ARRAY_TEST_MESSAGE_HIL_OPTICAL_FLOW = 114,
  PYTHON_ARRAY_TEST_MESSAGE_HIL_STATE_QUATERNION = 115,
  PYTHON_ARRAY_TEST_MESSAGE_SCALED_IMU2 = 116,
  PYTHON_ARRAY_TEST_MESSAGE_LOG_REQUEST_LIST = 117,
  PYTHON_ARRAY_TEST_MESSAGE_LOG_ENTRY = 118,
  PYTHON_ARRAY_TEST_MESSAGE_LOG_REQUEST_DATA = 119,
  PYTHON_ARRAY_TEST_MESSAGE_LOG_DATA = 120,
  PYTHON_ARRAY_TEST_MESSAGE_LOG_ERASE = 121,
  PYTHON_ARRAY_TEST_MESSAGE_LOG_REQUEST_END = 122,
  PYTHON_ARRAY_TEST_MESSAGE_GPS_INJECT_DATA = 123,
  PYTHON_ARRAY_TEST_MESSAGE_GPS2_RAW = 124,
  PYTHON_ARRAY_TEST_MESSAGE_POWER_STATUS = 125,
  PYTHON_ARRAY_TEST_MESSAGE_SERIAL_CONTROL = 126,
  PYTHON_ARRAY_TEST_MESSAGE_GPS_RTK = 127,
  PYTHON_ARRAY_TEST_MESSAGE_GPS2_RTK = 128,
  PYTHON_ARRAY_TEST_MESSAGE_SCALED_IMU3 = 129,
  PYTHON_ARRAY_TEST_MESSAGE_DATA_TRANSMISSION_HANDSHAKE = 130,
  PYTHON_ARRAY_TEST_MESSAGE_ENCAPSULATED_DATA = 131,
  PYTHON_ARRAY_TEST_MESSAGE_DISTANCE_SENSOR = 132,
  PYTHON_ARRAY_TEST_MESSAGE_TERRAIN_REQUEST = 133,
  PYTHON_ARRAY_TEST_MESSAGE_TERRAIN_DATA = 134,
  PYTHON_ARRAY_TEST_MESSAGE_TERRAIN_CHECK = 135,
  PYTHON_ARRAY_TEST_MESSAGE_TERRAIN_REPORT = 136,
  PYTHON_ARRAY_TEST_MESSAGE_SCALED_PRESSURE2 = 137,
  PYTHON_ARRAY_TEST_MESSAGE_ATT_POS_MOCAP = 138,
  PYTHON_ARRAY_TEST_MESSAGE_SET_ACTUATOR_CONTROL_TARGET = 139,
  PYTHON_ARRAY_TEST_MESSAGE_ACTUATOR_CONTROL_TARGET = 140,
  PYTHON_ARRAY_TEST_MESSAGE_ALTITUDE = 141,
  PYTHON_ARRAY_TEST_MESSAGE_RESOURCE_REQUEST = 142,
  PYTHON_ARRAY_TEST_MESSAGE_SCALED_PRESSURE3 = 143,
  PYTHON_ARRAY_TEST_MESSAGE_FOLLOW_TARGET = 144,
  PYTHON_ARRAY_TEST_MESSAGE_CONTROL_SYSTEM_STATE = 146,
  PYTHON_ARRAY_TEST_MESSAGE_BATTERY_STATUS = 147,
  PYTHON_ARRAY_TEST_MESSAGE_AUTOPILOT_VERSION = 148,
  PYTHON_ARRAY_TEST_MESSAGE_LANDING_TARGET = 149,
  PYTHON_ARRAY_TEST_MESSAGE_ARRAY_TEST_0 = 150,
  PYTHON_ARRAY_TEST_MESSAGE_ARRAY_TEST_1 = 151,
  PYTHON_ARRAY_TEST_MESSAGE_ARRAY_TEST_3 = 153,
  PYTHON_ARRAY_TEST_MESSAGE_ARRAY_TEST_4 = 154,
  PYTHON_ARRAY_TEST_MESSAGE_ARRAY_TEST_5 = 155,
  PYTHON_ARRAY_TEST_MESSAGE_ARRAY_TEST_6 = 156,
  PYTHON_ARRAY_TEST_MESSAGE_ARRAY_TEST_7 = 157,
  PYTHON_ARRAY_TEST_MESSAGE_ARRAY_TEST_8 = 158,
  PYTHON_ARRAY_TEST_MESSAGE_ESTIMATOR_STATUS = 230,
  PYTHON_ARRAY_TEST_MESSAGE_WIND_COV = 231,
  PYTHON_ARRAY_TEST_MESSAGE_GPS_INPUT = 232,
  PYTHON_ARRAY_TEST_MESSAGE_GPS_RTCM_DATA = 233,
  PYTHON_ARRAY_TEST_MESSAGE_HIGH_LATENCY = 234,
  PYTHON_ARRAY_TEST_MESSAGE_HIGH_LATENCY2 = 235,
  PYTHON_ARRAY_TEST_MESSAGE_VIBRATION = 241,
  PYTHON_ARRAY_TEST_MESSAGE_HOME_POSITION = 242,
  PYTHON_ARRAY_TEST_MESSAGE_SET_HOME_POSITION = 243,
  PYTHON_ARRAY_TEST_MESSAGE_MESSAGE_INTERVAL = 244,
  PYTHON_ARRAY_TEST_MESSAGE_EXTENDED_SYS_STATE = 245,
  PYTHON_ARRAY_TEST_MESSAGE_ADSB_VEHICLE = 246,
  PYTHON_ARRAY_TEST_MESSAGE_COLLISION = 247,
  PYTHON_ARRAY_TEST_MESSAGE_V2_EXTENSION = 248,
  PYTHON_ARRAY_TEST_MESSAGE_MEMORY_VECT = 249,
  PYTHON_ARRAY_TEST_MESSAGE_DEBUG_VECT = 250,
  PYTHON_ARRAY_TEST_MESSAGE_NAMED_VALUE_FLOAT = 251,
  PYTHON_ARRAY_TEST_MESSAGE_NAMED_VALUE_INT = 252,
  PYTHON_ARRAY_TEST_MESSAGE_STATUSTEXT = 253,
  PYTHON_ARRAY_TEST_MESSAGE_DEBUG = 254,
  PYTHON_ARRAY_TEST_MESSAGE_SETUP_SIGNING = 256,
  PYTHON_ARRAY_TEST_MESSAGE_BUTTON_CHANGE = 257,
  PYTHON_ARRAY_TEST_MESSAGE_PLAY_TUNE = 258,
  PYTHON_ARRAY_TEST_MESSAGE_CAMERA_INFORMATION = 259,
  PYTHON_ARRAY_TEST_MESSAGE_CAMERA_SETTINGS = 260,
  PYTHON_ARRAY_TEST_MESSAGE_STORAGE_INFORMATION = 261,
  PYTHON_ARRAY_TEST_MESSAGE_CAMERA_CAPTURE_STATUS = 262,
  PYTHON_ARRAY_TEST_MESSAGE_CAMERA_IMAGE_CAPTURED = 263,
  PYTHON_ARRAY_TEST_MESSAGE_FLIGHT_INFORMATION = 264,
  PYTHON_ARRAY_TEST_MESSAGE_MOUNT_ORIENTATION = 265,
  PYTHON_ARRAY_TEST_MESSAGE_LOGGING_DATA = 266,
  PYTHON_ARRAY_TEST_MESSAGE_LOGGING_DATA_ACKED = 267,
  PYTHON_ARRAY_TEST_MESSAGE_LOGGING_ACK = 268,
  PYTHON_ARRAY_TEST_MESSAGE_VIDEO_STREAM_INFORMATION = 269,
  PYTHON_ARRAY_TEST_MESSAGE_VIDEO_STREAM_STATUS = 270,
  PYTHON_ARRAY_TEST_MESSAGE_WIFI_CONFIG_AP = 299,
  PYTHON_ARRAY_TEST_MESSAGE_PROTOCOL_VERSION = 300,
  PYTHON_ARRAY_TEST_MESSAGE_UAVCAN_NODE_STATUS = 310,
  PYTHON_ARRAY_TEST_MESSAGE_UAVCAN_NODE_INFO = 311,
  PYTHON_ARRAY_TEST_MESSAGE_PARAM_EXT_REQUEST_READ = 320,
  PYTHON_ARRAY_TEST_MESSAGE_PARAM_EXT_REQUEST_LIST = 321,
  PYTHON_ARRAY_TEST_MESSAGE_PARAM_EXT_VALUE = 322,
  PYTHON_ARRAY_TEST_MESSAGE_PARAM_EXT_SET = 323,
  PYTHON_ARRAY_TEST_MESSAGE_PARAM_EXT_ACK = 324,
  PYTHON_ARRAY_TEST_MESSAGE_OBSTACLE_DISTANCE = 330,
  PYTHON_ARRAY_TEST_MESSAGE_ODOMETRY = 331,
  PYTHON_ARRAY_TEST_MESSAGE_TRAJECTORY_REPRESENTATION_WAYPOINTS = 332,
  PYTHON_ARRAY_TEST_MESSAGE_TRAJECTORY_REPRESENTATION_BEZIER = 333,
  PYTHON_ARRAY_TEST_MESSAGE_CELLULAR_STATUS = 334,
  PYTHON_ARRAY_TEST_MESSAGE_ISBD_LINK_STATUS = 335,
  PYTHON_ARRAY_TEST_MESSAGE_UTM_GLOBAL_POSITION = 340,
  PYTHON_ARRAY_TEST_MESSAGE_DEBUG_FLOAT_ARRAY = 350,
  PYTHON_ARRAY_TEST_MESSAGE_ORBIT_EXECUTION_STATUS = 360,
  PYTHON_ARRAY_TEST_MESSAGE_STATUSTEXT_LONG = 365,
  PYTHON_ARRAY_TEST_MESSAGE_SMART_BATTERY_INFO = 370,
  PYTHON_ARRAY_TEST_MESSAGE_SMART_BATTERY_STATUS = 371,
  PYTHON_ARRAY_TEST_MESSAGE_ACTUATOR_OUTPUT_STATUS = 375,
  PYTHON_ARRAY_TEST_MESSAGE_TIME_ESTIMATE_TO_TARGET = 380,
  PYTHON_ARRAY_TEST_MESSAGE_WHEEL_DISTANCE = 9000
};
...
// 280 bytes.
struct python_array_test_message {
  ...
  enum PYTHON_ARRAY_TEST_MESSAGE msg_id;
  union {
 ...
 *
 * implemented in python_array_test_sign.c
 */
void python_array_test_message_sign(struct python_array_test_message *msg,
                                    uint8_t shared[32]);
int python_array_test_message_signed(struct python_array_test_message *msg,
                                     uint8_t shared[32]);
 ...
 *
 * implemented in python_array_test_enc.c
 */
size_t
python_array_test_message_serialize_v1(struct python_array_test_message *msg,
                                       uint8_t *buf, size_t size);
size_t
python_array_test_message_serialize_v2(struct python_array_test_message *msg,
                                       uint8_t *buf, size_t size);
 ...
 *
 * implemented in python_array_test_dec.c
 */
 ...
 * implemented in python_array_test_fmt.c
 */
size_t
python_array_test_message_snprintf(char *buf, size_t size,
                                   const struct python_array_test_message *msg);
