...
// This enum is used to switch the anonymous union in matrixpilot_message.
enum MATRIXPILOT_MESSAGE {
  MATRIXPILOT_MESSAGE_HEARTBEAT = 0,
  MATRIXPILOT_MESSAGE_SYS_STATUS = 1,
  MATRIXPILOT_MESSAGE_SYSTEM_TIME = 2,
  MATRIXPILOT_MESSAGE_PING = 4,
  MATRIXPILOT_MESSAGE_CHANGE_OPERATOR_CONTROL = 5,
  MATRIXPILOT_MESSAGE_CHANGE_OPERATOR_CONTROL_ACK = 6,
  MATRIXPILOT_MESSAGE_AUTH_KEY = 7,
  MATRIXPILOT_MESSAGE_LINK_NODE_STATUS = 8,
  MATRIXPILOT_MESSAGE_SET_MODE = 11,
  MATRIXPILOT_MESSAGE_PARAM_REQUEST_READ = 20,
  MATRIXPILOT_MESSAGE_PARAM_REQUEST_LIST = 21,
  MATRIXPILOT_MESSAGE_PARAM_VALUE = 22,
  MATRIXPILOT_MESSAGE_PARAM_SET = 23,
  MATRIXPILOT_MESSAGE_GPS_RAW_INT = 24,
  MATRIXPILOT_MESSAGE_GPS_STATUS = 25,
  MATRIXPILOT_MESSAGE_SCALED_IMU = 26,
  MATRIXPILOT_MESSAGE_RAW_IMU = 27,
  MATRIXPILOT_MESSAGE_RAW_PRESSURE = 28,
  MATRIXPILOT_MESSAGE_SCALED_PRESSURE = 29,
  MATRIXPILOT_MESSAGE_ATTITUDE = 30,
  MATRIXPILOT_MESSAGE_ATTITUDE_QUATERNION = 31,
  MATRIXPILOT_MESSAGE_LOCAL_POSITION_NED = 32,
  MATRIXPILOT_MESSAGE_GLOBAL_POSITION_INT = 33,
  MATRIXPILOT_MESSAGE_RC_CHANNELS_SCALED = 34,
  MATRIXPILOT_MESSAGE_RC_CHANNELS_RAW = 35,
  MATRIXPILOT_MESSAGE_SERVO_OUTPUT_RAW = 36,
  MATRIXPILOT_MESSAGE_MISSION_REQUEST_PARTIAL_LIST = 37,
  MATRIXPILOT_MESSAGE_MISSION_WRITE_PARTIAL_LIST = 38,
  MATRIXPILOT_MESSAGE_MISSION_ITEM = 39,
  MATRIXPILOT_MESSAGE_MISSION_REQUEST = 40,
  MATRIXPILOT_MESSAGE_MISSION_SET_CURRENT = 41,
  MATRIXPILOT_MESSAGE_MISSION_CURRENT = 42,
  MATRIXPILOT_MESSAGE_MISSION_REQUEST_LIST = 43,
  MATRIXPILOT_MESSAGE_MISSION_COUNT = 44,
  MATRIXPILOT_MESSAGE_MISSION_CLEAR_ALL = 45,
  MATRIXPILOT_MESSAGE_MISSION_ITEM_REACHED = 46,
  MATRIXPILOT_MESSAGE_MISSION_ACK = 47,
  MATRIXPILOT_MESSAGE_SET_GPS_GLOBAL_ORIGIN = 48,
  MATRIXPILOT_MESSAGE_GPS_GLOBAL_ORIGIN = 49,
  MATRIXPILOT_MESSAGE_PARAM_MAP_RC = 50,
  MATRIXPILOT_MESSAGE_MISSION_REQUEST_INT = 51,
  MATRIXPILOT_MESSAGE_MISSION_CHANGED = 52,
  MATRIXPILOT_MESSAGE_SAFETY_SET_ALLOWED_AREA = 54,
  MATRIXPILOT_MESSAGE_SAFETY_ALLOWED_AREA = 55,
  MATRIXPILOT_MESSAGE_ATTITUDE_QUATERNION_COV = 61,
  MATRIXPILOT_MESSAGE_NAV_CONTROLLER_OUTPUT = 62,
  MATRIXPILOT_MESSAGE_GLOBAL_POSITION_INT_COV = 63,
  MATRIXPILOT_MESSAGE_LOCAL_POSITION_NED_COV = 64,
  MATRIXPILOT_MESSAGE_RC_CHANNELS = 65,
  MATRIXPILOT_MESSAGE_REQUEST_DATA_STREAM = 66,
  MATRIXPILOT_MESSAGE_DATA_STREAM = 67,
  MATRIXPILOT_MESSAGE_MANUAL_CONTROL = 69,
  MATRIXPILOT_MESSAGE_RC_CHANNELS_OVERRIDE = 70,
  MATRIXPILOT_MESSAGE_MISSION_ITEM_INT = 73,
  MATRIXPILOT_MESSAGE_VFR_HUD = 74,
  MATRIXPILOT_MESSAGE_COMMAND_INT = 75,
  MATRIXPILOT_MESSAGE_COMMAND_LONG = 76,
  MATRIXPILOT_MESSAGE_COMMAND_ACK = 77,
  MATRIXPILOT_MESSAGE_MANUAL_SETPOINT = 81,
  MATRIXPILOT_MESSAGE_SET_ATTITUDE_TARGET = 82,
  MATRIXPILOT_MESSAGE_ATTITUDE_TARGET = 83,
  MATRIXPILOT_MESSAGE_SET_POSITION_TARGET_LOCAL_NED = 84,
  MATRIXPILOT_MESSAGE_POSITION_TARGET_LOCAL_NED = 85,
  MATRIXPILOT_MESSAGE_SET_POSITION_TARGET_GLOBAL_INT = 86,
  MATRIXPILOT_MESSAGE_POSITION_TARGET_GLOBAL_INT = 87,
  MATRIXPILOT_MESSAGE_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET = 89,
  MATRIXPILOT_MESSAGE_HIL_STATE = 90,
  MATRIXPILOT_MESSAGE_HIL_CONTROLS = 91,
  MATRIXPILOT_MESSAGE_HIL_RC_INPUTS_RAW = 92,
  MATRIXPILOT_MESSAGE_HIL_ACTUATOR_CONTROLS = 93,
  MATRIXPILOT_MESSAGE_OPTICAL_FLOW = 100,
  MATRIXPILOT_MESSAGE_GLOBAL_VISION_POSITION_ESTIMATE = 101,
  MATRIXPILOT_MESSAGE_VISION_POSITION_ESTIMATE = 102,
  MATRIXPILOT_MESSAGE_VISION_SPEED_ESTIMATE = 103,
  MATRIXPILOT_MESSAGE_VICON_POSITION_ESTIMATE = 104,
  MATRIXPILOT_MESSAGE_HIGHRES_IMU = 105,
  MATRIXPILOT_MESSAGE_OPTICAL_FLOW_RAD = 106,
  MATRIXPILOT_MESSAGE_HIL_SENSOR = 107,
  MATRIXPILOT_MESSAGE_SIM_STATE = 108,
  MATRIXPILOT_MESSAGE_RADIO_STATUS = 109,
  MATRIXPILOT_MESSAGE_FILE_TRANSFER_PROTOCOL = 110,
  MATRIXPILOT_MESSAGE_TIMESYNC = 111,
  MATRIXPILOT_MESSAGE_CAMERA_TRIGGER = 112,
  MATRIXPILOT_MESSAGE_HIL_GPS = 113,
  MATRIXPILOT_MESSAGE_HIL_OPTICAL_FLOW = 114,
  MATRIXPILOT_MESSAGE_HIL_STATE_QUATERNION = 115,
  MATRIXPILOT_MESSAGE_SCALED_IMU2 = 116,
  MATRIXPILOT_MESSAGE_LOG_REQUEST_LIST = 117,
  MATRIXPILOT_MESSAGE_LOG_ENTRY = 118,
  MATRIXPILOT_MESSAGE_LOG_REQUEST_DATA = 119,
  MATRIXPILOT_MESSAGE_LOG_DATA = 120,
  MATRIXPILOT_MESSAGE_LOG_ERASE = 121,
  MATRIXPILOT_MESSAGE_LOG_REQUEST_END = 122,
  MATRIXPILOT_MESSAGE_GPS_INJECT_DATA = 123,
  MATRIXPILOT_MESSAGE_GPS2_RAW = 124,
  MATRIXPILOT_MESSAGE_POWER_STATUS = 125,
  MATRIXPILOT_MESSAGE_SERIAL_CONTROL = 126,
  MATRIXPILOT_MESSAGE_GPS_RTK = 127,
  MATRIXPILOT_MESSAGE_GPS2_RTK = 128,
  MATRIXPILOT_MESSAGE_SCALED_IMU3 = 129,
  MATRIXPILOT_MESSAGE_DATA_TRANSMISSION_HANDSHAKE = 130,
  MATRIXPILOT_MESSAGE_ENCAPSULATED_DATA = 131,
  MATRIXPILOT_MESSAGE_DISTANCE_SENSOR = 132,
  MATRIXPILOT_MESSAGE_TERRAIN_REQUEST = 133,
  MATRIXPILOT_MESSAGE_TERRAIN_DATA = 134,
  MATRIXPILOT_MESSAGE_TERRAIN_CHECK = 135,
  MATRIXPILOT_MESSAGE_TERRAIN_REPORT = 136,
  MATRIXPILOT_MESSAGE_SCALED_PRESSURE2 = 137,
  MATRIXPILOT_MESSAGE_ATT_POS_MOCAP = 138,
  MATRIXPILOT_MESSAGE_SET_ACTUATOR_CONTROL_TARGET = 139,
  MATRIXPILOT_MESSAGE_ACTUATOR_CONTROL_TARGET = 140,
  MATRIXPILOT_MESSAGE_ALTITUDE = 141,
  MATRIXPILOT_MESSAGE_RESOURCE_REQUEST = 142,
  MATRIXPILOT_MESSAGE_SCALED_PRESSURE3 = 143,
  MATRIXPILOT_MESSAGE_FOLLOW_TARGET = 144,
  MATRIXPILOT_MESSAGE_CONTROL_SYSTEM_STATE = 146,
  MATRIXPILOT_MESSAGE_BATTERY_STATUS = 147,
  MATRIXPILOT_MESSAGE_AUTOPILOT_VERSION = 148,
  MATRIXPILOT_MESSAGE_LANDING_TARGET = 149,
  MATRIXPILOT_MESSAGE_FLEXIFUNCTION_SET = 150,
  MATRIXPILOT_MESSAGE_FLEXIFUNCTION_READ_REQ = 151,
  MATRIXPILOT_MESSAGE_FLEXIFUNCTION_BUFFER_FUNCTION = 152,
  MATRIXPILOT_MESSAGE_FLEXIFUNCTION_BUFFER_FUNCTION_ACK = 153,
  MATRIXPILOT_MESSAGE_FLEXIFUNCTION_DIRECTORY = 155,
  MATRIXPILOT_MESSAGE_FLEXIFUNCTION_DIRECTORY_ACK = 156,
  MATRIXPILOT_MESSAGE_FLEXIFUNCTION_COMMAND = 157,
  MATRIXPILOT_MESSAGE_FLEXIFUNCTION_COMMAND_ACK = 158,
  MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F2_A = 170,
  MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F2_B = 171,
  MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F4 = 172,
  MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F5 = 173,
  MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F6 = 174,
  MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F7 = 175,
  MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F8 = 176,
  MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F13 = 177,
  MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F14 = 178,
  MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F15 = 179,
  MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F16 = 180,
  MATRIXPILOT_MESSAGE_ALTITUDES = 181,
  MATRIXPILOT_MESSAGE_AIRSPEEDS = 182,
  MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F17 = 183,
  MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F18 = 184,
  MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F19 = 185,
  MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F20 = 186,
  MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F21 = 187,
  MATRIXPILOT_MESSAGE_SERIAL_UDB_EXTRA_F22 = 188,
  MATRIXPILOT_MESSAGE_ESTIMATOR_STATUS = 230,
  MATRIXPILOT_MESSAGE_WIND_COV = 231,
  MATRIXPILOT_MESSAGE_GPS_INPUT = 232,
  MATRIXPILOT_MESSAGE_GPS_RTCM_DATA = 233,
  MATRIXPILOT_MESSAGE_HIGH_LATENCY = 234,
  MATRIXPILOT_MESSAGE_HIGH_LATENCY2 = 235,
  MATRIXPILOT_MESSAGE_VIBRATION = 241,
  MATRIXPILOT_MESSAGE_HOME_POSITION = 242,
  MATRIXPILOT_MESSAGE_SET_HOME_POSITION = 243,
  MATRIXPILOT_MESSAGE_MESSAGE_INTERVAL = 244,
  MATRIXPILOT_MESSAGE_EXTENDED_SYS_STATE = 245,
  MATRIXPILOT_MESSAGE_ADSB_VEHICLE = 246,
  MATRIXPILOT_MESSAGE_COLLISION = 247,
  MATRIXPILOT_MESSAGE_V2_EXTENSION = 248,
  MATRIXPILOT_MESSAGE_MEMORY_VECT = 249,
  MATRIXPILOT_MESSAGE_DEBUG_VECT = 250,
  MATRIXPILOT_MESSAGE_NAMED_VALUE_FLOAT = 251,
  MATRIXPILOT_MESSAGE_NAMED_VALUE_INT = 252,
  MATRIXPILOT_MESSAGE_STATUSTEXT = 253,
  MATRIXPILOT_MESSAGE_DEBUG = 254,
  MATRIXPILOT_MESSAGE_SETUP_SIGNING = 256,
  MATRIXPILOT_MESSAGE_BUTTON_CHANGE = 257,
  MATRIXPILOT_MESSAGE_PLAY_TUNE = 258,
  MATRIXPILOT_MESSAGE_CAMERA_INFORMATION = 259,
  MATRIXPILOT_MESSAGE_CAMERA_SETTINGS = 260,
  MATRIXPILOT_MESSAGE_STORAGE_INFORMATION = 261,
  MATRIXPILOT_MESSAGE_CAMERA_CAPTURE_STATUS = 262,
  MATRIXPILOT_MESSAGE_CAMERA_IMAGE_CAPTURED = 263,
  MATRIXPILOT_MESSAGE_FLIGHT_INFORMATION = 264,
  MATRIXPILOT_MESSAGE_MOUNT_ORIENTATION = 265,
  MATRIXPILOT_MESSAGE_LOGGING_DATA = 266,
  MATRIXPILOT_MESSAGE_LOGGING_DATA_ACKED = 267,
  MATRIXPILOT_MESSAGE_LOGGING_ACK = 268,
  MATRIXPILOT_MESSAGE_VIDEO_STREAM_INFORMATION = 269,
  MATRIXPILOT_MESSAGE_VIDEO_STREAM_STATUS = 270,
  MATRIXPILOT_MESSAGE_WIFI_CONFIG_AP = 299,
  MATRIXPILOT_MESSAGE_PROTOCOL_VERSION = 300,
  MATRIXPILOT_MESSAGE_UAVCAN_NODE_STATUS = 310,
  MATRIXPILOT_MESSAGE_UAVCAN_NODE_INFO = 311,
  MATRIXPILOT_MESSAGE_PARAM_EXT_REQUEST_READ = 320,
  MATRIXPILOT_MESSAGE_PARAM_EXT_REQUEST_LIST = 321,
  MATRIXPILOT_MESSAGE_PARAM_EXT_VALUE = 322,
  MATRIXPILOT_MESSAGE_PARAM_EXT_SET = 323,
  MATRIXPILOT_MESSAGE_PARAM_EXT_ACK = 324,
  MATRIXPILOT_MESSAGE_OBSTACLE_DISTANCE = 330,
  MATRIXPILOT_MESSAGE_ODOMETRY = 331,
  MATRIXPILOT_MESSAGE_TRAJECTORY_REPRESENTATION_WAYPOINTS = 332,
  MATRIXPILOT_MESSAGE_TRAJECTORY_REPRESENTATION_BEZIER = 333,
  MATRIXPILOT_MESSAGE_CELLULAR_STATUS = 334,
  MATRIXPILOT_MESSAGE_ISBD_LINK_STATUS = 335,
  MATRIXPILOT_MESSAGE_UTM_GLOBAL_POSITION = 340,
  MATRIXPILOT_MESSAGE_DEBUG_FLOAT_ARRAY = 350,
  MATRIXPILOT_MESSAGE_ORBIT_EXECUTION_STATUS = 360,
  MATRIXPILOT_MESSAGE_STATUSTEXT_LONG = 365,
  MATRIXPILOT_MESSAGE_SMART_BATTERY_INFO = 370,
  MATRIXPILOT_MESSAGE_SMART_BATTERY_STATUS = 371,
  MATRIXPILOT_MESSAGE_ACTUATOR_OUTPUT_STATUS = 375,
  MATRIXPILOT_MESSAGE_TIME_ESTIMATE_TO_TARGET = 380,
  MATRIXPILOT_MESSAGE_WHEEL_DISTANCE = 9000
};
...
struct matrixpilot_message {
  ...
  enum MATRIXPILOT_MESSAGE msg_id;
  union {
    ...
    struct {
      ...
      uint16_t data_address; /* Address in the flexifunction data, Set to 0xFFFF
                                to use address in target memory */
    ...
    struct {
      ...
      int16_t
          sue_hdop; /* Serial UDB Extra GPS Horizontal Dilution of Precision */
    ...
    struct {
      ...
      int16_t
          sue_location_error_earth_x; /* Serial UDB Location Error Earth X */
      int16_t
          sue_location_error_earth_y; /* Serial UDB Location Error Earth Y */
      int16_t
          sue_location_error_earth_z; /* Serial UDB Location Error Earth Z */
      ...
      int16_t
          sue_waypoint_goal_x; /* Serial UDB Extra Current Waypoint Goal X */
      int16_t
          sue_waypoint_goal_y; /* Serial UDB Extra Current Waypoint Goal Y */
      int16_t
          sue_waypoint_goal_z;    /* Serial UDB Extra Current Waypoint Goal Z */
    ...
    struct {
      uint8_t sue_ROLL_STABILIZATION_AILERONS; /* Serial UDB Extra Roll
                                                  Stabilization with Ailerons
                                                  Enabled */
      uint8_t
          sue_ROLL_STABILIZATION_RUDDER; /* Serial UDB Extra Roll Stabilization
                                            with Rudder Enabled */
      uint8_t sue_PITCH_STABILIZATION;   /* Serial UDB Extra Pitch Stabilization
                                            Enabled */
      uint8_t
          sue_YAW_STABILIZATION_RUDDER; /* Serial UDB Extra Yaw Stabilization
                                           using Rudder Enabled */
      uint8_t
          sue_YAW_STABILIZATION_AILERON; /* Serial UDB Extra Yaw Stabilization
                                            using Ailerons Enabled */
      uint8_t sue_AILERON_NAVIGATION;    /* Serial UDB Extra Navigation with
                                            Ailerons Enabled */
      uint8_t sue_RUDDER_NAVIGATION; /* Serial UDB Extra Navigation with Rudder
                                        Enabled */
      uint8_t sue_ALTITUDEHOLD_STABILIZED; /* Serial UDB Extra Type of Alitude
                                              Hold when in Stabilized Mode */
      uint8_t sue_ALTITUDEHOLD_WAYPOINT;   /* Serial UDB Extra Type of Alitude
                                              Hold when in Waypoint Mode */
      uint8_t
          sue_RACING_MODE; /* Serial UDB Extra Firmware racing mode enabled */
    } serial_udb_extra_f4;

    /* Backwards compatible version of SERIAL_UDB_EXTRA F5: format */
    struct {
      float sue_YAWKP_AILERON; /* Serial UDB YAWKP_AILERON Gain for Proporional
                                  control of navigation */
      float sue_YAWKD_AILERON; /* Serial UDB YAWKD_AILERON Gain for Rate control
                                  of navigation */
      float sue_ROLLKP; /* Serial UDB Extra ROLLKP Gain for Proportional control
                           of roll stabilization */
      float sue_ROLLKD; /* Serial UDB Extra ROLLKD Gain for Rate control of roll
                           stabilization */
    } serial_udb_extra_f5;
    ...
    struct {
      ...
      float sue_ELEVATOR_BOOST;  /* Gain For Boosting Manual Elevator control
                                    When Plane Stabilized */
    } serial_udb_extra_f6;

    /* Backwards compatible version of SERIAL_UDB_EXTRA F7: format */
    struct {
      float sue_YAWKP_RUDDER;   /* Serial UDB YAWKP_RUDDER Gain for Proporional
                                   control of navigation */
      float sue_YAWKD_RUDDER;   /* Serial UDB YAWKD_RUDDER Gain for Rate control
                                   of navigation */
      float sue_ROLLKP_RUDDER;  /* Serial UDB Extra ROLLKP_RUDDER Gain for
                                   Proportional control of roll stabilization */
      float sue_ROLLKD_RUDDER;  /* Serial UDB Extra ROLLKD_RUDDER Gain for Rate
                                   control of roll stabilization */
      float sue_RUDDER_BOOST;   /* SERIAL UDB EXTRA Rudder Boost Gain to Manual
                                   Control when stabilized */
      float sue_RTL_PITCH_DOWN; /* Serial UDB Extra Return To Landing - Angle to
                                   Pitch Plane Down */
    } serial_udb_extra_f7;
    ...
    struct {
      ...
      int32_t sue_alt_origin; /* Serial UDB Extra MP Origin Altitude Above Sea
                                 Level */
    ...
    struct {
      uint32_t sue_TRAP_SOURCE; /* Serial UDB Extra Type Program Address of Last
                                   Trap */
      int16_t sue_RCON;         /* Serial UDB Extra Reboot Register of DSPIC */
      int16_t sue_TRAP_FLAGS;   /* Serial UDB Extra  Last dspic Trap Flags */
      int16_t sue_osc_fail_count; /* Serial UDB Extra Number of Ocillator
                                     Failures */
      uint8_t
          sue_WIND_ESTIMATION;  /* Serial UDB Extra Wind Estimation Enabled */
      ...
      uint8_t sue_CLOCK_CONFIG; /* Serial UDB Extra UDB Internal Clock
                                   Configuration */
    ...
    struct {
      uint8_t sue_ID_VEHICLE_MODEL_NAME[40];   /* Serial UDB Extra Model Name Of
                                                  Vehicle */
      uint8_t sue_ID_VEHICLE_REGISTRATION[20]; /* Serial UDB Extra Registraton
                                                  Number of Vehicle */
    } serial_udb_extra_f15;

    /* Backwards compatible version of SERIAL_UDB_EXTRA F16 format */
    struct {
      uint8_t sue_ID_LEAD_PILOT[40]; /* Serial UDB Extra Name of Expected Lead
                                        Pilot */
      uint8_t sue_ID_DIY_DRONES_URL[70]; /* Serial UDB Extra URL of Lead Pilot
                                            or Team */
    ...
    struct {
      ...
      int32_t alt_gps; /* GPS altitude (MSL) in meters, expressed as * 1000
                          (millimeters) */
      int32_t alt_imu; /* IMU altitude above ground in meters, expressed as *
                          1000 (millimeters) */
      int32_t alt_barometric;   /* barometeric altitude above ground in meters,
                                   expressed as * 1000 (millimeters) */
      int32_t alt_optical_flow; /* Optical flow altitude above ground in meters,
                                   expressed as * 1000 (millimeters) */
      int32_t alt_range_finder; /* Rangefinder Altitude above ground in meters,
                                   expressed as * 1000 (millimeters) */
      int32_t alt_extra; /* Extra altitude above ground in meters, expressed as
                            * 1000 (millimeters) */
    } altitudes;
    ...
    struct {
      ...
      int16_t
          airspeed_hot_wire; /* Hot wire anenometer measured airspeed, cm/s */
    ...
    struct {
      int16_t sue_accel_x_at_calibration; /* SUE X accelerometer at calibration
                                             time */
      int16_t sue_accel_y_at_calibration; /* SUE Y accelerometer at calibration
                                             time */
      int16_t sue_accel_z_at_calibration; /* SUE Z accelerometer at calibration
                                             time */
 ...
 *
 * implemented in matrixpilot_sign.c
 */
void matrixpilot_message_sign(struct matrixpilot_message *msg,
                              uint8_t shared[32]);
int matrixpilot_message_signed(struct matrixpilot_message *msg,
                               uint8_t shared[32]);
 ...
 *
 * implemented in matrixpilot_enc.c
 */
size_t matrixpilot_message_serialize_v1(struct matrixpilot_message *msg,
                                        uint8_t *buf, size_t size);
size_t matrixpilot_message_serialize_v2(struct matrixpilot_message *msg,
                                        uint8_t *buf, size_t size);
 ...
 *
 * implemented in matrixpilot_dec.c
 */
size_t matrixpilot_message_seek(const uint8_t *buf, size_t size);
 ...
 * implemented in matrixpilot_dec.c
 */
size_t matrixpilot_message_deserialize(const uint8_t *buf, size_t size,
                                       struct matrixpilot_message *msg);

/* _snprintf appends a debug representation of the message to a buffer
 * implemented in matrixpilot_fmt.c
 */
size_t matrixpilot_message_snprintf(char *buf, size_t size,
                                    const struct matrixpilot_message *msg);
