...
// This enum is used to switch the anonymous union in paparazzi_message.
enum PAPARAZZI_MESSAGE {
  PAPARAZZI_MESSAGE_HEARTBEAT = 0,
  PAPARAZZI_MESSAGE_SYS_STATUS = 1,
  PAPARAZZI_MESSAGE_SYSTEM_TIME = 2,
  PAPARAZZI_MESSAGE_PING = 4,
  PAPARAZZI_MESSAGE_CHANGE_OPERATOR_CONTROL = 5,
  PAPARAZZI_MESSAGE_CHANGE_OPERATOR_CONTROL_ACK = 6,
  PAPARAZZI_MESSAGE_AUTH_KEY = 7,
  PAPARAZZI_MESSAGE_LINK_NODE_STATUS = 8,
  PAPARAZZI_MESSAGE_SET_MODE = 11,
  PAPARAZZI_MESSAGE_PARAM_REQUEST_READ = 20,
  PAPARAZZI_MESSAGE_PARAM_REQUEST_LIST = 21,
  PAPARAZZI_MESSAGE_PARAM_VALUE = 22,
  PAPARAZZI_MESSAGE_PARAM_SET = 23,
  PAPARAZZI_MESSAGE_GPS_RAW_INT = 24,
  PAPARAZZI_MESSAGE_GPS_STATUS = 25,
  PAPARAZZI_MESSAGE_SCALED_IMU = 26,
  PAPARAZZI_MESSAGE_RAW_IMU = 27,
  PAPARAZZI_MESSAGE_RAW_PRESSURE = 28,
  PAPARAZZI_MESSAGE_SCALED_PRESSURE = 29,
  PAPARAZZI_MESSAGE_ATTITUDE = 30,
  PAPARAZZI_MESSAGE_ATTITUDE_QUATERNION = 31,
  PAPARAZZI_MESSAGE_LOCAL_POSITION_NED = 32,
  PAPARAZZI_MESSAGE_GLOBAL_POSITION_INT = 33,
  PAPARAZZI_MESSAGE_RC_CHANNELS_SCALED = 34,
  PAPARAZZI_MESSAGE_RC_CHANNELS_RAW = 35,
  PAPARAZZI_MESSAGE_SERVO_OUTPUT_RAW = 36,
  PAPARAZZI_MESSAGE_MISSION_REQUEST_PARTIAL_LIST = 37,
  PAPARAZZI_MESSAGE_MISSION_WRITE_PARTIAL_LIST = 38,
  PAPARAZZI_MESSAGE_MISSION_ITEM = 39,
  PAPARAZZI_MESSAGE_MISSION_REQUEST = 40,
  PAPARAZZI_MESSAGE_MISSION_SET_CURRENT = 41,
  PAPARAZZI_MESSAGE_MISSION_CURRENT = 42,
  PAPARAZZI_MESSAGE_MISSION_REQUEST_LIST = 43,
  PAPARAZZI_MESSAGE_MISSION_COUNT = 44,
  PAPARAZZI_MESSAGE_MISSION_CLEAR_ALL = 45,
  PAPARAZZI_MESSAGE_MISSION_ITEM_REACHED = 46,
  PAPARAZZI_MESSAGE_MISSION_ACK = 47,
  PAPARAZZI_MESSAGE_SET_GPS_GLOBAL_ORIGIN = 48,
  PAPARAZZI_MESSAGE_GPS_GLOBAL_ORIGIN = 49,
  PAPARAZZI_MESSAGE_PARAM_MAP_RC = 50,
  PAPARAZZI_MESSAGE_MISSION_REQUEST_INT = 51,
  PAPARAZZI_MESSAGE_MISSION_CHANGED = 52,
  PAPARAZZI_MESSAGE_SAFETY_SET_ALLOWED_AREA = 54,
  PAPARAZZI_MESSAGE_SAFETY_ALLOWED_AREA = 55,
  PAPARAZZI_MESSAGE_ATTITUDE_QUATERNION_COV = 61,
  PAPARAZZI_MESSAGE_NAV_CONTROLLER_OUTPUT = 62,
  PAPARAZZI_MESSAGE_GLOBAL_POSITION_INT_COV = 63,
  PAPARAZZI_MESSAGE_LOCAL_POSITION_NED_COV = 64,
  PAPARAZZI_MESSAGE_RC_CHANNELS = 65,
  PAPARAZZI_MESSAGE_REQUEST_DATA_STREAM = 66,
  PAPARAZZI_MESSAGE_DATA_STREAM = 67,
  PAPARAZZI_MESSAGE_MANUAL_CONTROL = 69,
  PAPARAZZI_MESSAGE_RC_CHANNELS_OVERRIDE = 70,
  PAPARAZZI_MESSAGE_MISSION_ITEM_INT = 73,
  PAPARAZZI_MESSAGE_VFR_HUD = 74,
  PAPARAZZI_MESSAGE_COMMAND_INT = 75,
  PAPARAZZI_MESSAGE_COMMAND_LONG = 76,
  PAPARAZZI_MESSAGE_COMMAND_ACK = 77,
  PAPARAZZI_MESSAGE_MANUAL_SETPOINT = 81,
  PAPARAZZI_MESSAGE_SET_ATTITUDE_TARGET = 82,
  PAPARAZZI_MESSAGE_ATTITUDE_TARGET = 83,
  PAPARAZZI_MESSAGE_SET_POSITION_TARGET_LOCAL_NED = 84,
  PAPARAZZI_MESSAGE_POSITION_TARGET_LOCAL_NED = 85,
  PAPARAZZI_MESSAGE_SET_POSITION_TARGET_GLOBAL_INT = 86,
  PAPARAZZI_MESSAGE_POSITION_TARGET_GLOBAL_INT = 87,
  PAPARAZZI_MESSAGE_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET = 89,
  PAPARAZZI_MESSAGE_HIL_STATE = 90,
  PAPARAZZI_MESSAGE_HIL_CONTROLS = 91,
  PAPARAZZI_MESSAGE_HIL_RC_INPUTS_RAW = 92,
  PAPARAZZI_MESSAGE_HIL_ACTUATOR_CONTROLS = 93,
  PAPARAZZI_MESSAGE_OPTICAL_FLOW = 100,
  PAPARAZZI_MESSAGE_GLOBAL_VISION_POSITION_ESTIMATE = 101,
  PAPARAZZI_MESSAGE_VISION_POSITION_ESTIMATE = 102,
  PAPARAZZI_MESSAGE_VISION_SPEED_ESTIMATE = 103,
  PAPARAZZI_MESSAGE_VICON_POSITION_ESTIMATE = 104,
  PAPARAZZI_MESSAGE_HIGHRES_IMU = 105,
  PAPARAZZI_MESSAGE_OPTICAL_FLOW_RAD = 106,
  PAPARAZZI_MESSAGE_HIL_SENSOR = 107,
  PAPARAZZI_MESSAGE_SIM_STATE = 108,
  PAPARAZZI_MESSAGE_RADIO_STATUS = 109,
  PAPARAZZI_MESSAGE_FILE_TRANSFER_PROTOCOL = 110,
  PAPARAZZI_MESSAGE_TIMESYNC = 111,
  PAPARAZZI_MESSAGE_CAMERA_TRIGGER = 112,
  PAPARAZZI_MESSAGE_HIL_GPS = 113,
  PAPARAZZI_MESSAGE_HIL_OPTICAL_FLOW = 114,
  PAPARAZZI_MESSAGE_HIL_STATE_QUATERNION = 115,
  PAPARAZZI_MESSAGE_SCALED_IMU2 = 116,
  PAPARAZZI_MESSAGE_LOG_REQUEST_LIST = 117,
  PAPARAZZI_MESSAGE_LOG_ENTRY = 118,
  PAPARAZZI_MESSAGE_LOG_REQUEST_DATA = 119,
  PAPARAZZI_MESSAGE_LOG_DATA = 120,
  PAPARAZZI_MESSAGE_LOG_ERASE = 121,
  PAPARAZZI_MESSAGE_LOG_REQUEST_END = 122,
  PAPARAZZI_MESSAGE_GPS_INJECT_DATA = 123,
  PAPARAZZI_MESSAGE_GPS2_RAW = 124,
  PAPARAZZI_MESSAGE_POWER_STATUS = 125,
  PAPARAZZI_MESSAGE_SERIAL_CONTROL = 126,
  PAPARAZZI_MESSAGE_GPS_RTK = 127,
  PAPARAZZI_MESSAGE_GPS2_RTK = 128,
  PAPARAZZI_MESSAGE_SCALED_IMU3 = 129,
  PAPARAZZI_MESSAGE_DATA_TRANSMISSION_HANDSHAKE = 130,
  PAPARAZZI_MESSAGE_ENCAPSULATED_DATA = 131,
  PAPARAZZI_MESSAGE_DISTANCE_SENSOR = 132,
  PAPARAZZI_MESSAGE_TERRAIN_REQUEST = 133,
  PAPARAZZI_MESSAGE_TERRAIN_DATA = 134,
  PAPARAZZI_MESSAGE_TERRAIN_CHECK = 135,
  PAPARAZZI_MESSAGE_TERRAIN_REPORT = 136,
  PAPARAZZI_MESSAGE_SCALED_PRESSURE2 = 137,
  PAPARAZZI_MESSAGE_ATT_POS_MOCAP = 138,
  PAPARAZZI_MESSAGE_SET_ACTUATOR_CONTROL_TARGET = 139,
  PAPARAZZI_MESSAGE_ACTUATOR_CONTROL_TARGET = 140,
  PAPARAZZI_MESSAGE_ALTITUDE = 141,
  PAPARAZZI_MESSAGE_RESOURCE_REQUEST = 142,
  PAPARAZZI_MESSAGE_SCALED_PRESSURE3 = 143,
  PAPARAZZI_MESSAGE_FOLLOW_TARGET = 144,
  PAPARAZZI_MESSAGE_CONTROL_SYSTEM_STATE = 146,
  PAPARAZZI_MESSAGE_BATTERY_STATUS = 147,
  PAPARAZZI_MESSAGE_AUTOPILOT_VERSION = 148,
  PAPARAZZI_MESSAGE_LANDING_TARGET = 149,
  PAPARAZZI_MESSAGE_SCRIPT_ITEM = 180,
  PAPARAZZI_MESSAGE_SCRIPT_REQUEST = 181,
  PAPARAZZI_MESSAGE_SCRIPT_REQUEST_LIST = 182,
  PAPARAZZI_MESSAGE_SCRIPT_COUNT = 183,
  PAPARAZZI_MESSAGE_SCRIPT_CURRENT = 184,
  PAPARAZZI_MESSAGE_ESTIMATOR_STATUS = 230,
  PAPARAZZI_MESSAGE_WIND_COV = 231,
  PAPARAZZI_MESSAGE_GPS_INPUT = 232,
  PAPARAZZI_MESSAGE_GPS_RTCM_DATA = 233,
  PAPARAZZI_MESSAGE_HIGH_LATENCY = 234,
  PAPARAZZI_MESSAGE_HIGH_LATENCY2 = 235,
  PAPARAZZI_MESSAGE_VIBRATION = 241,
  PAPARAZZI_MESSAGE_HOME_POSITION = 242,
  PAPARAZZI_MESSAGE_SET_HOME_POSITION = 243,
  PAPARAZZI_MESSAGE_MESSAGE_INTERVAL = 244,
  PAPARAZZI_MESSAGE_EXTENDED_SYS_STATE = 245,
  PAPARAZZI_MESSAGE_ADSB_VEHICLE = 246,
  PAPARAZZI_MESSAGE_COLLISION = 247,
  PAPARAZZI_MESSAGE_V2_EXTENSION = 248,
  PAPARAZZI_MESSAGE_MEMORY_VECT = 249,
  PAPARAZZI_MESSAGE_DEBUG_VECT = 250,
  PAPARAZZI_MESSAGE_NAMED_VALUE_FLOAT = 251,
  PAPARAZZI_MESSAGE_NAMED_VALUE_INT = 252,
  PAPARAZZI_MESSAGE_STATUSTEXT = 253,
  PAPARAZZI_MESSAGE_DEBUG = 254,
  PAPARAZZI_MESSAGE_SETUP_SIGNING = 256,
  PAPARAZZI_MESSAGE_BUTTON_CHANGE = 257,
  PAPARAZZI_MESSAGE_PLAY_TUNE = 258,
  PAPARAZZI_MESSAGE_CAMERA_INFORMATION = 259,
  PAPARAZZI_MESSAGE_CAMERA_SETTINGS = 260,
  PAPARAZZI_MESSAGE_STORAGE_INFORMATION = 261,
  PAPARAZZI_MESSAGE_CAMERA_CAPTURE_STATUS = 262,
  PAPARAZZI_MESSAGE_CAMERA_IMAGE_CAPTURED = 263,
  PAPARAZZI_MESSAGE_FLIGHT_INFORMATION = 264,
  PAPARAZZI_MESSAGE_MOUNT_ORIENTATION = 265,
  PAPARAZZI_MESSAGE_LOGGING_DATA = 266,
  PAPARAZZI_MESSAGE_LOGGING_DATA_ACKED = 267,
  PAPARAZZI_MESSAGE_LOGGING_ACK = 268,
  PAPARAZZI_MESSAGE_VIDEO_STREAM_INFORMATION = 269,
  PAPARAZZI_MESSAGE_VIDEO_STREAM_STATUS = 270,
  PAPARAZZI_MESSAGE_WIFI_CONFIG_AP = 299,
  PAPARAZZI_MESSAGE_PROTOCOL_VERSION = 300,
  PAPARAZZI_MESSAGE_UAVCAN_NODE_STATUS = 310,
  PAPARAZZI_MESSAGE_UAVCAN_NODE_INFO = 311,
  PAPARAZZI_MESSAGE_PARAM_EXT_REQUEST_READ = 320,
  PAPARAZZI_MESSAGE_PARAM_EXT_REQUEST_LIST = 321,
  PAPARAZZI_MESSAGE_PARAM_EXT_VALUE = 322,
  PAPARAZZI_MESSAGE_PARAM_EXT_SET = 323,
  PAPARAZZI_MESSAGE_PARAM_EXT_ACK = 324,
  PAPARAZZI_MESSAGE_OBSTACLE_DISTANCE = 330,
  PAPARAZZI_MESSAGE_ODOMETRY = 331,
  PAPARAZZI_MESSAGE_TRAJECTORY_REPRESENTATION_WAYPOINTS = 332,
  PAPARAZZI_MESSAGE_TRAJECTORY_REPRESENTATION_BEZIER = 333,
  PAPARAZZI_MESSAGE_CELLULAR_STATUS = 334,
  PAPARAZZI_MESSAGE_ISBD_LINK_STATUS = 335,
  PAPARAZZI_MESSAGE_UTM_GLOBAL_POSITION = 340,
  PAPARAZZI_MESSAGE_DEBUG_FLOAT_ARRAY = 350,
  PAPARAZZI_MESSAGE_ORBIT_EXECUTION_STATUS = 360,
  PAPARAZZI_MESSAGE_STATUSTEXT_LONG = 365,
  PAPARAZZI_MESSAGE_SMART_BATTERY_INFO = 370,
  PAPARAZZI_MESSAGE_SMART_BATTERY_STATUS = 371,
  PAPARAZZI_MESSAGE_ACTUATOR_OUTPUT_STATUS = 375,
  PAPARAZZI_MESSAGE_TIME_ESTIMATE_TO_TARGET = 380,
  PAPARAZZI_MESSAGE_WHEEL_DISTANCE = 9000
};
...
struct paparazzi_message {
  ...
  union {
    ...
    /* This message is emitted as response to SCRIPT_REQUEST_LIST by the MAV to
     * get the number of mission scripts. */
    struct {
 ...
 *
 * implemented in paparazzi_sign.c
 */
void paparazzi_message_sign(struct paparazzi_message *msg, uint8_t shared[32]);
int paparazzi_message_signed(struct paparazzi_message *msg, uint8_t shared[32]);
 ...
 *
 * implemented in paparazzi_enc.c
 */
 ...
 *
 * implemented in paparazzi_dec.c
 */
size_t paparazzi_message_seek(const uint8_t *buf, size_t size);
 ...
 * implemented in paparazzi_dec.c
 */
size_t paparazzi_message_deserialize(const uint8_t *buf, size_t size,
                                     struct paparazzi_message *msg);

/* _snprintf appends a debug representation of the message to a buffer
 * implemented in paparazzi_fmt.c
 */
size_t paparazzi_message_snprintf(char *buf, size_t size,
                                  const struct paparazzi_message *msg);
